    ...
    for image_id in set(image_ids):
      try:
        api.docker(
            ...
            '-f',
            image_id.strip(),
            step_name='delete image %s' % image_id)
