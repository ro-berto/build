...
def _RunScript(api, script_invocation):
  ...
  message = _GenerateCLMessage(script_invocation, bug_file_contents, cl_cmdline)
  _UploadCL(api, script_invocation, message)


def _GenerateCLMessage(script_invocation, bug_file_contents, cmdline):
  cl_description = [
...
def _UploadCL(api, script_invocation, message):
  api.git('add', '-u')
