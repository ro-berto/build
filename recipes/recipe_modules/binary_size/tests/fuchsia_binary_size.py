...
def GenTests(api):
  ...
  yield api.test(
      'unexpected_increase', api.binary_size.build(),
      override_analyze(),
  ...
  yield api.test(
      ...
      api.binary_size.build(), override_analyze(),
  ...
  yield api.test(
      ...
      api.binary_size.build(fuchsia_size_footer=True), override_analyze(),
      api.override_step_data(
          constants.RESULT_JSON_STEP_NAME,
          api.json.output({
              'status_code': 1,
  ...
  yield api.test(
      ...
      api.binary_size.build(android_size_footer=True), override_analyze(),
      api.override_step_data(
          constants.RESULT_JSON_STEP_NAME,
          api.json.output({
              'status_code': 1,
  ...
  yield api.test(
      ...
      api.binary_size.build(
          commit_message='Revert some change'),
      override_analyze(),
      api.override_step_data(
          constants.RESULT_JSON_STEP_NAME,
          api.json.output({
  ...
  yield api.test(
      ...
      api.binary_size.build(
          ...
          patch_parent_cp=12350), override_analyze(),
  ...
  yield api.test(
      ...
      api.binary_size.build(
          recent_upload_cp=12345,
          patch_parent_cp=None), override_analyze(),
