...
_KZIPINFO_CORPUSINFO = _descriptor.Descriptor(
  name='CorpusInfo',
  full_name='kythe.proto.KzipInfo.CorpusInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_KZIPINFO_CORPORAENTRY = _descriptor.Descriptor(
  name='CorporaEntry',
  full_name='kythe.proto.KzipInfo.CorporaEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='kythe.proto.KzipInfo.CorporaEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='kythe.proto.KzipInfo.CorporaEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_KZIPINFO = _descriptor.Descriptor(
  name='KzipInfo',
  full_name='kythe.proto.KzipInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='corpora', full_name='kythe.proto.KzipInfo.corpora', index=0,
...
_KZIPINFO.fields_by_name['corpora'].message_type = _KZIPINFO_CORPORAENTRY
...
DESCRIPTOR.message_types_by_name['KzipInfo'] = _KZIPINFO
...
KzipInfo = _reflection.GeneratedProtocolMessageType('KzipInfo', (_message.Message,), dict(
  ...
  CorpusInfo = _reflection.GeneratedProtocolMessageType('CorpusInfo', (_message.Message,), dict(
    ...
    __module__ = 'kythe.proto.analysis_pb2'
    # @@protoc_insertion_point(class_scope:kythe.proto.KzipInfo.CorpusInfo)
    ))
  ,

  CorporaEntry = _reflection.GeneratedProtocolMessageType('CorporaEntry', (_message.Message,), dict(
    DESCRIPTOR = _KZIPINFO_CORPORAENTRY,
    __module__ = 'kythe.proto.analysis_pb2'
    # @@protoc_insertion_point(class_scope:kythe.proto.KzipInfo.CorporaEntry)
    ))
  ,
  DESCRIPTOR = _KZIPINFO,
  __module__ = 'kythe.proto.analysis_pb2'
