...
class WeetbixApi(recipe_api.RecipeApi):
  ...
  def query_failure_rate(self, test_suites):
    """Queries 'luci.analysis.v1.TestVariants.QueryFailureRate' for failing tests
  ...
  def query_test_history(self,
    ...
    Args:
      ...
      variant_predicate (luci.analysis.v1.TestVerdict): Optional. The subset of test
        variants to request history for. Default all will be returned.
      partition_time_range (luci.analysis.v1.common.TimeRange): Optional. A range of
        timestamps to query the test history from. Default all will be returned.
        (At most recent 90 days as TTL).
      submitted_filter (luci.analysis.v1.common.SubmittedFilter): Optional. Whether
