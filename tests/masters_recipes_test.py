...
FAKE_BUILDERS = {
    ...
    'master.tryserver.chromium.win' : [
        ...
        'gpu-fyi-try-win7-nvidia-rel',
        'gpu-fyi-try-win7-nvidia-rel-64',
        'gpu-fyi-try-win10-intel-dqp',
        'gpu-fyi-try-win10-intel-exp',
        'gpu-fyi-try-win10-intel-rel',
        'gpu-fyi-try-win10-nvidia-dbg',
        'gpu-fyi-try-win10-nvidia-dqp',
        'gpu-fyi-try-win10-nvidia-exp',
        'gpu-fyi-try-win10-nvidia-rel',
