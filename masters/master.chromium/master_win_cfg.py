...
F('dbg_unit_2', win().ChromiumFactory(
    ...
    factory_properties={'sharded_tests': sharded_tests,
                        'ui_total_shards': 5, 'ui_shard_index': 1,
...
F('dbg_unit_3', win().ChromiumFactory(
    ...
    factory_properties={'sharded_tests': sharded_tests,
                        'ui_total_shards': 5, 'ui_shard_index': 2,
...
F('dbg_unit_4', win().ChromiumFactory(
    ...
    factory_properties={'sharded_tests': sharded_tests,
                        'ui_total_shards': 5, 'ui_shard_index': 3,
...
F('dbg_unit_5', win().ChromiumFactory(
    ...
    tests=['ui', 'browser_tests'],
    factory_properties={'sharded_tests': sharded_tests,
                        'ui_total_shards': 5, 'ui_shard_index': 4,
...
F('dbg_unit_6', win().ChromiumFactory(
    ...
    tests=['ui', 'browser_tests'],
    factory_properties={'sharded_tests': sharded_tests,
                        'ui_total_shards': 5, 'ui_shard_index': 5,
