...
#F('rel_sync', win().ChromiumGITFactory(
#    slave_type='Tester',
#    build_url=rel_archive,
...
#F('rel_nacl', win().ChromiumGITFactory(
#    slave_type='Tester',
#    build_url=rel_archive,
...
#  auto_reboot=True)
#F('rel_cf', win().ChromiumGITFactory(
#    slave_type='Tester',
#    build_url=rel_archive,
#    tests=['chrome_frame'],
#    factory_properties={'process_dumps': True,
...
#  builddir='cr-win-2010-dbg')
#F('dbg_2010', win().ChromiumGITFactory(
#    target='Debug',
#    slave_type='Builder',
...
#  auto_reboot=True)
#F('dbg_unit_1', win().ChromiumGITFactory(
#    target='Debug',
#    slave_type='Tester',
...
#  auto_reboot=True)
#F('dbg_unit_2', win().ChromiumGITFactory(
#    target='Debug',
#    slave_type='Tester',
#    build_url=dbg_archive,
...
#  auto_reboot=True)
#F('dbg_unit_3', win().ChromiumGITFactory(
#      target='Debug',
#      slave_type='Tester',
#      build_url=dbg_archive,
...
#  auto_reboot=True)
#F('dbg_unit_4', win().ChromiumGITFactory(
#    target='Debug',
#    slave_type='Tester',
#    build_url=dbg_archive,
#    tests=['browser_tests'],
...
#  auto_reboot=True)
#F('dbg_unit_5', win().ChromiumGITFactory(
#    target='Debug',
#    slave_type='Tester',
#    build_url=dbg_archive,
#    tests=['browser_tests'],
...
#  auto_reboot=True)
#F('dbg_unit_6', win().ChromiumGITFactory(
#    target='Debug',
#    slave_type='Tester',
#    build_url=dbg_archive,
#    tests=['browser_tests'],
...
#F('dbg_int', win().ChromiumGITFactory(
#    target='Debug',
#    slave_type='Tester',
#    build_url=dbg_archive,
...
#F('dbg_shared', win().ChromiumGITFactory(
#    target='Debug',
#    slave_type='Builder',
#    project='all.sln',
#    factory_properties={'gclient_env':
