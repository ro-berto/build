...
"""Sends a test request to a TRS server. The request is taken from a file
as specified on the command line and must be formatted as explained in
...
def main():
  ...
  parser.add_option('-t', '--sleep_time', type='int', default=60,
                    help='The time, in seconds, to wait between '
