...
V8_LKGR_STEPS = {
  'client.v8': {
    ...
    'V8 Linux - debug': ['Check', 'Test262'],
    'V8 Linux - debug - mozilla': ['Mozilla'],
    'V8 Linux - shared': V8_NORMAL_STEPS,
    'V8 Linux64 - builder': ['compile'],
    'V8 Linux64 - debug builder': ['compile'],
    'V8 Linux64': ['Check', 'Test262', 'Mozilla', 'Static-Initializers'],
    'V8 Linux64 - debug': ['Check', 'Webkit'],
    'V8 Linux64 - debug - mozilla': ['Mozilla'],
    'V8 Linux64 - debug - test262': ['Test262'],
    'V8 Linux - nosnap': ['Check', 'Test262', 'Mozilla'],
    'V8 Linux - nosnap - debug': ['Check'],
    'V8 Linux - nosnap - debug - mozilla': ['Mozilla'],
    'V8 Linux - nosnap - debug - test262': ['Test262'],
    ...
    'V8 Win32 - debug': ['Check', 'Webkit'],
    'V8 Win32 - debug - mozilla - 1': ['Mozilla'],
    'V8 Win32 - debug - mozilla - 2': ['Mozilla'],
    'V8 Win32 - debug - test262 - 1': ['Test262'],
    'V8 Win32 - debug - test262 - 2': ['Test262'],
