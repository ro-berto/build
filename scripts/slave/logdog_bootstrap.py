...
_STABLE_CIPD_TAG = 'git_revision:c64d92cc5a23f78580ec803adff517cdb49f0d2b'
...
_PLATFORM_CONFIG = {
  ...
  ('win',): {
    ...
    'annotee_relpath': 'logdog_butler.exe',
  },
  ('win', 32): {
