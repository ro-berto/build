...
_FALLBACKINSETUPSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='failed_to_update_required_files', full_name='devtools_goma.FallbackInSetupStats.failed_to_update_required_files', index=6,
