...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#434)(self):**

&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#750)(self):**

&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1398)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_rietveld](/scripts/slave/recipe_modules/v8/api.py#269)(self):**
...
&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#600)(self, \*\*kwargs):**

&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#826)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#832)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#839)(self):**
...
&mdash; **def [dr\_compile](/scripts/slave/recipe_modules/v8/api.py#668)(self):**

&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1137)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1001)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#757)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#822)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1374)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1327)(self):**

&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#761)(self):**

Delete all gcov counter files.

&mdash; **def [init\_tryserver](/scripts/slave/recipe_modules/v8/api.py#215)(self):**

&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#842)(self, tests):**

&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#459)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#697)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/v8/api.py#185)(self):**

&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1420)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#902)(self, test_results):**
...
&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1238)(self, \*\*additional_properties):**

&mdash; **def [peek\_gn](/scripts/slave/recipe_modules/v8/api.py#382)(self):**

Runs gn and compares flags with gyp (fyi only).

&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1436)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1445)(self, ref, step_name_desc):**

Read and return the version at a paricular ref.

&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#455)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1425)(self, culprit_range):**

&emsp; **@property**<br>&mdash; **def [run\_dynamorio](/scripts/slave/recipe_modules/v8/api.py#685)(self):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#350)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#847)(self, tests):**

&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#305)(self):**

&mdash; **def [setup\_mips\_toolchain](/scripts/slave/recipe_modules/v8/api.py#416)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#438)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/v8/api.py#451)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#442)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#446)(self):**

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1163)(self):**

&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#195)(self):**
...
&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#768)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1449)(blob):**
