...
&mdash; **def [deapply\_deps](/scripts/slave/recipe_modules/chromium_tests/api.py#1236)(self, bot_update_step):**

&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#840)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#722)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None, read_gn_args=True):**
...
&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#1004)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#377)(self, bot_config, bot_db, tests):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#1038)(self, bot_config=None):**
...
&mdash; **def [integration\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1254)(self, builders=None, bots=None):**
...
&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1070)(self, mb_config_path=None, builders=None):**
...
&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#695)(self, compile_targets, isolated_targets, name_suffix, mb_mastername=None, mb_buildername=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=False, android_version_code=None, android_version_name=None):**

&mdash; **def [run\_tests\_with\_and\_without\_changes](/scripts/slave/recipe_modules/chromium_tests/api.py#1264)(self, builders, mirrored_bots, deapply_changes):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1259)(self, builders=None, trybots=None):**

&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#106)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#781)(self, bot_config, tests=None):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/devtools/devtools-frontend.py#19)(api):**

&mdash; **def [run\_script](/scripts/slave/recipes/devtools/devtools-frontend.py#43)(api, step_name, script):**
...
&mdash; **def [AddFiles](/scripts/slave/recipes/flutter/engine.py#188)(api, pkg, relative_paths):**

&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#323)(api):**
...
&mdash; **def [BuildFuchsia](/scripts/slave/recipes/flutter/engine.py#633)(api):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#902)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#1032)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#491)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#370)(api, swarming_task_id):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#715)(api):**

&mdash; **def [BuildNoGoma](/scripts/slave/recipes/flutter/engine.py#73)(api, config, \*targets):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#1062)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#950)(api):**
...
&mdash; **def [DownloadFuchsiaSystemImage](/scripts/slave/recipes/flutter/engine.py#539)(api, target_dir, bucket_name, build_id, image_name):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#1079)(api):**

&mdash; **def [GetCheckoutPath](/scripts/slave/recipes/flutter/engine.py#48)(api):**

&mdash; **def [GetCloudMavenPath](/scripts/slave/recipes/flutter/engine.py#211)(api, artifact_filename):**
...
&mdash; **def [GetFuchsiaBuildId](/scripts/slave/recipes/flutter/engine.py#530)(api):**
...
&emsp; **@contextmanager**<br>&mdash; **def [InstallGems](/scripts/slave/recipes/flutter/engine.py#1047)(api):**

&mdash; **def [IsolateFuchsiaTestArtifacts](/scripts/slave/recipes/flutter/engine.py#561)(api, checkout, fuchsia_tools, image_name):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#314)(api, label):**

&mdash; **def [PackageFlutterRunnerTests](/scripts/slave/recipes/flutter/engine.py#546)(api, checkout, fuchsia_tools):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#819)(api, label, arm64_out, armv7_out, sim_out, bucket_name, strip_bitcode=False):**
...
&mdash; **def [RunIOSTests](/scripts/slave/recipes/flutter/engine.py#891)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#1100)(api, properties, env_properties):**
...
&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#708)(api):**

&mdash; **def [ShouldUploadPackages](/scripts/slave/recipes/flutter/engine.py#51)(api):**

&mdash; **def [TestFuchsia](/scripts/slave/recipes/flutter/engine.py#590)(api):**
...
&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#698)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#193)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#269)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#299)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#277)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#251)(api, dir_label, parent_dir, folder_name, zip_name, platform=None):**

&mdash; **def [UploadMavenArtifacts](/scripts/slave/recipes/flutter/engine.py#234)(api, artifacts):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#343)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [UploadWebSdk](/scripts/slave/recipes/flutter/engine.py#306)(api, archive_name):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#332)(api):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/1e9e3d2e9e799335f7b20d076e3efd5d6b019480/recipes/README.recipes.md#recipe_modules-windows_sdk
[recipe_engine/recipe_modules/assertions]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9217b5d873035e5f0a4b5c2debe089217432e482/README.recipes.md#recipe_modules-assertions
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9217b5d873035e5f0a4b5c2debe089217432e482/README.recipes.md#recipe_modules-generator_script
[recipe_engine/recipe_modules/isolated]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9217b5d873035e5f0a4b5c2debe089217432e482/README.recipes.md#recipe_modules-isolated
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9217b5d873035e5f0a4b5c2debe089217432e482/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9217b5d873035e5f0a4b5c2debe089217432e482/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9217b5d873035e5f0a4b5c2debe089217432e482/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9217b5d873035e5f0a4b5c2debe089217432e482/README.recipes.md#recipe_modules-swarming
[recipe_engine/recipe_modules/time]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9217b5d873035e5f0a4b5c2debe089217432e482/README.recipes.md#recipe_modules-time
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9217b5d873035e5f0a4b5c2debe089217432e482/recipe_engine/util.py#135
