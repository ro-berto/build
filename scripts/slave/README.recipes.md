...
&mdash; **def [apply\_bot\_config](/scripts/slave/recipe_modules/v8/api.py#152)(self, bot_config):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#290)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#249)(self, revision=None, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/v8/api.py#219)(self):**
...
&mdash; **def [set\_gclient\_custom\_var](/scripts/slave/recipe_modules/v8/api.py#210)(self, var_name):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#306)(self):**
...
&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#229)(self):**
...
&mdash; **def [update\_bot\_config](/scripts/slave/recipe_modules/v8/api.py#125)(self, bot_config, build_config, target_arch, target_platform):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/b496b6a0570bd4c9be2c1034ae1b5ae4360b327b/recipes/README.recipes.md#recipe_modules-gerrit
