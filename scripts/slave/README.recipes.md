...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1344)(self, step_name, gs_bucket, gs_acl=None, mode=None, build_name=None, \*\*kwargs):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#878)(self):**
...
&mdash; **def [delete\_old\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#831)(self):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#797)(self, client_type='release'):**

&mdash; **def [ensure\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#840)(self):**

&mdash; **def [ensure\_toolchains](/scripts/slave/recipe_modules/chromium/api.py#874)(self):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1387)(self, _):**
...
&mdash; **def [get\_mac\_toolchain\_installer](/scripts/slave/recipe_modules/chromium/api.py#817)(self):**

&mdash; **def [get\_version](/scripts/slave/recipe_modules/chromium/api.py#157)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_analyze](/scripts/slave/recipe_modules/chromium/api.py#1112)(self, mastername, buildername, analyze_input, name=None, mb_path=None, mb_config_path=None, chromium_config=None, build_dir=None, phase=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_isolate\_everything](/scripts/slave/recipe_modules/chromium/api.py#1306)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_lookup](/scripts/slave/recipe_modules/chromium/api.py#1155)(self, mastername, buildername, name=None, mb_path=None, mb_config_path=None, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None):**
...
&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1332)(self, \*\*kwargs):**

&mdash; **def [reload\_version](/scripts/slave/recipe_modules/chromium/api.py#162)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#930)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb\_cmd](/scripts/slave/recipe_modules/chromium/api.py#1007)(self, name, mb_command, mastername, buildername, mb_path=None, mb_config_path=None, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, additional_args=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#888)(self, env=None, \*\*kwargs):**
...
&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1326)(self):**
...
&mdash; **def [collect\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#940)(self, task, \*\*kwargs):**
...
&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/chromium_swarming/api.py#1517)(self, project_name, precommit, mastername=None, default_priority=None):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/chromium_swarming/api.py#1469)(self, task):**

SwarmingTask -> argument list for go swarming command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/chromium_swarming/api.py#1366)(self, prefix, task):**
...
&mdash; **def [report\_stats](/scripts/slave/recipe_modules/chromium_swarming/api.py#968)(self):**
...
&mdash; **def [trigger\_task\_shard](/scripts/slave/recipe_modules/chromium_swarming/api.py#746)(self, task, shard_index, \*\*kwargs):**
...
&mdash; **def [wait\_for\_finished\_task\_set](/scripts/slave/recipe_modules/chromium_swarming/api.py#1265)(self, task_sets, suffix=None, attempts=0):**
...
&mdash; **def [shard\_merge](/scripts/slave/recipe_modules/clang_coverage/api.py#337)(self, step_name):**
...
&mdash; **def [checkout\_generated\_files\_repo\_and\_sync](/scripts/slave/recipe_modules/codesearch/api.py#216)(self):**
...
&mdash; **def [delete\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#511)(self):**
...
&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#499)(self):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#517)(self, test_data):**
...
&mdash; **def [create\_results\_from\_json](/scripts/slave/recipe_modules/test_utils/api.py#528)(self, data):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [gtest\_results](/scripts/slave/recipe_modules/test_utils/api.py#541)(self, add_json_log=True):**
...
&mdash; **def [summarize\_findit\_flakiness](/scripts/slave/recipe_modules/test_utils/api.py#448)(self, caller_api, test_suites):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_results](/scripts/slave/recipe_modules/test_utils/api.py#531)(self, add_json_log=True):**
...
&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1404)(self, requests, project=None, bucket=None, step_name='trigger'):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1522)(self, sequence, subsequence, value):**
...
&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1217)(self):**
...
&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1498)(self, bisect_range):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1441)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1544)(self, available_bisect_range):**
...
&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1321)(self, test_spec=v8_builders.EmptyTestSpec, \*\*additional_properties):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1560)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1569)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1549)(self, culprit_range):**
...
&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1243)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1573)(blob):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_codesearch.py#147)(api, root_solution_revision, root_solution_revision_timestamp):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/codesearch/examples/full.py#55)(api):**
...
&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/dart/flutter_engine.py#42)(api, checkout_dir):**

&mdash; **def [Build](/scripts/slave/recipes/dart/flutter_engine.py#27)(api, checkout_dir, config, \*targets):**

&mdash; **def [BuildAndTest](/scripts/slave/recipes/dart/flutter_engine.py#239)(api, start_dir, checkout_dir):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/dart/flutter_engine.py#70)(api, checkout_dir):**

&mdash; **def [BuildLinuxAndroidArm](/scripts/slave/recipes/dart/flutter_engine.py#55)(api, checkout_dir):**

&mdash; **def [BuildLinuxAndroidx86](/scripts/slave/recipes/dart/flutter_engine.py#50)(api, checkout_dir):**

&mdash; **def [CopyArtifacts](/scripts/slave/recipes/dart/flutter_engine.py#116)(api, engine_src, cached_dest, file_paths):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/dart/flutter_engine.py#89)(api):**

&mdash; **def [KillTasks](/scripts/slave/recipes/dart/flutter_engine.py#20)(api, checkout_dir, ok_ret='any'):**

Kills leftover tasks from previous runs or steps.

&mdash; **def [RunGN](/scripts/slave/recipes/dart/flutter_engine.py#35)(api, checkout_dir, \*args):**

&mdash; **def [RunSteps](/scripts/slave/recipes/dart/flutter_engine.py#216)(api):**

&mdash; **def [TestEngine](/scripts/slave/recipes/dart/flutter_engine.py#46)(api, checkout_dir):**

&mdash; **def [TestFlutter](/scripts/slave/recipes/dart/flutter_engine.py#186)(api, start_dir, just_built_dart_sdk):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/dart/flutter_engine.py#80)(api, checkout_dir):**

&mdash; **def [UpdateCachedEngineArtifacts](/scripts/slave/recipes/dart/flutter_engine.py#128)(api, flutter, engine_src):**
...
&mdash; **def [AddFiles](/scripts/slave/recipes/flutter/engine.py#104)(api, pkg, relative_paths):**

&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#171)(api):**

&mdash; **def [Build](/scripts/slave/recipes/flutter/engine.py#39)(api, config, \*targets, \*\*kwargs):**

&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#534)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#646)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#296)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#217)(api):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#375)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#676)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#564)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#692)(api):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#32)(api, path):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallJazzy](/scripts/slave/recipes/flutter/engine.py#661)(api):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#162)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#469)(api, label, arm64_out, armv7_out, sim_out, bucket_name):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/engine.py#350)(api, ios_tools_path, target_version):**

Locates and switches to a version of Xcode matching target_version.

&mdash; **def [RunGN](/scripts/slave/recipes/flutter/engine.py#89)(api, \*args):**

&mdash; **def [RunHostTests](/scripts/slave/recipes/flutter/engine.py#50)(api, out_dir, exe_extension=''):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#707)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#362)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#332)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#112)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#139)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#154)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#147)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#126)(api, dir_label, parent_dir, folder_name, zip_name):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#191)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#180)(api):**
...
&mdash; **def [BuildExamples](/scripts/slave/recipes/flutter/flutter.py#132)(api, git_hash, flutter_executable):**

&mdash; **def [CreateAndUploadFlutterPackage](/scripts/slave/recipes/flutter/flutter.py#302)(api, git_hash, branch):**

Prepares, builds, and uploads an all-inclusive archive package.

&mdash; **def [DecryptKMS](/scripts/slave/recipes/flutter/flutter.py#106)(api, step_name, crypto_key_path, ciphertext_file, plaintext_file):**

&mdash; **def [EnsureCloudKMS](/scripts/slave/recipes/flutter/flutter.py#96)(api, version=None):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/flutter.py#126)(api, git_hash, path):**

&mdash; **def [GetGradleDirName](/scripts/slave/recipes/flutter/flutter.py#241)(api):**

&mdash; **def [GetGradleDistributionUrl](/scripts/slave/recipes/flutter/flutter.py#231)(api):**

&mdash; **def [GetGradleZipFileName](/scripts/slave/recipes/flutter/flutter.py#237)(api):**

&mdash; **def [GetPuppetApiTokenPath](/scripts/slave/recipes/flutter/flutter.py#117)(api, token_name):**

Returns the path to a the token file

The file is located where ChromeOps Puppet drops generic secrets.

&emsp; **@contextmanager**<br>&mdash; **def [Install7za](/scripts/slave/recipes/flutter/flutter.py#58)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallGem](/scripts/slave/recipes/flutter/flutter.py#84)(api, gem_name, gem_version):**

&mdash; **def [InstallGradle](/scripts/slave/recipes/flutter/flutter.py#244)(api, checkout):**

&mdash; **def [InstallOpenJDK](/scripts/slave/recipes/flutter/flutter.py#72)(api):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/flutter.py#201)(api, ios_tools_path, target_version):**

Locates and switches to a version of Xcode matching target_version.

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/flutter.py#337)(api):**

&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/flutter.py#215)(api):**

&mdash; **def [UploadFlutterCoverage](/scripts/slave/recipes/flutter/flutter.py#263)(api):**
...
[DEPS](/scripts/slave/recipes/v8/node_integration_ng.py#11): [chromium](#recipe_modules-chromium), [commit\_position](#recipe_modules-commit_position), [goma](#recipe_modules-goma), [v8](#recipe_modules-v8), [zip](#recipe_modules-zip), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/gsutil][depot_tools/recipe_modules/gsutil], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

Recipe to test v8/node.js integration.

&mdash; **def [RunSteps](/scripts/slave/recipes/v8/node_integration_ng.py#42)(api, triggers, v8_tot):**
...
[DEPS](/scripts/slave/recipes/v8/verify_flakes.py#19): [v8](#recipe_modules-v8), [depot\_tools/gitiles][depot_tools/recipe_modules/gitiles], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/verify_flakes.py#30)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/webrtc/ios.py#435)(api):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/fe34723a55ec71b235512eac5ad561faf3151d6e/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/cq]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/81bee2d517dae82881c1193fe9e4860fc7355f5b/README.recipes.md#recipe_modules-cq
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/81bee2d517dae82881c1193fe9e4860fc7355f5b/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/81bee2d517dae82881c1193fe9e4860fc7355f5b/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/81bee2d517dae82881c1193fe9e4860fc7355f5b/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/81bee2d517dae82881c1193fe9e4860fc7355f5b/recipe_engine/util.py#132
