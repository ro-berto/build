...
&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#393)(self, mastername, buildername, update_step, bot_db):**

&emsp; **@property**<br>&mdash; **def [builders](/scripts/slave/recipe_modules/chromium_tests/api.py#36)(self):**

&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#297)(self, bot_config, update_step, bot_db, compile_targets, tests_including_triggered, mb_mastername=None, mb_buildername=None, mb_config_path=None, override_bot_type=None):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#665)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#547)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None):**
...
&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#758)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#290)(self, bot_config, bot_db, tests):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#798)(self, bot_config=None):**
...
&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#830)(self, mb_config_path=None, bot_config=None):**
...
&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#527)(self, compile_targets, isolated_targets, name_suffix, mb_mastername=None, mb_buildername=None, mb_config_path=None):**

&mdash; **def [run\_tests\_on\_tryserver](/scripts/slave/recipe_modules/chromium_tests/api.py#677)(self, bot_config, tests, bot_update_step, affected_files, mb_mastername=None, mb_buildername=None, disable_deapply_patch=False):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#859)(self):**

&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#44)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#601)(self, bot_config, tests=None):**
...
#### **class [SwarmingApi](/scripts/slave/recipe_modules/swarming/api.py#141)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [add\_default\_tag](/scripts/slave/recipe_modules/swarming/api.py#383)(self, tag):**
...
&mdash; **def [check\_client\_version](/scripts/slave/recipe_modules/swarming/api.py#613)(self, step_test_data=None):**

Yields steps to verify compatibility with swarming_client version.

&mdash; **def [collect](/scripts/slave/recipe_modules/swarming/api.py#836)(self, tasks, \*\*kwargs):**
...
&mdash; **def [collect\_task](/scripts/slave/recipe_modules/swarming/api.py#799)(self, task, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [default\_dimensions](/scripts/slave/recipe_modules/swarming/api.py#328)(self):**
...
&emsp; **@property**<br>&mdash; **def [default\_env](/scripts/slave/recipe_modules/swarming/api.py#351)(self):**
...
&emsp; **@default_expiration.setter**<br>&mdash; **def [default\_expiration](/scripts/slave/recipe_modules/swarming/api.py#251)(self, value):**

&emsp; **@default_hard_timeout.setter**<br>&mdash; **def [default\_hard\_timeout](/scripts/slave/recipe_modules/swarming/api.py#268)(self, value):**

&emsp; **@default_idempotent.setter**<br>&mdash; **def [default\_idempotent](/scripts/slave/recipe_modules/swarming/api.py#307)(self, value):**

&emsp; **@default_io_timeout.setter**<br>&mdash; **def [default\_io\_timeout](/scripts/slave/recipe_modules/swarming/api.py#287)(self, value):**

&emsp; **@default_priority.setter**<br>&mdash; **def [default\_priority](/scripts/slave/recipe_modules/swarming/api.py#378)(self, value):**

&emsp; **@default_user.setter**<br>&mdash; **def [default\_user](/scripts/slave/recipe_modules/swarming/api.py#323)(self, value):**

&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/swarming/api.py#1217)(self, task):**

SwarmingTask -> argument list for 'swarming.py' command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/swarming/api.py#1147)(self, prefix, task):**
...
&mdash; **def [gtest\_task](/scripts/slave/recipe_modules/swarming/api.py#532)(self, title, isolated_hash, test_launcher_summary_output=None, extra_args=None, cipd_packages=None, merge=None, \*\*kwargs):**
...
&mdash; **def [isolated\_script\_task](/scripts/slave/recipe_modules/swarming/api.py#578)(self, title, isolated_hash, extra_args=None, idempotent=False, merge=None, \*\*kwargs):**
...
&emsp; **@staticmethod**<br>&mdash; **def [prefered\_os\_dimension](/scripts/slave/recipe_modules/swarming/api.py#412)(platform):**
...
&mdash; **def [set\_default\_dimension](/scripts/slave/recipe_modules/swarming/api.py#343)(self, key, value):**

&mdash; **def [set\_default\_env](/scripts/slave/recipe_modules/swarming/api.py#362)(self, key, value):**

&emsp; **@show_isolated_out_in_collect_step.setter**<br>&mdash; **def [show\_isolated\_out\_in\_collect\_step](/scripts/slave/recipe_modules/swarming/api.py#399)(self, value):**

&emsp; **@show_shards_in_collect_step.setter**<br>&mdash; **def [show\_shards\_in\_collect\_step](/scripts/slave/recipe_modules/swarming/api.py#408)(self, value):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [summary](/scripts/slave/recipe_modules/swarming/api.py#214)(self):**
...
&mdash; **def [task](/scripts/slave/recipe_modules/swarming/api.py#430)(self, title, isolated_hash, ignore_task_failure=False, shards=1, task_output_dir=None, extra_args=None, idempotent=None, cipd_packages=None, build_properties=None, merge=None, trigger_script=None, named_caches=None, service_account=None, raw_cmd=None, env_prefixes=None):**
...
&mdash; **def [trigger](/scripts/slave/recipe_modules/swarming/api.py#827)(self, tasks, \*\*kwargs):**
...
&mdash; **def [trigger\_task](/scripts/slave/recipe_modules/swarming/api.py#618)(self, task, \*\*kwargs):**
