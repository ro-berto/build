...
&mdash; **def [create\_results\_from\_json](/scripts/slave/recipe_modules/test_utils/api.py#438)(self, data):**

&mdash; **def [create\_results\_from\_json\_if\_needed](/scripts/slave/recipe_modules/test_utils/api.py#441)(self, data):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [gtest\_results](/scripts/slave/recipe_modules/test_utils/api.py#458)(self, add_json_log=True):**
...
&mdash; **def [summarize\_test\_with\_patch\_deapplied](/scripts/slave/recipe_modules/test_utils/api.py#317)(self, caller_api, test_suite):**
...
&mdash; **def [summarize\_test\_with\_patch\_reapplied](/scripts/slave/recipe_modules/test_utils/api.py#361)(self, caller_api, test_suite):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_results](/scripts/slave/recipe_modules/test_utils/api.py#448)(self, add_json_log=True):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#492)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#599)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#266)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#193)(api):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#344)(api):**
...
&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#520)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#642)(api):**
...
&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#427)(api, label, arm64_out, armv7_out, sim_out, bucket_name):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/engine.py#319)(api, ios_tools_path, target_version):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#661)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#331)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#301)(api):**
...
&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#176)(api, upload_dir, lib_flutter_path, android_triple):**
...
&mdash; **def [GetGradleDirName](/scripts/slave/recipes/flutter/flutter.py#201)(api):**

&mdash; **def [GetGradleDistributionUrl](/scripts/slave/recipes/flutter/flutter.py#191)(api):**

&mdash; **def [GetGradleZipFileName](/scripts/slave/recipes/flutter/flutter.py#197)(api):**
...
&mdash; **def [InstallGradle](/scripts/slave/recipes/flutter/flutter.py#204)(api, checkout):**

&mdash; **def [InstallOpenJDK](/scripts/slave/recipes/flutter/flutter.py#58)(api):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/flutter.py#161)(api, ios_tools_path, target_version):**

Locates and switches to a version of Xcode matching target_version.

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/flutter.py#291)(api):**

&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/flutter.py#175)(api):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/26ffa944643443f809b6eed9646821abe1d706ee/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/1886f5a16a7736b63988858884cf7f7f7adf3637/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/1886f5a16a7736b63988858884cf7f7f7adf3637/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/1886f5a16a7736b63988858884cf7f7f7adf3637/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/1886f5a16a7736b63988858884cf7f7f7adf3637/recipe_engine/util.py#132
