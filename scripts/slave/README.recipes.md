...
&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1462)(self, bucket, changes, requests, step_name='trigger', service_account='v8-bot', add_buildset_tag=True, no_buildset=False):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1608)(self, sequence, subsequence, value):**
...
&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1584)(self, bisect_range):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1527)(self):**

&mdash; **def [get\_changes](/scripts/slave/recipe_modules/v8/api.py#1456)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1630)(self, available_bisect_range):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1646)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1655)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1635)(self, culprit_range):**
...
&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1659)(blob):**
