...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [apply\_syzyasan](/scripts/slave/recipe_modules/chromium/api.py#971)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#983)(self, step_name, gs_bucket, gs_acl=None, mode=None, \*\*kwargs):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#735)(self):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#717)(self, canary=False):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1065)(self, test_name):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [get\_clang\_version](/scripts/slave/recipe_modules/chromium/api.py#673)(self, \*\*kwargs):**

&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium/api.py#81)(self):**

&mdash; **def [get\_cros\_chrome\_sdk\_wrapper](/scripts/slave/recipe_modules/chromium/api.py#687)(self, clean=False):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [list\_perf\_tests](/scripts/slave/recipe_modules/chromium/api.py#1024)(self, browser, num_shards, device=None):**
...
&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#959)(self, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#783)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gyp\_chromium](/scripts/slave/recipe_modules/chromium/api.py#775)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb](/scripts/slave/recipe_modules/chromium/api.py#846)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, isolated_targets=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, gyp_script=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#745)(self, env=None, \*\*kwargs):**

Run the build-configuration hooks for chromium.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runtest](/scripts/slave/recipe_modules/chromium/api.py#502)(self, test, args=None, xvfb=False, name=None, annotate=None, results_url=None, perf_dashboard_id=None, test_type=None, python_mode=False, parallel=False, point_id=None, revision=None, webkit_revision=None, test_launcher_summary_output=None, flakiness_dash=None, perf_id=None, perf_config=None, chartjson_file=False, disable_src_side_runtest_py=False, tee_stdout_file=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [sizes](/scripts/slave/recipe_modules/chromium/api.py#630)(self, results_url=None, perf_id=None, platform=None, \*\*kwargs):**

Return a sizes.py invocation.
This uses runtests.py to upload the results to the perf dashboard.

&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#953)(self):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_launcher\_filter](/scripts/slave/recipe_modules/chromium/api.py#498)(self, tests):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [update\_clang](/scripts/slave/recipe_modules/chromium/api.py#943)(self):**
...
&mdash; **def [android\_build\_wrapper](/scripts/slave/recipe_modules/chromium_android/api.py#1309)(self, logcat_gs_bucket='chromium-android'):**

&mdash; **def [android\_test\_wrapper](/scripts/slave/recipe_modules/chromium_android/api.py#1326)(self, _logcat_gs_bucket='chromium-android'):**
...
&mdash; **def [common\_tests\_final\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#1290)(self, logcat_gs_bucket='chromium-android', force_latest_version=False, checkout_dir=None):**

&mdash; **def [common\_tests\_setup\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#1266)(self, perf_setup=False, \*\*provision_kwargs):**

&mdash; **def [configure\_from\_properties](/scripts/slave/recipe_modules/chromium_android/api.py#65)(self, config_name, \*\*kwargs):**

&mdash; **def [copy\_gtest\_results](/scripts/slave/recipe_modules/chromium_android/api.py#1071)(self, result_step, active_step):**

&emsp; **@property**<br>&mdash; **def [coverage\_dir](/scripts/slave/recipe_modules/chromium_android/api.py#44)(self):**

&mdash; **def [coverage\_report](/scripts/slave/recipe_modules/chromium_android/api.py#1469)(self, upload=True, \*\*kwargs):**
...
&mdash; **def [create\_result\_details](/scripts/slave/recipe_modules/chromium_android/api.py#1076)(self, step_name, json_results_file):**

&mdash; **def [create\_supersize\_archive](/scripts/slave/recipe_modules/chromium_android/api.py#229)(self, apk_path, size_path):**
...
&mdash; **def [download\_build](/scripts/slave/recipe_modules/chromium_android/api.py#290)(self, bucket, path, extract_path=None):**
...
&mdash; **def [generate\_breakpad\_symbols](/scripts/slave/recipe_modules/chromium_android/api.py#1135)(self, symbols_dir, binary_path, root_chromium_dir):**
...
&mdash; **def [get\_changed\_lines\_for\_revision](/scripts/slave/recipe_modules/chromium_android/api.py#1582)(self):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [handle\_exit\_codes](/scripts/slave/recipe_modules/chromium_android/api.py#1643)(self):**
...
&mdash; **def [incremental\_coverage\_report](/scripts/slave/recipe_modules/chromium_android/api.py#1511)(self):**
...
&mdash; **def [logcat\_dump](/scripts/slave/recipe_modules/chromium_android/api.py#1099)(self, gs_bucket=None):**
...
&mdash; **def [resource\_sizes](/scripts/slave/recipe_modules/chromium_android/api.py#206)(self, apk_path, chartjson_file=False, upload_archives_to_bucket=None, perf_id=None):**

&mdash; **def [run\_bisect\_script](/scripts/slave/recipe_modules/chromium_android/api.py#1333)(self, extra_src='', path_to_config='', \*\*kwargs):**

&mdash; **def [run\_instrumentation\_suite](/scripts/slave/recipe_modules/chromium_android/api.py#970)(self, name, test_apk=None, apk_under_test=None, additional_apks=None, flakiness_dashboard=None, annotation=None, except_annotation=None, screenshot=False, verbose=False, tool=None, apk_package=None, json_results_file=None, timeout_scale=None, strict_mode=None, suffix=None, num_retries=None, device_flags=None, wrapper_script_suite_name=None, result_details=False, store_tombstones=False, trace_output=False, args=None, \*\*kwargs):**

&mdash; **def [run\_java\_unit\_test\_suite](/scripts/slave/recipe_modules/chromium_android/api.py#1393)(self, suite, verbose=True, json_results_file=None, suffix=None, \*\*kwargs):**

&mdash; **def [run\_sharded\_perf\_tests](/scripts/slave/recipe_modules/chromium_android/api.py#812)(self, config, flaky_config=None, perf_id=None, test_type_transform=(lambda x: x), chartjson_file=False, max_battery_temp=None, upload_archives_to_bucket=None, known_devices_file=None, enable_platform_mode=False, timestamp_as_point_id=False, pass_adb_path=True, num_retries=0, json_output=False, \*\*kwargs):**
...
&mdash; **def [run\_telemetry\_browser\_test](/scripts/slave/recipe_modules/chromium_android/api.py#951)(self, test_name, browser='android-chromium'):**

Run a telemetry browser test.

&mdash; **def [run\_test\_suite](/scripts/slave/recipe_modules/chromium_android/api.py#1349)(self, suite, verbose=True, gtest_filter=None, tool=None, result_details=False, store_tombstones=False, name=None, json_results_file=None, shard_timeout=None, args=None, \*\*kwargs):**

&mdash; **def [run\_tree\_truth](/scripts/slave/recipe_modules/chromium_android/api.py#178)(self, additional_repos=None):**

&mdash; **def [run\_webview\_cts](/scripts/slave/recipe_modules/chromium_android/api.py#1428)(self, android_platform, arch, command_line_args=None, suffix=None, result_details=False):**
...
&mdash; **def [stack\_tool\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#1206)(self, force_latest_version=False):**

&mdash; **def [stackwalker](/scripts/slave/recipe_modules/chromium_android/api.py#1159)(self, root_chromium_dir, binary_paths):**
...
&mdash; **def [staged\_files\_matching\_filter](/scripts/slave/recipe_modules/chromium_android/api.py#1623)(self, diff_filter):**
...
&mdash; **def [test\_report](/scripts/slave/recipe_modules/chromium_android/api.py#1249)(self):**

&mdash; **def [test\_runner](/scripts/slave/recipe_modules/chromium_android/api.py#1666)(self, step_name, args=None, wrapper_script_suite_name=None, pass_adb_path=True, \*\*kwargs):**
...
&mdash; **def [upload\_apks\_for\_bisect](/scripts/slave/recipe_modules/chromium_android/api.py#239)(self, update_properties, bucket, path):**

Uploads android apks for functional bisects.

&mdash; **def [upload\_build](/scripts/slave/recipe_modules/chromium_android/api.py#265)(self, bucket, path):**
...
&mdash; **def [build](/scripts/slave/recipe_modules/dart/api.py#28)(self, build_args=[], isolate=None):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/dart/api.py#100)(self, tasks):**
...
&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#132)(self):**

Reads the debug.log file

&mdash; **def [read\_result\_file](/scripts/slave/recipe_modules/dart/api.py#116)(self, name, log_name, test_data=''):**
...
&mdash; **def [shard](/scripts/slave/recipe_modules/dart/api.py#65)(self, title, isolate_hash, test_args, os=None, cpu='x86-64', pool='Dart.LUCI'):**
...
&mdash; **def [build\_with\_goma](/scripts/slave/recipe_modules/goma/api.py#413)(self, ninja_command, name=None, ninja_log_outdir=None, ninja_log_compiler=None, goma_env=None, ninja_env=None, \*\*kwargs):**
...
&mdash; **def [stop](/scripts/slave/recipe_modules/goma/api.py#296)(self, ninja_log_outdir=None, ninja_log_compiler=None, ninja_log_command=None, ninja_log_exit_status=None, \*\*kwargs):**
...
&mdash; **def [bootstrap\_swarming](/scripts/slave/recipe_modules/ios/api.py#475)(self):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#705)(self, tasks, upload_test_results=True):**
...
&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#841)(self, path):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#482)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#546)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_test](/scripts/slave/recipe_modules/ios/api.py#487)(self, test, tmp_dir, isolate_template):**

Isolates a single test.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#896)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#883)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#911)(self):**
...
&mdash; **def [symupload](/scripts/slave/recipe_modules/ios/api.py#399)(self, artifact, url):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#860)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True):**

Runs tests on Swarming as instructed by this bot's build config.

&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#636)(self, tasks):**

Triggers the given Swarming tasks.

&mdash; **def [upload](/scripts/slave/recipe_modules/ios/api.py#445)(self, base_path=None):**

Uploads built artifacts as instructed by this bot's build config.

&mdash; **def [upload\_tgz](/scripts/slave/recipe_modules/ios/api.py#414)(self, artifact, bucket, path):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1426)(self, sequence, subsequence, value):**
...
&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#598)(self, \*\*kwargs):**
...
&mdash; **def [dr\_compile](/scripts/slave/recipe_modules/v8/api.py#666)(self):**
...
&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1402)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1355)(self):**
...
&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#457)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#695)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/v8/api.py#183)(self):**

&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1448)(self, available_bisect_range):**
...
&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#712)(self, update_step):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1241)(self, \*\*additional_properties):**

&mdash; **def [peek\_gn](/scripts/slave/recipe_modules/v8/api.py#380)(self):**

Runs gn and compares flags with gyp (fyi only).

&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1464)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1473)(self, ref, step_name_desc):**

Read and return the version at a paricular ref.

&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#453)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1453)(self, culprit_range):**

&emsp; **@property**<br>&mdash; **def [run\_dynamorio](/scripts/slave/recipe_modules/v8/api.py#683)(self):**
...
&mdash; **def [setup\_mips\_toolchain](/scripts/slave/recipe_modules/v8/api.py#414)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#436)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/v8/api.py#449)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#440)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#444)(self):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#687)(self, name_suffix='', archive=None):**
...
&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#704)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1477)(blob):**
...
&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#250)(self):**

&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#166)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#138)(self, \*\*kwargs):**

&mdash; **def [clean\_test\_output](/scripts/slave/recipe_modules/webrtc/api.py#333)(self):**

Remove all test output in out/, since we have tests leaking files.

&mdash; **def [cleanup](/scripts/slave/recipe_modules/webrtc/api.py#326)(self):**

&mdash; **def [compile](/scripts/slave/recipe_modules/webrtc/api.py#176)(self):**

&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/webrtc/api.py#102)(self):**

&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#158)(self):**

&mdash; **def [extract\_build](/scripts/slave/recipe_modules/webrtc/api.py#305)(self):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#227)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#290)(self):**

&mdash; **def [package\_build](/scripts/slave/recipe_modules/webrtc/api.py#240)(self):**

&mdash; **def [run\_baremetal\_test](/scripts/slave/recipe_modules/webrtc/api.py#222)(self, test, name=None, gtest_args=None, args=None, parallel=True):**

&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#170)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#185)(self):**
...
&emsp; **@property**<br>&mdash; **def [should\_download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#51)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/webrtc/api.py#47)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/webrtc/api.py#35)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test\_android\_studio\_project\_generation](/scripts/slave/recipe_modules/webrtc/api.py#43)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/webrtc/api.py#39)(self):**

&mdash; **def [virtual\_webcam\_check](/scripts/slave/recipe_modules/webrtc/api.py#341)(self):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/boringssl.py#177)(api, buildername):**
...
&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#370)(api):**
...
&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#386)(api):**
...
&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#402)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#417)(api):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/a5b7d73e7b2537e3eb3ccb3a2f3b18aa1f2b25af/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3e09a61a1ad7c8f21e2ce2afd7240855c318d7ce/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3e09a61a1ad7c8f21e2ce2afd7240855c318d7ce/README.recipes.md#recipe_modules-service_account
