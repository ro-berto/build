...
&mdash; **def [bootstrap\_swarming](/scripts/slave/recipe_modules/ios/api.py#495)(self):**

Bootstraps Swarming.

&emsp; **@property**<br>&mdash; **def [bucket](/scripts/slave/recipe_modules/ios/api.py#53)(self):**

&mdash; **def [build](/scripts/slave/recipe_modules/ios/api.py#271)(self, analyze=False, default_gn_args_path=None, mb_path=None, setup_gn=False, suffix=None, use_mb=True):**
...
&mdash; **def [checkout](/scripts/slave/recipe_modules/ios/api.py#90)(self, gclient_apply_config=None, \*\*kwargs):**
...
&mdash; **def [parse\_tests](/scripts/slave/recipe_modules/ios/api.py#108)(self, tests, include_dir, start_index=0):**
...
&emsp; **@property**<br>&mdash; **def [platform](/scripts/slave/recipe_modules/ios/api.py#67)(self):**

&mdash; **def [read\_build\_config](/scripts/slave/recipe_modules/ios/api.py#169)(self, master_name=None, build_config_base_dir=None, buildername=None):**
...
&mdash; **def [symupload](/scripts/slave/recipe_modules/ios/api.py#419)(self, artifact, url):**
...
&mdash; **def [upload](/scripts/slave/recipe_modules/ios/api.py#465)(self, base_path=None):**

Uploads built artifacts as instructed by this bot's build config.

&mdash; **def [upload\_tgz](/scripts/slave/recipe_modules/ios/api.py#434)(self, artifact, bucket, path):**
...
&emsp; **@property**<br>&mdash; **def [use\_goma](/scripts/slave/recipe_modules/ios/api.py#80)(self):**
