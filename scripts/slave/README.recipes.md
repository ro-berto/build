...
&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#826)(self, bot_config=None):**
...
&mdash; **def [trigger\_child\_builds](/scripts/slave/recipe_modules/chromium_tests/api.py#515)(self, mastername, buildername, update_step, bot_db, additional_properties=None):**
...
&mdash; **def [checkout\_generated\_files\_repo\_and\_sync](/scripts/slave/recipe_modules/codesearch/api.py#202)(self):**
...
&mdash; **def [build\_with\_goma](/scripts/slave/recipe_modules/goma/api.py#484)(self, ninja_command, name=None, ninja_log_outdir=None, ninja_log_compiler=None, goma_env=None, ninja_env=None, \*\*kwargs):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#934)(self, tasks, upload_test_results=True):**
...
&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#1108)(self, path):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#569)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#725)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_earlgrey\_test](/scripts/slave/recipe_modules/ios/api.py#670)(self, test, shard_size, tmp_dir, isolate_template):**

Isolate earlgrey test into small shards

&mdash; **def [isolate\_test](/scripts/slave/recipe_modules/ios/api.py#590)(self, test, tmp_dir, isolate_template, test_cases=None, shard_num=None):**

Isolates a single test.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#1193)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#1180)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#1208)(self):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#1157)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True):**

Runs tests on Swarming as instructed by this bot's build config.

&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#825)(self, tasks):**
...
&mdash; **def [collect\_task](/scripts/slave/recipe_modules/swarming/api.py#810)(self, task, \*\*kwargs):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/swarming/api.py#1211)(self, task):**

SwarmingTask -> argument list for 'swarming.py' command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/swarming/api.py#1144)(self, prefix, task):**
...
&mdash; **def [apply\_bot\_config](/scripts/slave/recipe_modules/v8/api.py#147)(self, bot_config):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#354)(self):**
...
&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1357)(self, bucket, changes, requests, step_name='trigger', service_account='v8-bot', no_buildset=False):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1485)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#285)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#244)(self, revision=None, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#561)(self, test_spec=EmptyTestSpec, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#813)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#819)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#826)(self):**

&mdash; **def [dedupe\_tests](/scripts/slave/recipe_modules/v8/api.py#401)(self, high_prec_tests, low_prec_tests):**

Dedupe tests with lower precedence.

&mdash; **def [download\_build](/scripts/slave/recipe_modules/v8/api.py#698)(self, name_suffix='', archive=None):**

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#706)(self, revision):**

&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1122)(self):**

&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#383)(self):**

Returns runnable testing.BaseTest objects for each extra test specified
by parent_test_spec property.

&mdash; **def [extra\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#392)(self, test_spec):**

Returns runnable testing.BaseTest objects for each extra test specified
in the test spec of the current builder.

&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#986)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#723)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#809)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1461)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1411)(self):**

&mdash; **def [get\_changes](/scripts/slave/recipe_modules/v8/api.py#1351)(self):**

&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#727)(self):**

Delete all gcov counter files.

&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#829)(self):**

&emsp; **@property**<br>&mdash; **def [isolate\_targets](/scripts/slave/recipe_modules/v8/api.py#441)(self):**

&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#464)(self, isolate_targets):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#664)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/v8/api.py#214)(self):**

&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1507)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#889)(self, test_results):**
...
&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1222)(self, test_spec=EmptyTestSpec, \*\*additional_properties):**

&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#407)(self):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1523)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1532)(self, ref, step_name_desc):**

Read and return the version at a paricular ref.

&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#379)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1512)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#345)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#834)(self, tests):**

&mdash; **def [set\_gclient\_custom\_var](/scripts/slave/recipe_modules/v8/api.py#205)(self, var_name):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#301)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#362)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/v8/api.py#375)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#366)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#370)(self):**

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1148)(self):**

&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#224)(self):**
...
&mdash; **def [update\_bot\_config](/scripts/slave/recipe_modules/v8/api.py#120)(self, bot_config, build_config, target_arch, target_platform):**
...
&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#737)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1536)(blob):**
...
&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#292)(self):**

&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#192)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#150)(self, \*\*kwargs):**

&mdash; **def [clean\_test\_output](/scripts/slave/recipe_modules/webrtc/api.py#377)(self):**

Remove all test output in out/, since we have tests leaking files.

&mdash; **def [cleanup](/scripts/slave/recipe_modules/webrtc/api.py#370)(self):**
...
&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#164)(self):**

&mdash; **def [download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#172)(self):**

&mdash; **def [extract\_build](/scripts/slave/recipe_modules/webrtc/api.py#349)(self):**

&mdash; **def [get\_binary\_sizes](/scripts/slave/recipe_modules/webrtc/api.py#211)(self, files=None, base_dir=None):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#269)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#333)(self):**

&mdash; **def [package\_build](/scripts/slave/recipe_modules/webrtc/api.py#282)(self):**

&mdash; **def [run\_baremetal\_test](/scripts/slave/recipe_modules/webrtc/api.py#264)(self, test, name=None, gtest_args=None, args=None, parallel=True):**
...
&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/webrtc/api.py#33)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#53)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/webrtc/api.py#49)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#58)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/webrtc/api.py#37)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test\_android\_studio\_project\_generation](/scripts/slave/recipe_modules/webrtc/api.py#45)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/webrtc/api.py#41)(self):**

&mdash; **def [virtual\_webcam\_check](/scripts/slave/recipe_modules/webrtc/api.py#385)(self):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_codesearch.py#129)(api, root_solution_revision):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#376)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#448)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#202)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#152)(api):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#264)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#464)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#404)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#480)(api):**
...
&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#320)(api, label, arm64_out, armv7_out, sim_out, bucket_name):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/engine.py#243)(api, ios_tools_path, target_version):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#495)(api):**

&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#256)(api):**

&mdash; **def [TestEngine](/scripts/slave/recipes/flutter/engine.py#236)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#224)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8.py#40)(api, build_config, set_gclient_var, target_arch, target_platform):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/node_integration.py#240)(api):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/d1de725e0b53f5f0bb331471e5673aee0e72a5b7/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/buildbucket]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/2ee036b744812ca2e9b30fae453ebe3e4dd83f5e/README.recipes.md#recipe_modules-buildbucket
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/2ee036b744812ca2e9b30fae453ebe3e4dd83f5e/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/2ee036b744812ca2e9b30fae453ebe3e4dd83f5e/README.recipes.md#recipe_modules-scheduler
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/2ee036b744812ca2e9b30fae453ebe3e4dd83f5e/recipe_engine/util.py#120
