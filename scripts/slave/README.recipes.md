...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1104)(self, step_name, gs_bucket, gs_acl=None, mode=None, \*\*kwargs):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#766)(self, canary=False):**
...
&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1145)(self, test_name):**
...
&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1092)(self, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb](/scripts/slave/recipe_modules/chromium/api.py#971)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, isolated_targets=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, \*\*kwargs):**
...
&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1086)(self):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_launcher\_filter](/scripts/slave/recipe_modules/chromium/api.py#559)(self, tests):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [update\_clang](/scripts/slave/recipe_modules/chromium/api.py#1076)(self):**
...
&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#868)(self, bot_config=None):**
...
&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#900)(self, mb_config_path=None, bot_config=None):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/chromium_tests/api.py#174)(self, bot_config):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#956)(self, builders=None, trybots=None):**
...
&mdash; **def [build](/scripts/slave/recipe_modules/dart/api.py#74)(self, build_args=[], isolate=None, name='build dart'):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/dart/api.py#192)(self, tasks):**

Collects the results of a sharded test run.

&mdash; **def [collect\_all](/scripts/slave/recipe_modules/dart/api.py#209)(self, deferred_tasks):**

Collects the results of a sharded test run.

&mdash; **def [download\_parent\_isolate](/scripts/slave/recipe_modules/dart/api.py#140)(self):**

&mdash; **def [get\_secret](/scripts/slave/recipe_modules/dart/api.py#49)(self, name):**

Decrypts the specified secret and returns the location of the result

&mdash; **def [kill\_tasks](/scripts/slave/recipe_modules/dart/api.py#67)(self):**

Kills leftover tasks from previous runs or steps.

&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#244)(self):**

Reads the debug.log file

&mdash; **def [read\_result\_file](/scripts/slave/recipe_modules/dart/api.py#225)(self, name, log_name, test_data=''):**
...
&mdash; **def [run\_script](/scripts/slave/recipe_modules/dart/api.py#536)(self, step_name, script, args, isolate_hash, shards, local_shard, environment, tasks, cipd_packages=[]):**
...
&mdash; **def [run\_test\_py](/scripts/slave/recipe_modules/dart/api.py#468)(self, step_name, append_logs, step, isolate_hash, shards, local_shard, environment, tasks, global_config):**
...
&mdash; **def [run\_trigger](/scripts/slave/recipe_modules/dart/api.py#434)(self, step_name, step, isolate_hash):**

&mdash; **def [shard](/scripts/slave/recipe_modules/dart/api.py#154)(self, title, isolate_hash, test_args, os=None, cpu='x86-64', pool='dart.tests', num_shards=0, last_shard_is_local=False, cipd_packages=[]):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#255)(self, test_data):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#427)(self):**

&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#820)(self):**
...
&emsp; **@property**<br>&mdash; **def [builderset](/scripts/slave/recipe_modules/v8/api.py#435)(self):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#358)(self):**
...
&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#662)(self, test_spec=EmptyTestSpec, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#915)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#921)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#928)(self):**

&mdash; **def [dedupe\_tests](/scripts/slave/recipe_modules/v8/api.py#482)(self, high_prec_tests, low_prec_tests):**

Dedupe tests with lower precedence.

&mdash; **def [download\_build](/scripts/slave/recipe_modules/v8/api.py#800)(self, name_suffix='', archive=None):**

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#808)(self, revision):**

&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1225)(self):**

&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#464)(self):**

Returns runnable testing.BaseTest objects for each extra test specified
by parent_test_spec property.

&mdash; **def [extra\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#473)(self, test_spec):**

Returns runnable testing.BaseTest objects for each extra test specified
in the test spec of the current builder.

&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1088)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#825)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#911)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1573)(self, bisect_range, use_swarming=False):**
...
&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#829)(self):**

Delete all gcov counter files.

&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#931)(self):**

&emsp; **@property**<br>&mdash; **def [isolate\_targets](/scripts/slave/recipe_modules/v8/api.py#542)(self):**

Returns the isolate targets statically known from builders.py.

&mdash; **def [isolate\_targets\_from\_tests](/scripts/slave/recipe_modules/v8/api.py#522)(self, tests):**
...
&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#565)(self, isolate_targets):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#766)(self):**
...
&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#991)(self, test_results):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#784)(self, update_step):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1329)(self, test_spec=EmptyTestSpec, \*\*additional_properties):**

&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#488)(self, root):**
...
&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#460)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1624)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#418)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#936)(self, tests):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#374)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#443)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/v8/api.py#456)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#447)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#451)(self):**

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1251)(self):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#759)(self, name_suffix='', archive=None):**

&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#839)(self):**

Capture coverage data and upload a report.

&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#776)(self):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_codesearch.py#124)(api, root_solution_revision):**
...
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/d328b47eb1a09f1872d6fe589d02c3c4822d5a06/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/d328b47eb1a09f1872d6fe589d02c3c4822d5a06/recipes/README.recipes.md#recipe_modules-depot_tools
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/d328b47eb1a09f1872d6fe589d02c3c4822d5a06/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/d328b47eb1a09f1872d6fe589d02c3c4822d5a06/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/d328b47eb1a09f1872d6fe589d02c3c4822d5a06/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/d328b47eb1a09f1872d6fe589d02c3c4822d5a06/recipes/README.recipes.md#recipe_modules-gsutil
...
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/d328b47eb1a09f1872d6fe589d02c3c4822d5a06/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/d328b47eb1a09f1872d6fe589d02c3c4822d5a06/recipes/README.recipes.md#recipe_modules-tryserver
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/782ed0377a0a23f393a3a873194954825972b961/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/782ed0377a0a23f393a3a873194954825972b961/README.recipes.md#recipe_modules-scheduler
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/782ed0377a0a23f393a3a873194954825972b961/recipe_engine/util.py#120
