...
&mdash; **def [bootstrap\_swarming](/scripts/slave/recipe_modules/ios/api.py#481)(self):**

Bootstraps Swarming.

&emsp; **@property**<br>&mdash; **def [bucket](/scripts/slave/recipe_modules/ios/api.py#39)(self):**

&mdash; **def [build](/scripts/slave/recipe_modules/ios/api.py#257)(self, analyze=False, default_gn_args_path=None, mb_path=None, setup_gn=False, suffix=None, use_mb=True):**
...
&mdash; **def [checkout](/scripts/slave/recipe_modules/ios/api.py#76)(self, gclient_apply_config=None, \*\*kwargs):**

Checks out Chromium.

&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#721)(self, tasks, upload_test_results=True):**
...
&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#890)(self, path):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#488)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#554)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_test](/scripts/slave/recipe_modules/ios/api.py#493)(self, test, tmp_dir, isolate_template):**

Isolates a single test.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#975)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#962)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#990)(self):**

Returns the path to the most recently compiled iossim.

&mdash; **def [parse\_tests](/scripts/slave/recipe_modules/ios/api.py#94)(self, tests, include_dir, start_index=0):**
...
&mdash; **def [read\_build\_config](/scripts/slave/recipe_modules/ios/api.py#155)(self, master_name=None, build_config_base_dir=None, buildername=None):**
...
&mdash; **def [symupload](/scripts/slave/recipe_modules/ios/api.py#405)(self, artifact, url):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#939)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True):**

Runs tests on Swarming as instructed by this bot's build config.

&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#644)(self, tasks):**

Triggers the given Swarming tasks.

&mdash; **def [upload](/scripts/slave/recipe_modules/ios/api.py#451)(self, base_path=None):**

Uploads built artifacts as instructed by this bot's build config.

&mdash; **def [upload\_tgz](/scripts/slave/recipe_modules/ios/api.py#420)(self, artifact, bucket, path):**
...
&emsp; **@property**<br>&mdash; **def [use\_goma](/scripts/slave/recipe_modules/ios/api.py#66)(self):**
...
&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1465)(self):**
