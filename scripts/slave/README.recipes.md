...
&mdash; **def [deapply\_deps](/scripts/slave/recipe_modules/chromium_tests/api.py#1223)(self, bot_update_step):**
...
&mdash; **def [integration\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1241)(self, builders=None, bots=None):**
...
&mdash; **def [run\_tests\_with\_and\_without\_changes](/scripts/slave/recipe_modules/chromium_tests/api.py#1263)(self, builders, mirrored_bots, deapply_changes, tests=None):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1246)(self, builders=None, trybots=None):**

&mdash; **def [trybot\_steps\_for\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#1252)(self, builders=None, trybots=None, tests=None):**
...
&mdash; **def [apply\_bot\_config](/scripts/slave/recipe_modules/v8/api.py#260)(self, bot_config):**
...
&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#882)(self):**

Absolute path to the build product based on the 'checkout' path.

&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1449)(self, requests, project=None, bucket=None, step_name='trigger'):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1559)(self, sequence, subsequence, value):**
...
&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#367)(self, revision=None, \*\*kwargs):**

&mdash; **def [collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#791)(self):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#708)(self, test_spec=v8_builders.EmptyTestSpec, mb_config_path=None, out_dir=None, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#976)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#982)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#989)(self):**
...
&emsp; **@property**<br>&mdash; **def [depot\_tools\_path](/scripts/slave/recipe_modules/v8/api.py#818)(self):**

Returns path to depot_tools pinned in the V8 checkout.

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#870)(self, revision):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [ensure\_osx\_sdk\_if\_needed](/scripts/slave/recipe_modules/v8/api.py#647)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1161)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#887)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#972)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1535)(self, bisect_range):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1484)(self):**
...
&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#891)(self):**

Delete all gcov counter files.

&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#992)(self):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#838)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1581)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#1061)(self, test_results, test_spec):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#853)(self, update_step):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [maybe\_nest](/scripts/slave/recipe_modules/v8/api.py#997)(self, condition, parent_step_name):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1359)(self, test_spec=v8_builders.EmptyTestSpec, \*\*additional_properties):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1597)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1606)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1586)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#463)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#1005)(self, tests):**

&mdash; **def [set\_chromium\_configs](/scripts/slave/recipe_modules/v8/api.py#341)(self, clobber, default_targets):**

&mdash; **def [set\_gclient\_custom\_deps](/scripts/slave/recipe_modules/v8/api.py#336)(self, custom_deps):**

Configures additional gclient custom_deps to be synced.

&mdash; **def [set\_gclient\_custom\_var](/scripts/slave/recipe_modules/v8/api.py#327)(self, var_name):**
...
&emsp; **@property**<br>&mdash; **def [should\_collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#784)(self):**
...
&emsp; **@property**<br>&mdash; **def [target\_bits](/scripts/slave/recipe_modules/v8/api.py#638)(self):**
...
&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#347)(self):**
...
&mdash; **def [ui\_test\_label](/scripts/slave/recipe_modules/v8/api.py#1192)(self, full_test_name):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#831)(self, name_suffix='', archive=None):**

&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#901)(self):**

Capture coverage data and upload a report.

&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#845)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1610)(blob):**
...
&mdash; **def [TestFlutter](/scripts/slave/recipes/dart/flutter_engine.py#249)(api, start_dir, just_built_dart_sdk):**
...
&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#344)(api):**
...
&mdash; **def [BuildFuchsia](/scripts/slave/recipes/flutter/engine.py#698)(api):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#986)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#1134)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#530)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#391)(api, swarming_task_id):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#782)(api):**

&mdash; **def [BuildNoGoma](/scripts/slave/recipes/flutter/engine.py#73)(api, config, \*targets):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#1164)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#1037)(api):**
...
&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#1181)(api):**
...
&mdash; **def [GetFuchsiaBuildId](/scripts/slave/recipes/flutter/engine.py#569)(api):**
...
&emsp; **@contextmanager**<br>&mdash; **def [InstallGems](/scripts/slave/recipes/flutter/engine.py#1149)(api):**

&mdash; **def [IsolateFuchsiaTestArtifacts](/scripts/slave/recipes/flutter/engine.py#600)(api, checkout, fuchsia_tools, image_name):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#335)(api, label):**

&mdash; **def [PackageFlutterRunnerTests](/scripts/slave/recipes/flutter/engine.py#585)(api, checkout, fuchsia_tools):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#903)(api, label, arm64_out, armv7_out, sim_out, bucket_name, strip_bitcode=False):**
...
&mdash; **def [RunIOSTests](/scripts/slave/recipes/flutter/engine.py#975)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#1202)(api, properties, env_properties):**
...
&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#775)(api):**

&mdash; **def [ShouldUploadPackages](/scripts/slave/recipes/flutter/engine.py#51)(api):**

&mdash; **def [TestFuchsia](/scripts/slave/recipes/flutter/engine.py#629)(api):**
...
&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#765)(api):**
...
&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#320)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#298)(api):**
...
&mdash; **def [UploadFuchsiaDebugSymbols](/scripts/slave/recipes/flutter/engine.py#674)(api):**

&mdash; **def [UploadMavenArtifacts](/scripts/slave/recipes/flutter/engine.py#232)(api, artifacts, swarming_task_id):**

&mdash; **def [UploadSkyEngineDartPackage](/scripts/slave/recipes/flutter/engine.py#293)(api):**

&mdash; **def [UploadSkyEngineToCIPD](/scripts/slave/recipes/flutter/engine.py#276)(api, package_name):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#364)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [UploadWebSdk](/scripts/slave/recipes/flutter/engine.py#327)(api, archive_name):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#353)(api):**
...
### *recipes* / [tricium\_analyze](/scripts/slave/recipes/tricium_analyze.py)
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/0f993370186f5d6a4454973d281351645cabdbba/recipes/README.recipes.md#recipe_modules-windows_sdk
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5f5aea33b7cac05bfc7f7b68332de60ddd143be3/README.recipes.md#recipe_modules-generator_script
[recipe_engine/recipe_modules/isolated]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5f5aea33b7cac05bfc7f7b68332de60ddd143be3/README.recipes.md#recipe_modules-isolated
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5f5aea33b7cac05bfc7f7b68332de60ddd143be3/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5f5aea33b7cac05bfc7f7b68332de60ddd143be3/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/recipe_modules/tricium]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5f5aea33b7cac05bfc7f7b68332de60ddd143be3/README.recipes.md#recipe_modules-tricium
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5f5aea33b7cac05bfc7f7b68332de60ddd143be3/recipe_engine/util.py#135
