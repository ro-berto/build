...
&mdash; **def [archive\_differences](/scripts/slave/recipe_modules/isolate/api.py#307)(self, first_dir, second_dir, values):**
...
&mdash; **def [compare\_build\_artifacts](/scripts/slave/recipe_modules/isolate/api.py#336)(self, first_dir, second_dir):**

Compare the artifacts from 2 builds.

&mdash; **def [compose](/scripts/slave/recipe_modules/isolate/api.py#364)(self, isolate_hashes, step_name=None, \*\*kwargs):**
...
&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/isolate/api.py#107)(self, build_dir, targets=None, verbose=False, swarm_hashes_property_name='swarm_hashes', use_exparchive=False, step_name=None, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/isolate/api.py#254)(self):**
...
&mdash; **def [remove\_build\_metadata](/scripts/slave/recipe_modules/isolate/api.py#288)(self):**

Removes the build metadata embedded in the build artifacts.

&mdash; **def [run\_isolated](/scripts/slave/recipe_modules/isolate/api.py#276)(self, name, isolate_hash, args=None, \*\*kwargs):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/dart/flutter_engine.py#115)(api):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/52c7211807930272424213ff6127c209de790eca/recipes/README.recipes.md#recipe_modules-gerrit
...
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/52c7211807930272424213ff6127c209de790eca/recipes/README.recipes.md#recipe_modules-windows_sdk
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/75244002db7a51d62cabdad873d622b1d8c28434/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/75244002db7a51d62cabdad873d622b1d8c28434/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/75244002db7a51d62cabdad873d622b1d8c28434/README.recipes.md#recipe_modules-scheduler
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/75244002db7a51d62cabdad873d622b1d8c28434/recipe_engine/util.py#120
