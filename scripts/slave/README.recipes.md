...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [apply\_syzyasan](/scripts/slave/recipe_modules/chromium/api.py#961)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#973)(self, step_name, gs_bucket, gs_acl=None, mode=None, \*\*kwargs):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#734)(self):**

Add an explicit clobber step if requested.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [compile](/scripts/slave/recipe_modules/chromium/api.py#339)(self, targets=None, name=None, out_dir=None, target=None, use_goma_module=False, \*\*kwargs):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#716)(self, canary=False):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1055)(self, test_name):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [get\_clang\_version](/scripts/slave/recipe_modules/chromium/api.py#672)(self, \*\*kwargs):**

&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium/api.py#81)(self):**

&mdash; **def [get\_cros\_chrome\_sdk\_wrapper](/scripts/slave/recipe_modules/chromium/api.py#686)(self, clean=False):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [list\_perf\_tests](/scripts/slave/recipe_modules/chromium/api.py#1014)(self, browser, num_shards, device=None):**
...
&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#949)(self, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#782)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gyp\_chromium](/scripts/slave/recipe_modules/chromium/api.py#774)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb](/scripts/slave/recipe_modules/chromium/api.py#839)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, isolated_targets=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, gyp_script=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#744)(self, env=None, \*\*kwargs):**

Run the build-configuration hooks for chromium.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runtest](/scripts/slave/recipe_modules/chromium/api.py#501)(self, test, args=None, xvfb=False, name=None, annotate=None, results_url=None, perf_dashboard_id=None, test_type=None, python_mode=False, parallel=False, point_id=None, revision=None, webkit_revision=None, test_launcher_summary_output=None, flakiness_dash=None, perf_id=None, perf_config=None, chartjson_file=False, disable_src_side_runtest_py=False, tee_stdout_file=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [sizes](/scripts/slave/recipe_modules/chromium/api.py#629)(self, results_url=None, perf_id=None, platform=None, \*\*kwargs):**

Return a sizes.py invocation.
This uses runtests.py to upload the results to the perf dashboard.

&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#943)(self):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_launcher\_filter](/scripts/slave/recipe_modules/chromium/api.py#497)(self, tests):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [update\_clang](/scripts/slave/recipe_modules/chromium/api.py#933)(self):**
...
&mdash; **def [bootstrap\_swarming](/scripts/slave/recipe_modules/ios/api.py#471)(self):**

Bootstraps Swarming.

&emsp; **@property**<br>&mdash; **def [bucket](/scripts/slave/recipe_modules/ios/api.py#29)(self):**

&mdash; **def [build](/scripts/slave/recipe_modules/ios/api.py#247)(self, analyze=False, default_gn_args_path=None, mb_path=None, setup_gn=False, suffix=None, use_mb=True):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#697)(self, tasks, upload_test_results=True):**
...
&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#833)(self, path):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#478)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#540)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_test](/scripts/slave/recipe_modules/ios/api.py#483)(self, test, tmp_dir, isolate_template):**

Isolates a single test.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#888)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#875)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#903)(self):**
...
&mdash; **def [symupload](/scripts/slave/recipe_modules/ios/api.py#396)(self, artifact):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#852)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True):**

Runs tests on Swarming as instructed by this bot's build config.

&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#629)(self, tasks):**

Triggers the given Swarming tasks.

&mdash; **def [upload](/scripts/slave/recipe_modules/ios/api.py#441)(self, base_path=None):**

Uploads built artifacts as instructed by this bot's build config.

&mdash; **def [upload\_tgz](/scripts/slave/recipe_modules/ios/api.py#410)(self, artifact, bucket, path):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/swarming/api.py#1029)(self, task):**

SwarmingTask -> argument list for 'swarming.py' command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/swarming/api.py#959)(self, prefix, task):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#314)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#365)(api):**
...
&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#250)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#381)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#336)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#397)(api):**
...
&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#281)(api, label, device_out, sim_out, bucket_name):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/engine.py#229)(api, ios_tools_path, target_version):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#412)(api):**

&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#242)(api):**

&mdash; **def [TestEngine](/scripts/slave/recipes/flutter/engine.py#222)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#211)(api):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9ff5688343b8bf00affe3e7959acfeb2fc1081cb/recipes/README.recipes.md#recipe_modules-gerrit
...
[depot_tools/recipe_modules/rietveld]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9ff5688343b8bf00affe3e7959acfeb2fc1081cb/recipes/README.recipes.md#recipe_modules-rietveld
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/7d60012b4e854314e4960e1cde6354533057ffe8/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/7d60012b4e854314e4960e1cde6354533057ffe8/recipe_engine/util.py#119
