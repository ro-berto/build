...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1595)(self, step_name, gs_bucket, gs_acl=None, mode=None, build_name=None, \*\*kwargs):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#1058)(self):**
...
&mdash; **def [delete\_old\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#1009)(self):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#973)(self, client_type='release'):**

&mdash; **def [ensure\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#1018)(self):**

&mdash; **def [ensure\_toolchains](/scripts/slave/recipe_modules/chromium/api.py#1054)(self):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1638)(self, _):**

&mdash; **def [get\_builder\_id](/scripts/slave/recipe_modules/chromium/api.py#186)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [get\_clang\_version](/scripts/slave/recipe_modules/chromium/api.py#921)(self, \*\*kwargs):**

&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium/api.py#98)(self):**

&mdash; **def [get\_cros\_chrome\_sdk\_wrapper](/scripts/slave/recipe_modules/chromium/api.py#938)(self):**
...
&mdash; **def [get\_mac\_toolchain\_installer](/scripts/slave/recipe_modules/chromium/api.py#993)(self):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_analyze](/scripts/slave/recipe_modules/chromium/api.py#1296)(self, builder_id, analyze_input, name=None, mb_path=None, mb_config_path=None, chromium_config=None, build_dir=None, phase=None, \*\*kwargs):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [mb\_failure\_handler](/scripts/slave/recipe_modules/chromium/api.py#1563)(self, name):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_gen](/scripts/slave/recipe_modules/chromium/api.py#1432)(self, builder_id, name=None, mb_path=None, mb_config_path=None, use_goma=True, isolated_targets=None, build_dir=None, phase=None, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None, recursive_lookup=False, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_isolate\_everything](/scripts/slave/recipe_modules/chromium/api.py#1531)(self, builder_id, use_goma=True, mb_path=None, mb_config_path=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_lookup](/scripts/slave/recipe_modules/chromium/api.py#1359)(self, builder_id, name=None, mb_path=None, mb_config_path=None, recursive=False, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None):**
...
&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1583)(self, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#1107)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb\_cmd](/scripts/slave/recipe_modules/chromium/api.py#1184)(self, name, mb_command, builder_id, mb_path=None, mb_config_path=None, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, additional_args=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#1068)(self, env=None, \*\*kwargs):**

Run the build-configuration hooks for chromium.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runtest](/scripts/slave/recipe_modules/chromium/api.py#755)(self, test, args=None, xvfb=False, name=None, annotate=None, results_url=None, perf_dashboard_id=None, test_type=None, python_mode=False, point_id=None, revision=None, webkit_revision=None, test_launcher_summary_output=None, perf_id=None, perf_config=None, chartjson_file=False, use_histograms=False, tee_stdout_file=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [sizes](/scripts/slave/recipe_modules/chromium/api.py#872)(self, results_url=None, perf_id=None, platform=None, \*\*kwargs):**

Return a sizes.py invocation.
This uses runtests.py to upload the results to the perf dashboard.

&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1577)(self):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_launcher\_filter](/scripts/slave/recipe_modules/chromium/api.py#751)(self, tests):**
...
&mdash; **def [collect\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#1088)(self, task, \*\*kwargs):**
...
&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/chromium_swarming/api.py#1707)(self, project_name, precommit, mastername=None, default_priority=None, path_to_testing_dir=None):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/chromium_swarming/api.py#1658)(self, task):**

SwarmingTask -> argument list for go swarming command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/chromium_swarming/api.py#1475)(self, prefix, task):**
...
&mdash; **def [report\_stats](/scripts/slave/recipe_modules/chromium_swarming/api.py#1110)(self):**
...
&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#540)(self, builder_id, update_step, build_config):**
...
&mdash; **def [deapply\_deps](/scripts/slave/recipe_modules/chromium_tests/api.py#1204)(self, bot_update_step):**

&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#785)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#656)(self, builder_id, update_step, build_config, build_archive_url=None, build_revision=None, override_bot_type=None, read_gn_args=True):**
...
&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#966)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#307)(self, bot_config, build_config, tests):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#1000)(self, bot_config=None):**
...
&mdash; **def [inbound\_transfer](/scripts/slave/recipe_modules/chromium_tests/api.py#1134)(self, bot, bot_update_step, build_config):**
...
&mdash; **def [integration\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1227)(self, builders=None, bots=None):**

&mdash; **def [log](/scripts/slave/recipe_modules/chromium_tests/api.py#104)(self, message):**

&mdash; **def [lookup\_bot\_metadata](/scripts/slave/recipe_modules/chromium_tests/api.py#1361)(self, builders, mirrored_bots=None):**

&mdash; **def [lookup\_builder\_gn\_args](/scripts/slave/recipe_modules/chromium_tests/api.py#1619)(self, bot_meta_data, mb_config_path=None, builders=None):**

&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1032)(self, mb_config_path=None, builders=None):**
...
&mdash; **def [outbound\_transfer](/scripts/slave/recipe_modules/chromium_tests/api.py#1079)(self, bot, bot_update_step, build_config):**
...
&mdash; **def [package\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#464)(self, builder_id, update_step, build_config, reasons=None):**
...
&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#623)(self, compile_targets, isolated_targets, name_suffix, builder_id=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=False, android_version_code=None, android_version_name=None):**

&mdash; **def [run\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#1642)(self, bot_meta_data, build_config):**

&mdash; **def [run\_tests\_with\_and\_without\_changes](/scripts/slave/recipe_modules/chromium_tests/api.py#1249)(self, builders, mirrored_bots, deapply_changes, tests=None):**
...
&mdash; **def [trigger\_child\_builds](/scripts/slave/recipe_modules/chromium_tests/api.py#591)(self, builder_id, update_step, build_config, additional_properties=None):**

&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1232)(self, builders=None, trybots=None):**

&mdash; **def [trybot\_steps\_for\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#1238)(self, builders=None, trybots=None, tests=None):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#723)(self, bot_config, tests=None):**
...
&mdash; **def [record\_previous\_revision](/scripts/slave/recipe_modules/findit/api.py#384)(self, bot_config):**
...
&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#877)(self):**

Absolute path to the build product based on the 'checkout' path.

&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1445)(self, requests, project=None, bucket=None, step_name='trigger'):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1555)(self, sequence, subsequence, value):**
...
&mdash; **def [collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#793)(self):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#971)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#977)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#984)(self):**
...
&emsp; **@property**<br>&mdash; **def [depot\_tools\_path](/scripts/slave/recipe_modules/v8/api.py#820)(self):**

Returns path to depot_tools pinned in the V8 checkout.

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#865)(self, revision):**
...
&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1247)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1156)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#882)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#967)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1531)(self, bisect_range):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1480)(self):**
...
&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#886)(self):**

Delete all gcov counter files.

&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#987)(self):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#833)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1577)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#1056)(self, test_results, test_spec):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#848)(self, update_step):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [maybe\_nest](/scripts/slave/recipe_modules/v8/api.py#992)(self, condition, parent_step_name):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1354)(self, test_spec=v8_builders.EmptyTestSpec, \*\*additional_properties):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1593)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1602)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1582)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#470)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#1000)(self, tests):**
...
&emsp; **@property**<br>&mdash; **def [should\_collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#786)(self):**
...
&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1273)(self):**
...
&mdash; **def [ui\_test\_label](/scripts/slave/recipe_modules/v8/api.py#1187)(self, full_test_name):**
...
&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#896)(self):**

Capture coverage data and upload a report.

&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#840)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1606)(blob):**
...
&emsp; **@property**<br>&mdash; **def [bucketname](/scripts/slave/recipe_modules/webrtc/api.py#213)(self):**

&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#500)(self):**

&emsp; **@property**<br>&mdash; **def [build\_url](/scripts/slave/recipe_modules/webrtc/api.py#226)(self):**

&emsp; **@property**<br>&mdash; **def [builder\_id](/scripts/slave/recipe_modules/webrtc/api.py#221)(self):**

&emsp; **@property**<br>&mdash; **def [buildername](/scripts/slave/recipe_modules/webrtc/api.py#217)(self):**

&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#380)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#322)(self, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/webrtc/api.py#426)(self, phase=None, override_targets=None):**

&mdash; **def [configure\_isolate](/scripts/slave/recipe_modules/webrtc/api.py#264)(self, phase=None):**

&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/webrtc/api.py#281)(self):**

&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#352)(self):**

&mdash; **def [download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#360)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [ensure\_sdk](/scripts/slave/recipe_modules/webrtc/api.py#384)(self):**

&mdash; **def [get\_binary\_sizes](/scripts/slave/recipe_modules/webrtc/api.py#441)(self, files=None, base_dir=None):**

&mdash; **def [get\_bot](/scripts/slave/recipe_modules/webrtc/api.py#234)(self, bucketname, buildername):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/webrtc/api.py#437)(self):**

&emsp; **@property**<br>&mdash; **def [master\_config](/scripts/slave/recipe_modules/webrtc/api.py#237)(self):**

&emsp; **@property**<br>&mdash; **def [mastername](/scripts/slave/recipe_modules/webrtc/api.py#241)(self):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#484)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#541)(self):**

&mdash; **def [related\_bots](/scripts/slave/recipe_modules/webrtc/api.py#245)(self):**

&emsp; **@property**<br>&mdash; **def [revision\_number](/scripts/slave/recipe_modules/webrtc/api.py#207)(self):**

&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#389)(self, phase=None):**

&mdash; **def [run\_mb\_ios](/scripts/slave/recipe_modules/webrtc/api.py#409)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#457)(self, phase=None):**
...
&emsp; **@property**<br>&mdash; **def [should\_download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#250)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#257)(self):**

&mdash; **def [upload\_to\_perf\_dashboard](/scripts/slave/recipe_modules/webrtc/api.py#557)(self, name, step_result, use_histograms=False):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/android/builder.py#177)(api, mastername, buildername, revision):**
...
&mdash; **def [AddFiles](/scripts/slave/recipes/flutter/engine.py#201)(api, pkg, relative_paths):**

&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#373)(api):**

&mdash; **def [Build](/scripts/slave/recipes/flutter/engine.py#71)(api, config, \*targets):**

&mdash; **def [BuildAndTestFuchsia](/scripts/slave/recipes/flutter/engine.py#152)(api, build_script, git_rev):**

&mdash; **def [BuildFontSubset](/scripts/slave/recipes/flutter/engine.py#52)(api):**

&mdash; **def [BuildFuchsia](/scripts/slave/recipes/flutter/engine.py#748)(api):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#1068)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#1233)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#571)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#425)(api, swarming_task_id):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#836)(api):**

&mdash; **def [BuildNoGoma](/scripts/slave/recipes/flutter/engine.py#83)(api, config, \*targets):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#1298)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#1134)(api):**

&mdash; **def [CancelBuilds](/scripts/slave/recipes/flutter/engine.py#113)(api, builds):**

&mdash; **def [CollectBuilds](/scripts/slave/recipes/flutter/engine.py#118)(api, builds):**

&mdash; **def [DownloadFuchsiaSystemImage](/scripts/slave/recipes/flutter/engine.py#633)(api, target_dir, bucket_name, build_id, image_name):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#1316)(api):**

&mdash; **def [GetCheckoutPath](/scripts/slave/recipes/flutter/engine.py#56)(api):**

&mdash; **def [GetCloudMavenPath](/scripts/slave/recipes/flutter/engine.py#224)(api, artifact_filename, swarming_task_id):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#64)(api, path):**

&mdash; **def [GetFlutterFuchsiaBuildTargets](/scripts/slave/recipes/flutter/engine.py#123)(product, include_test_targets=False):**

&mdash; **def [GetFuchsiaBuildId](/scripts/slave/recipes/flutter/engine.py#624)(api):**

&mdash; **def [GetFuchsiaOutputDirs](/scripts/slave/recipes/flutter/engine.py#139)(product, build_mode, target_arch):**

&mdash; **def [GetFuchsiaOutputFiles](/scripts/slave/recipes/flutter/engine.py#130)(product):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallGems](/scripts/slave/recipes/flutter/engine.py#1277)(api):**

&mdash; **def [IsolateFuchsiaTestArtifacts](/scripts/slave/recipes/flutter/engine.py#640)(api, checkout, fuchsia_tools, image_name, fuchsia_test_script):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#364)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#979)(api, label, arm64_out, armv7_out, sim_out, bucket_name, strip_bitcode=False):**

&mdash; **def [PackageWindowsDesktopVariant](/scripts/slave/recipes/flutter/engine.py#1117)(api, label, bucket_name):**

&mdash; **def [RunGN](/scripts/slave/recipes/flutter/engine.py#171)(api, \*args):**

&mdash; **def [RunGNBitcode](/scripts/slave/recipes/flutter/engine.py#179)(api, \*args):**

&mdash; **def [RunIOSTests](/scripts/slave/recipes/flutter/engine.py#1056)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#1338)(api, properties, env_properties):**

&mdash; **def [RunTests](/scripts/slave/recipes/flutter/engine.py#95)(api, out_dir, android_out_dir=None, types='all'):**

&mdash; **def [ScheduleBuilds](/scripts/slave/recipes/flutter/engine.py#105)(api, builder_name, drone_props):**

&emsp; **@contextmanager**<br>&mdash; **def [SetupMacOSSDK](/scripts/slave/recipes/flutter/engine.py#1257)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#828)(api):**

&mdash; **def [ShouldUploadPackages](/scripts/slave/recipes/flutter/engine.py#60)(api):**

&mdash; **def [TestFuchsia](/scripts/slave/recipes/flutter/engine.py#677)(api):**
...
&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#817)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#206)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#288)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#345)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#320)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#266)(api, dir_label, parent_dir, folder_name, zip_name, platform=None):**

&mdash; **def [UploadFuchsiaDebugSymbols](/scripts/slave/recipes/flutter/engine.py#724)(api):**

&mdash; **def [UploadMavenArtifacts](/scripts/slave/recipes/flutter/engine.py#248)(api, artifacts, swarming_task_id):**

&mdash; **def [UploadSkyEngineDartPackage](/scripts/slave/recipes/flutter/engine.py#315)(api):**

&mdash; **def [UploadSkyEngineToCIPD](/scripts/slave/recipes/flutter/engine.py#297)(api, package_name):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#393)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [UploadWebSdk](/scripts/slave/recipes/flutter/engine.py#354)(api, archive_name):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#382)(api):**
...
&mdash; **def [CreateAndUploadFlutterPackage](/scripts/slave/recipes/flutter/flutter.py#267)(api, git_hash, branch):**

Prepares, builds, and uploads an all-inclusive archive package.

&mdash; **def [DecryptKMS](/scripts/slave/recipes/flutter/flutter.py#214)(api, step_name, crypto_key_path, ciphertext_file, plaintext_file):**

&mdash; **def [DownloadFuchsiaSystemImageAndPackages](/scripts/slave/recipes/flutter/flutter.py#94)(api, fuchsia_dir, target_dir):**

&mdash; **def [EnsureCloudKMS](/scripts/slave/recipes/flutter/flutter.py#203)(api, version=None):**

&mdash; **def [EnsureGoldctl](/scripts/slave/recipes/flutter/flutter.py#69)(api):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/flutter.py#228)(api, git_hash, path):**

&emsp; **@contextmanager**<br>&mdash; **def [Install7za](/scripts/slave/recipes/flutter/flutter.py#55)(api):**

&mdash; **def [InstallOpenJDK](/scripts/slave/recipes/flutter/flutter.py#192)(api):**

&mdash; **def [IsolateDriverDeps](/scripts/slave/recipes/flutter/flutter.py#129)(api):**

&mdash; **def [IsolateFuchsiaCtlDeps](/scripts/slave/recipes/flutter/flutter.py#114)(api, fuchsia_ctl_wd):**

&emsp; **@contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/flutter.py#85)(api, label):**

&mdash; **def [RunFuchsiaDriverTests](/scripts/slave/recipes/flutter/flutter.py#170)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/flutter.py#302)(api):**
...
&mdash; **def [SwarmFuchsiaTests](/scripts/slave/recipes/flutter/flutter.py#141)(api):**
...
&mdash; **def [tricium\_has\_message](/scripts/slave/recipes/tricium_clang_tidy_wrapper.py#311)(check, steps, message):**

&mdash; **def [tricium\_has\_no\_messages](/scripts/slave/recipes/tricium_clang_tidy_wrapper.py#306)(check, steps):**

&mdash; **def [tricium\_has\_replacements](/scripts/slave/recipes/tricium_clang_tidy_wrapper.py#318)(check, steps, \*expected_replacements):**

&mdash; **def [tricium\_outputs\_json](/scripts/slave/recipes/tricium_clang_tidy_wrapper.py#328)(check, steps, json_obj):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ef7a33909ea658fcd811398212d003dd3f2b7878/recipes/README.recipes.md#recipe_modules-windows_sdk
[recipe_engine/recipe_modules/assertions]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/cda5bed0ae2531e7252f80da471f675158ab694c/README.recipes.md#recipe_modules-assertions
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/cda5bed0ae2531e7252f80da471f675158ab694c/README.recipes.md#recipe_modules-generator_script
[recipe_engine/recipe_modules/isolated]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/cda5bed0ae2531e7252f80da471f675158ab694c/README.recipes.md#recipe_modules-isolated
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/cda5bed0ae2531e7252f80da471f675158ab694c/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/cda5bed0ae2531e7252f80da471f675158ab694c/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/cda5bed0ae2531e7252f80da471f675158ab694c/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/cda5bed0ae2531e7252f80da471f675158ab694c/README.recipes.md#recipe_modules-swarming
[recipe_engine/recipe_modules/time]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/cda5bed0ae2531e7252f80da471f675158ab694c/README.recipes.md#recipe_modules-time
[recipe_engine/recipe_modules/tricium]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/cda5bed0ae2531e7252f80da471f675158ab694c/README.recipes.md#recipe_modules-tricium
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/cda5bed0ae2531e7252f80da471f675158ab694c/recipe_engine/util.py#135
