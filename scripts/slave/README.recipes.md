...
&mdash; **def [create\_results\_from\_json](/scripts/slave/recipe_modules/test_utils/api.py#394)(self, data):**

&mdash; **def [create\_results\_from\_json\_if\_needed](/scripts/slave/recipe_modules/test_utils/api.py#397)(self, data):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [gtest\_results](/scripts/slave/recipe_modules/test_utils/api.py#414)(self, add_json_log=True):**
...
&mdash; **def [summarize\_test\_with\_patch\_reapplied](/scripts/slave/recipe_modules/test_utils/api.py#339)(self, caller_api, test):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_results](/scripts/slave/recipe_modules/test_utils/api.py#404)(self, add_json_log=True):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/art.py#607)(api):**
...
&mdash; **def [setup\_aosp\_builder](/scripts/slave/recipes/art.py#431)(api, read_barrier):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/83bd7f4cd5fa45c7b2b8a9187d3c3d3c13525621/recipes/README.recipes.md#recipe_modules-gerrit
