...
&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1508)(self, bisect_range, use_swarming=False):**
...
&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1329)(self, test_spec=None, \*\*additional_properties):**
