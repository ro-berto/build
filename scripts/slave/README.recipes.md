...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [apply\_syzyasan](/scripts/slave/recipe_modules/chromium/api.py#1061)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1073)(self, step_name, gs_bucket, gs_acl=None, mode=None, \*\*kwargs):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#815)(self):**

Add an explicit clobber step if requested.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [compile](/scripts/slave/recipe_modules/chromium/api.py#350)(self, targets=None, name=None, out_dir=None, target=None, use_goma_module=False, \*\*kwargs):**
...
&mdash; **def [delete\_old\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#769)(self):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#737)(self, canary=False):**

&mdash; **def [ensure\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#778)(self):**

&mdash; **def [ensure\_toolchains](/scripts/slave/recipe_modules/chromium/api.py#811)(self):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1114)(self, test_name):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [get\_clang\_version](/scripts/slave/recipe_modules/chromium/api.py#693)(self, \*\*kwargs):**

&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium/api.py#83)(self):**

&mdash; **def [get\_cros\_chrome\_sdk\_wrapper](/scripts/slave/recipe_modules/chromium/api.py#707)(self, clean=False):**
...
&mdash; **def [get\_mac\_toolchain\_installer](/scripts/slave/recipe_modules/chromium/api.py#755)(self):**
...
&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1049)(self, \*\*kwargs):**

&mdash; **def [reload\_version](/scripts/slave/recipe_modules/chromium/api.py#162)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#869)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gyp\_chromium](/scripts/slave/recipe_modules/chromium/api.py#861)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb](/scripts/slave/recipe_modules/chromium/api.py#933)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, isolated_targets=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#825)(self, env=None, \*\*kwargs):**

Run the build-configuration hooks for chromium.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runtest](/scripts/slave/recipe_modules/chromium/api.py#522)(self, test, args=None, xvfb=False, name=None, annotate=None, results_url=None, perf_dashboard_id=None, test_type=None, python_mode=False, parallel=False, point_id=None, revision=None, webkit_revision=None, test_launcher_summary_output=None, flakiness_dash=None, perf_id=None, perf_config=None, chartjson_file=False, disable_src_side_runtest_py=False, tee_stdout_file=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [sizes](/scripts/slave/recipe_modules/chromium/api.py#650)(self, results_url=None, perf_id=None, platform=None, \*\*kwargs):**

Return a sizes.py invocation.
This uses runtests.py to upload the results to the perf dashboard.

&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1043)(self):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_launcher\_filter](/scripts/slave/recipe_modules/chromium/api.py#518)(self, tests):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [update\_clang](/scripts/slave/recipe_modules/chromium/api.py#1033)(self):**
...
&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#403)(self, mastername, buildername, update_step, bot_db):**

&emsp; **@property**<br>&mdash; **def [builders](/scripts/slave/recipe_modules/chromium_tests/api.py#36)(self):**

&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#307)(self, bot_config, update_step, bot_db, compile_targets, tests_including_triggered, mb_mastername=None, mb_buildername=None, mb_config_path=None, override_bot_type=None):**
...
&mdash; **def [create\_bot\_db\_from\_master\_dict](/scripts/slave/recipe_modules/chromium_tests/api.py#203)(self, mastername, master_dict):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#675)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#557)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None):**

&mdash; **def [generate\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#230)(self, test_spec, builder_dict, buildername, mastername, swarming_dimensions, scripts_compile_targets, generators, bot_update_step, bot_config):**

&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#768)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#300)(self, bot_config, bot_db, tests):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#808)(self, bot_config=None):**
...
&mdash; **def [get\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#291)(self, bot_config, bot_db):**
...
&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#840)(self, mb_config_path=None, bot_config=None):**

&mdash; **def [prepare\_checkout](/scripts/slave/recipe_modules/chromium_tests/api.py#208)(self, bot_config, root_solution_revision=None, disable_syntax_validation=False):**

&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#246)(self, test_spec_file):**

&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#537)(self, compile_targets, isolated_targets, name_suffix, mb_mastername=None, mb_buildername=None, mb_config_path=None):**

&mdash; **def [run\_tests\_on\_tryserver](/scripts/slave/recipe_modules/chromium_tests/api.py#687)(self, bot_config, tests, bot_update_step, affected_files, mb_mastername=None, mb_buildername=None, disable_deapply_patch=False):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium_tests/api.py#189)(self, update_step):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#869)(self):**

&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#44)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#611)(self, bot_config, tests=None):**
...
#### **class [DartApi](/scripts/slave/recipe_modules/dart/api.py#10)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [checkout](/scripts/slave/recipe_modules/dart/api.py#13)(self, clobber=False):**

Checks out the dart code and prepares it for building.

&mdash; **def [collect](/scripts/slave/recipe_modules/dart/api.py#156)(self, tasks):**

Collects the results of a sharded test run.

&mdash; **def [collect\_all](/scripts/slave/recipe_modules/dart/api.py#173)(self, deferred_tasks):**

Collects the results of a sharded test run.

&mdash; **def [download\_parent\_isolate](/scripts/slave/recipe_modules/dart/api.py#103)(self):**

&mdash; **def [kill\_tasks](/scripts/slave/recipe_modules/dart/api.py#30)(self):**

Kills leftover tasks from previous runs or steps.

&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#208)(self):**

Reads the debug.log file

&mdash; **def [read\_result\_file](/scripts/slave/recipe_modules/dart/api.py#189)(self, name, log_name, test_data=''):**
...
&mdash; **def [run\_test\_py](/scripts/slave/recipe_modules/dart/api.py#412)(self, step_name, append_logs, step, isolate_hash, shards, local_shard, environment, tasks):**
...
&mdash; **def [run\_trigger](/scripts/slave/recipe_modules/dart/api.py#378)(self, step_name, step, isolate_hash):**

&mdash; **def [shard](/scripts/slave/recipe_modules/dart/api.py#117)(self, title, isolate_hash, test_args, os=None, cpu='x86-64', pool='dart.tests', num_shards=0, last_shard_is_local=False):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#219)(self, test_data):**
...
&mdash; **def [upload\_isolate](/scripts/slave/recipe_modules/dart/api.py#85)(self, isolate_fileset):**
...
&emsp; **@property**<br>&mdash; **def [goma\_ctl](/scripts/slave/recipe_modules/goma/api.py#157)(self):**

&emsp; **@property**<br>&mdash; **def [goma\_dir](/scripts/slave/recipe_modules/goma/api.py#161)(self):**
...
&mdash; **def [start](/scripts/slave/recipe_modules/goma/api.py#229)(self, env=None, \*\*kwargs):**
...
&mdash; **def [stop](/scripts/slave/recipe_modules/goma/api.py#309)(self, ninja_log_outdir=None, ninja_log_compiler=None, ninja_log_command=None, build_exit_status=None, \*\*kwargs):**
...
&mdash; **def [bootstrap\_swarming](/scripts/slave/recipe_modules/ios/api.py#522)(self):**

Bootstraps Swarming.

&emsp; **@property**<br>&mdash; **def [bucket](/scripts/slave/recipe_modules/ios/api.py#56)(self):**

&mdash; **def [build](/scripts/slave/recipe_modules/ios/api.py#303)(self, analyze=False, mb_path=None, suffix=None, use_mb=True):**
...
&mdash; **def [checkout](/scripts/slave/recipe_modules/ios/api.py#93)(self, gclient_apply_config=None, \*\*kwargs):**

Checks out Chromium.

&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#907)(self, tasks, upload_test_results=True):**
...
&mdash; **def [ensure\_xcode](/scripts/slave/recipe_modules/ios/api.py#280)(self, xcode_build_version):**

&mdash; **def [get\_mac\_toolchain\_cmd](/scripts/slave/recipe_modules/ios/api.py#274)(self):**

&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#1081)(self, path):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#529)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#688)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_earlgrey\_test](/scripts/slave/recipe_modules/ios/api.py#633)(self, test, shard_size, tmp_dir, isolate_template):**

Isolate earlgrey test into small shards

&mdash; **def [isolate\_test](/scripts/slave/recipe_modules/ios/api.py#546)(self, test, tmp_dir, isolate_template, test_cases=None, shard_num=None):**

Isolates a single test.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#1166)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#1153)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#1181)(self):**

Returns the path to the most recently compiled iossim.

&mdash; **def [parse\_tests](/scripts/slave/recipe_modules/ios/api.py#111)(self, tests, include_dir, start_index=0):**
...
&mdash; **def [read\_build\_config](/scripts/slave/recipe_modules/ios/api.py#172)(self, master_name=None, build_config_base_dir=None, buildername=None):**
...
&mdash; **def [symupload](/scripts/slave/recipe_modules/ios/api.py#446)(self, artifact, url):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#1130)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True):**

Runs tests on Swarming as instructed by this bot's build config.

&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#788)(self, tasks):**

Triggers the given Swarming tasks.

&mdash; **def [upload](/scripts/slave/recipe_modules/ios/api.py#492)(self, base_path=None):**

Uploads built artifacts as instructed by this bot's build config.

&mdash; **def [upload\_tgz](/scripts/slave/recipe_modules/ios/api.py#461)(self, artifact, bucket, path):**
...
&emsp; **@property**<br>&mdash; **def [use\_goma](/scripts/slave/recipe_modules/ios/api.py#83)(self):**
...
#### **class [SwarmingApi](/scripts/slave/recipe_modules/swarming/api.py#133)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [add\_default\_tag](/scripts/slave/recipe_modules/swarming/api.py#386)(self, tag):**
...
&mdash; **def [check\_client\_version](/scripts/slave/recipe_modules/swarming/api.py#616)(self, step_test_data=None):**
...
&emsp; **@property**<br>&mdash; **def [default\_dimensions](/scripts/slave/recipe_modules/swarming/api.py#331)(self):**
...
&emsp; **@property**<br>&mdash; **def [default\_env](/scripts/slave/recipe_modules/swarming/api.py#354)(self):**
...
&emsp; **@default_expiration.setter**<br>&mdash; **def [default\_expiration](/scripts/slave/recipe_modules/swarming/api.py#254)(self, value):**

&emsp; **@default_hard_timeout.setter**<br>&mdash; **def [default\_hard\_timeout](/scripts/slave/recipe_modules/swarming/api.py#271)(self, value):**

&emsp; **@default_idempotent.setter**<br>&mdash; **def [default\_idempotent](/scripts/slave/recipe_modules/swarming/api.py#310)(self, value):**

&emsp; **@default_io_timeout.setter**<br>&mdash; **def [default\_io\_timeout](/scripts/slave/recipe_modules/swarming/api.py#290)(self, value):**

&emsp; **@default_priority.setter**<br>&mdash; **def [default\_priority](/scripts/slave/recipe_modules/swarming/api.py#381)(self, value):**
...
&mdash; **def [gtest\_task](/scripts/slave/recipe_modules/swarming/api.py#535)(self, title, isolated_hash, test_launcher_summary_output=None, extra_args=None, cipd_packages=None, merge=None, \*\*kwargs):**
...
&mdash; **def [isolated\_script\_task](/scripts/slave/recipe_modules/swarming/api.py#581)(self, title, isolated_hash, extra_args=None, idempotent=False, merge=None, \*\*kwargs):**
...
&emsp; **@staticmethod**<br>&mdash; **def [prefered\_os\_dimension](/scripts/slave/recipe_modules/swarming/api.py#415)(platform):**
...
&emsp; **@service_account_json.setter**<br>&mdash; **def [service\_account\_json](/scripts/slave/recipe_modules/swarming/api.py#216)(self, value):**

Service account json to use for swarming.

&mdash; **def [set\_default\_dimension](/scripts/slave/recipe_modules/swarming/api.py#346)(self, key, value):**

&mdash; **def [set\_default\_env](/scripts/slave/recipe_modules/swarming/api.py#365)(self, key, value):**

&emsp; **@show_isolated_out_in_collect_step.setter**<br>&mdash; **def [show\_isolated\_out\_in\_collect\_step](/scripts/slave/recipe_modules/swarming/api.py#402)(self, value):**

&emsp; **@show_shards_in_collect_step.setter**<br>&mdash; **def [show\_shards\_in\_collect\_step](/scripts/slave/recipe_modules/swarming/api.py#411)(self, value):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [summary](/scripts/slave/recipe_modules/swarming/api.py#207)(self):**

&emsp; **@swarming_server.setter**<br>&mdash; **def [swarming\_server](/scripts/slave/recipe_modules/swarming/api.py#226)(self, value):**

Changes URL of Swarming server to use.

&mdash; **def [task](/scripts/slave/recipe_modules/swarming/api.py#433)(self, title, isolated_hash, ignore_task_failure=False, shards=1, task_output_dir=None, extra_args=None, idempotent=None, cipd_packages=None, build_properties=None, merge=None, trigger_script=None, named_caches=None, service_account=None, raw_cmd=None, env_prefixes=None):**
...
&emsp; **@verbose.setter**<br>&mdash; **def [verbose](/scripts/slave/recipe_modules/swarming/api.py#236)(self, value):**
...
&mdash; **def [apply\_bot\_config](/scripts/slave/recipe_modules/v8/api.py#144)(self, builders):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#344)(self):**

&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#734)(self):**

&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1422)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#274)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#228)(self, revision=None, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#580)(self, test_spec=None, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#810)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#816)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#823)(self):**

&mdash; **def [download\_build](/scripts/slave/recipe_modules/v8/api.py#710)(self, name_suffix='', archive=None):**

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#722)(self, revision):**

&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1119)(self):**

&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#392)(self):**
...
&mdash; **def [extra\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#404)(self, test_spec):**

Returns runnable testing.BaseTest objects for each extra test specified
in the test spec of the current builder.

&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#983)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#741)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#806)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1398)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1351)(self):**

&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#745)(self):**

Delete all gcov counter files.

&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#826)(self, tests):**

&emsp; **@property**<br>&mdash; **def [isolate\_targets](/scripts/slave/recipe_modules/v8/api.py#462)(self):**

&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#486)(self, extra_targets=None):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#676)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/v8/api.py#198)(self):**

&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1444)(self, available_bisect_range):**
...
&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#693)(self, update_step):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1219)(self, test_spec=None, \*\*additional_properties):**

&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#413)(self):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1460)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1469)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1449)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#335)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#831)(self, tests):**

&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#290)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#348)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/v8/api.py#361)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#352)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#356)(self):**

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1145)(self):**

&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#208)(self):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#668)(self, name_suffix='', archive=None):**

&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#752)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1473)(blob):**
...
&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#273)(self):**

&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#189)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#147)(self, \*\*kwargs):**

&mdash; **def [clean\_test\_output](/scripts/slave/recipe_modules/webrtc/api.py#357)(self):**

Remove all test output in out/, since we have tests leaking files.

&mdash; **def [cleanup](/scripts/slave/recipe_modules/webrtc/api.py#350)(self):**

&mdash; **def [compile](/scripts/slave/recipe_modules/webrtc/api.py#199)(self):**

&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/webrtc/api.py#109)(self):**

&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#161)(self):**

&mdash; **def [download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#169)(self):**

&mdash; **def [extract\_build](/scripts/slave/recipe_modules/webrtc/api.py#329)(self):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#250)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#314)(self):**

&mdash; **def [package\_build](/scripts/slave/recipe_modules/webrtc/api.py#263)(self):**

&mdash; **def [run\_baremetal\_test](/scripts/slave/recipe_modules/webrtc/api.py#245)(self, test, name=None, gtest_args=None, args=None, parallel=True):**

&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#193)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#208)(self):**
...
&mdash; **def [virtual\_webcam\_check](/scripts/slave/recipe_modules/webrtc/api.py#365)(self):**
...
&mdash; **def [GetCheckout](/scripts/slave/recipes/dart/flutter_engine.py#65)(api):**
...
&mdash; **def [TestFlutter](/scripts/slave/recipes/dart/flutter_engine.py#89)(api):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#342)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#408)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#189)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#139)(api):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#247)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#424)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#364)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#440)(api):**
...
&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#303)(api, label, device_out, sim_out, bucket_name):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/engine.py#226)(api, ios_tools_path, target_version):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#455)(api):**

&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#239)(api):**

&mdash; **def [TestEngine](/scripts/slave/recipes/flutter/engine.py#219)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#208)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/flutter.py#175)(api):**
...
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/64f2fabf454ac0aeac1d80c62e46370655c073dc/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/64f2fabf454ac0aeac1d80c62e46370655c073dc/recipes/README.recipes.md#recipe_modules-depot_tools
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/64f2fabf454ac0aeac1d80c62e46370655c073dc/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/64f2fabf454ac0aeac1d80c62e46370655c073dc/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/64f2fabf454ac0aeac1d80c62e46370655c073dc/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/64f2fabf454ac0aeac1d80c62e46370655c073dc/recipes/README.recipes.md#recipe_modules-gsutil
...
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/64f2fabf454ac0aeac1d80c62e46370655c073dc/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/64f2fabf454ac0aeac1d80c62e46370655c073dc/recipes/README.recipes.md#recipe_modules-tryserver
[recipe_engine/recipe_modules/buildbucket]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5906d3e7a321c743d49f29a995040c41cc08ec24/README.recipes.md#recipe_modules-buildbucket
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5906d3e7a321c743d49f29a995040c41cc08ec24/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5906d3e7a321c743d49f29a995040c41cc08ec24/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5906d3e7a321c743d49f29a995040c41cc08ec24/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5906d3e7a321c743d49f29a995040c41cc08ec24/recipe_engine/util.py#120
