...
&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#540)(self, builder_id, update_step, bot_config):**
...
&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#357)(self, bot_config, update_step, build_config, compile_targets, tests_including_triggered, builder_id=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=True, override_bot_type=None):**
...
&mdash; **def [create\_test\_runner](/scripts/slave/recipe_modules/chromium_tests/api.py#274)(self, tests, suffix='', serialize_tests=False, retry_failed_shards=False, retry_invalid_shards=False):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#784)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#666)(self, builder_id, update_step, bot_config, build_archive_url=None, build_revision=None, override_bot_type=None, read_gn_args=True):**

&mdash; **def [generate\_tests\_from\_source\_side\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#242)(self, source_side_spec, bot_spec, buildername, mastername, swarming_dimensions, scripts_compile_targets_fn, bot_update_step):**

&mdash; **def [get\_android\_version\_details](/scripts/slave/recipe_modules/chromium_tests/api.py#327)(self, bot_config, log_details=False):**
...
&mdash; **def [lookup\_bot\_metadata](/scripts/slave/recipe_modules/chromium_tests/api.py#1370)(self, builders=None, mirrored_bots=None):**

&mdash; **def [lookup\_builder\_gn\_args](/scripts/slave/recipe_modules/chromium_tests/api.py#1633)(self, bot_meta_data, mb_config_path=None, mb_phase=None, builders=None):**

&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1030)(self, mb_config_path=None, mb_phase=None, builders=None):**
...
&mdash; **def [package\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#469)(self, builder_id, update_step, bot_config, reasons=None):**
...
&mdash; **def [read\_source\_side\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#262)(self, source_side_spec_file):**

&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#633)(self, compile_targets, isolated_targets, name_suffix, builder_id=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=False, android_version_code=None, android_version_name=None):**

&mdash; **def [run\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#1658)(self, bot_meta_data, tests):**
...
&mdash; **def [trigger\_child\_builds](/scripts/slave/recipe_modules/chromium_tests/api.py#602)(self, builder_id, update_step, bot_config, additional_properties=None):**
