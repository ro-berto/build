...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1384)(self, sequence, subsequence, value):**
...
&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1360)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1313)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1406)(self, available_bisect_range):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1422)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1431)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1411)(self, culprit_range):**
...
&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1435)(blob):**
