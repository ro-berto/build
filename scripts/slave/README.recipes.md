...
&mdash; **def [apply\_bot\_config](/scripts/slave/recipe_modules/webrtc/api.py#107)(self, builders, recipe_configs):**

&mdash; **def [apply\_ios\_config](/scripts/slave/recipe_modules/webrtc/api.py#142)(self):**
...
&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#580)(self):**
...
&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#454)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#396)(self, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/webrtc/api.py#500)(self, phase=None, override_targets=None):**

&mdash; **def [configure\_isolate](/scripts/slave/recipe_modules/webrtc/api.py#348)(self, phase=None):**

&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/webrtc/api.py#355)(self):**

&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#426)(self):**

&mdash; **def [download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#434)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [ensure\_sdk](/scripts/slave/recipe_modules/webrtc/api.py#458)(self):**

&mdash; **def [get\_binary\_sizes](/scripts/slave/recipe_modules/webrtc/api.py#513)(self, files=None, base_dir=None):**

&mdash; **def [get\_bot](/scripts/slave/recipe_modules/webrtc/api.py#244)(self, bucketname, buildername):**

&mdash; **def [is\_compile\_needed](/scripts/slave/recipe_modules/webrtc/api.py#274)(self, phase=None, is_ios=False):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/webrtc/api.py#509)(self):**

&emsp; **@property**<br>&mdash; **def [master\_config](/scripts/slave/recipe_modules/webrtc/api.py#247)(self):**

&emsp; **@property**<br>&mdash; **def [mastername](/scripts/slave/recipe_modules/webrtc/api.py#251)(self):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#564)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#621)(self):**
...
&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#463)(self, phase=None):**

&mdash; **def [run\_mb\_ios](/scripts/slave/recipe_modules/webrtc/api.py#483)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#529)(self, phase=None):**
...
&mdash; **def [upload\_to\_perf\_dashboard](/scripts/slave/recipe_modules/webrtc/api.py#637)(self, name, step_result):**
