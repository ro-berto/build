...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#777)(self, canary=False):**
...
&emsp; **@property**<br>&mdash; **def [bigquery\_service\_account\_json\_path](/scripts/slave/recipe_modules/goma/api.py#75)(self):**

&mdash; **def [build\_with\_goma](/scripts/slave/recipe_modules/goma/api.py#495)(self, ninja_command, name=None, ninja_log_outdir=None, ninja_log_compiler=None, goma_env=None, ninja_env=None, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [cloudtail\_exe](/scripts/slave/recipe_modules/goma/api.py#79)(self):**

&emsp; **@property**<br>&mdash; **def [cloudtail\_pid\_file](/scripts/slave/recipe_modules/goma/api.py#86)(self):**

&emsp; **@property**<br>&mdash; **def [cloudtail\_service\_account\_json\_path](/scripts/slave/recipe_modules/goma/api.py#66)(self):**

&emsp; **@property**<br>&mdash; **def [counterz\_path](/scripts/slave/recipe_modules/goma/api.py#70)(self):**

&emsp; **@property**<br>&mdash; **def [debug](/scripts/slave/recipe_modules/goma/api.py#129)(self):**
...
&emsp; **@property**<br>&mdash; **def [default\_cache\_path](/scripts/slave/recipe_modules/goma/api.py#109)(self):**

&emsp; **@property**<br>&mdash; **def [default\_cache\_path\_per\_slave](/scripts/slave/recipe_modules/goma/api.py#100)(self):**

&emsp; **@property**<br>&mdash; **def [default\_client\_path](/scripts/slave/recipe_modules/goma/api.py#116)(self):**

&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/goma/api.py#158)(self, canary=False):**

&emsp; **@property**<br>&mdash; **def [goma\_ctl](/scripts/slave/recipe_modules/goma/api.py#187)(self):**

&emsp; **@property**<br>&mdash; **def [goma\_dir](/scripts/slave/recipe_modules/goma/api.py#191)(self):**

&mdash; **def [initialize](/scripts/slave/recipe_modules/goma/api.py#58)(self):**

&emsp; **@property**<br>&mdash; **def [jobs](/scripts/slave/recipe_modules/goma/api.py#120)(self):**
...
&emsp; **@property**<br>&mdash; **def [json\_path](/scripts/slave/recipe_modules/goma/api.py#90)(self):**

&emsp; **@property**<br>&mdash; **def [jsonstatus](/scripts/slave/recipe_modules/goma/api.py#95)(self):**

&emsp; **@property**<br>&mdash; **def [recommended\_goma\_jobs](/scripts/slave/recipe_modules/goma/api.py#138)(self):**
...
&emsp; **@property**<br>&mdash; **def [service\_account\_json\_path](/scripts/slave/recipe_modules/goma/api.py#62)(self):**

&mdash; **def [start](/scripts/slave/recipe_modules/goma/api.py#255)(self, env=None, \*\*kwargs):**
...
&mdash; **def [stop](/scripts/slave/recipe_modules/goma/api.py#327)(self, build_exit_status, ninja_log_outdir=None, ninja_log_compiler=None, ninja_log_command=None, build_step_name='', \*\*kwargs):**
...
&mdash; **def [bootstrap\_swarming](/scripts/slave/recipe_modules/ios/api.py#567)(self):**

Bootstraps Swarming.

&emsp; **@property**<br>&mdash; **def [bucket](/scripts/slave/recipe_modules/ios/api.py#67)(self):**

&mdash; **def [build](/scripts/slave/recipe_modules/ios/api.py#344)(self, analyze=False, mb_path=None, suffix=None, use_mb=True):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#919)(self, tasks, upload_test_results=True):**
...
&mdash; **def [ensure\_xcode](/scripts/slave/recipe_modules/ios/api.py#317)(self, xcode_build_version):**

&mdash; **def [get\_mac\_toolchain\_cmd](/scripts/slave/recipe_modules/ios/api.py#311)(self):**

&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#1094)(self, path):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#573)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#729)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_earlgrey\_test](/scripts/slave/recipe_modules/ios/api.py#674)(self, test, shard_size, tmp_dir, isolate_template):**

Isolate earlgrey test into small shards

&mdash; **def [isolate\_test](/scripts/slave/recipe_modules/ios/api.py#594)(self, test, tmp_dir, isolate_template, test_cases=None, shard_num=None):**
...
&mdash; **def [symupload](/scripts/slave/recipe_modules/ios/api.py#491)(self, artifact, url):**
...
&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#810)(self, tasks):**

Triggers the given Swarming tasks.

&mdash; **def [upload](/scripts/slave/recipe_modules/ios/api.py#537)(self, base_path=None):**

Uploads built artifacts as instructed by this bot's build config.

&mdash; **def [upload\_tgz](/scripts/slave/recipe_modules/ios/api.py#506)(self, artifact, bucket, path):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/swarming/api.py#1273)(self, task):**

SwarmingTask -> argument list for 'swarming.py' command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/swarming/api.py#1197)(self, prefix, task):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_codesearch.py#130)(api, root_solution_revision, root_solution_revision_timestamp):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/19a169cc25a9af5053811f4cf1323cecccf903f9/recipes/README.recipes.md#recipe_modules-windows_sdk
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/53053ef702fea3816a322b4ecc697348e7002555/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/53053ef702fea3816a322b4ecc697348e7002555/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/53053ef702fea3816a322b4ecc697348e7002555/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/53053ef702fea3816a322b4ecc697348e7002555/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/recipe_modules/tempfile]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/53053ef702fea3816a322b4ecc697348e7002555/README.recipes.md#recipe_modules-tempfile
[recipe_engine/recipe_modules/time]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/53053ef702fea3816a322b4ecc697348e7002555/README.recipes.md#recipe_modules-time
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/53053ef702fea3816a322b4ecc697348e7002555/recipe_engine/util.py#120
