...
&mdash; **def [collect](/scripts/slave/recipe_modules/dart/api.py#121)(self, tasks):**

Collects the results of a sharded test run.

&mdash; **def [collect\_all](/scripts/slave/recipe_modules/dart/api.py#138)(self, deferred_tasks):**
...
&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#173)(self):**

Reads the debug.log file

&mdash; **def [read\_result\_file](/scripts/slave/recipe_modules/dart/api.py#154)(self, name, log_name, test_data=''):**
...
&mdash; **def [shard](/scripts/slave/recipe_modules/dart/api.py#83)(self, title, isolate_hash, test_args, os=None, cpu='x86-64', pool='Dart.LUCI', num_shards=0):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#184)(self, test_data):**
...
&mdash; **def [upload\_isolate](/scripts/slave/recipe_modules/dart/api.py#66)(self, isolate_fileset):**
