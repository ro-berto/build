...
&mdash; **def [build](/scripts/slave/recipe_modules/dart/api.py#84)(self, build_args=[], isolate=None, name='build dart'):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/dart/api.py#204)(self, tasks):**

Collects the results of a sharded test run.

&mdash; **def [collect\_all](/scripts/slave/recipe_modules/dart/api.py#221)(self, deferred_tasks):**

Collects the results of a sharded test run.

&mdash; **def [dart\_executable](/scripts/slave/recipe_modules/dart/api.py#79)(self):**

&mdash; **def [download\_parent\_isolate](/scripts/slave/recipe_modules/dart/api.py#150)(self):**
...
&mdash; **def [kill\_tasks](/scripts/slave/recipe_modules/dart/api.py#72)(self):**

Kills leftover tasks from previous runs or steps.

&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#270)(self):**

Reads the debug.log file

&mdash; **def [read\_result\_file](/scripts/slave/recipe_modules/dart/api.py#251)(self, name, log_name, test_data=''):**
...
&mdash; **def [run\_script](/scripts/slave/recipe_modules/dart/api.py#596)(self, step_name, script, args, isolate_hash, shards, local_shard, environment, tasks, cipd_packages=[]):**
...
&mdash; **def [run\_test\_py](/scripts/slave/recipe_modules/dart/api.py#509)(self, step_name, append_logs, step, isolate_hash, shards, local_shard, environment, tasks, global_config):**
...
&mdash; **def [run\_trigger](/scripts/slave/recipe_modules/dart/api.py#475)(self, step_name, step, isolate_hash):**

&mdash; **def [shard](/scripts/slave/recipe_modules/dart/api.py#164)(self, title, isolate_hash, test_args, os=None, cpu='x86-64', pool='dart.tests', num_shards=0, last_shard_is_local=False, cipd_packages=[]):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#281)(self, test_data):**
...
&mdash; **def [upload\_results](/scripts/slave/recipe_modules/dart/api.py#237)(self, name):**
