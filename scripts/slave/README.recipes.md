...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1060)(self, step_name, gs_bucket, gs_acl=None, mode=None, \*\*kwargs):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#814)(self):**
...
&mdash; **def [delete\_old\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#768)(self):**
...
&mdash; **def [ensure\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#777)(self):**

&mdash; **def [ensure\_toolchains](/scripts/slave/recipe_modules/chromium/api.py#810)(self):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1101)(self, test_name):**
...
&mdash; **def [get\_mac\_toolchain\_installer](/scripts/slave/recipe_modules/chromium/api.py#754)(self):**
...
&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1048)(self, \*\*kwargs):**

&mdash; **def [reload\_version](/scripts/slave/recipe_modules/chromium/api.py#166)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#868)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gyp\_chromium](/scripts/slave/recipe_modules/chromium/api.py#860)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb](/scripts/slave/recipe_modules/chromium/api.py#932)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, isolated_targets=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#824)(self, env=None, \*\*kwargs):**
...
&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1042)(self):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [update\_clang](/scripts/slave/recipe_modules/chromium/api.py#1032)(self):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/swarming/api.py#1205)(self, task):**

SwarmingTask -> argument list for 'swarming.py' command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/swarming/api.py#1135)(self, prefix, task):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#352)(self):**

&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#749)(self):**

&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1361)(self, bucket, changes, requests, step_name='trigger', service_account='v8-bot', no_buildset=False):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1489)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#278)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#232)(self, revision=None, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#591)(self, test_spec=None, \*\*kwargs):**
...
&mdash; **def [download\_build](/scripts/slave/recipe_modules/v8/api.py#729)(self, name_suffix='', archive=None):**

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#737)(self, revision):**

&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1131)(self):**

&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#400)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#995)(duration_in_seconds):**
...
&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1465)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1415)(self):**

&mdash; **def [get\_changes](/scripts/slave/recipe_modules/v8/api.py#1355)(self):**
...
&emsp; **@property**<br>&mdash; **def [isolate\_targets](/scripts/slave/recipe_modules/v8/api.py#470)(self):**

&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#494)(self, isolate_targets):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/v8/api.py#202)(self):**

&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1511)(self, available_bisect_range):**
...
&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#713)(self, update_step):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1231)(self, test_spec=None, \*\*additional_properties):**

&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#421)(self):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1527)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1536)(self, ref, step_name_desc):**

Read and return the version at a paricular ref.

&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#373)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1516)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#343)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#843)(self, tests):**

&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#294)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#356)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/v8/api.py#369)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#360)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#364)(self):**

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1157)(self):**

&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#212)(self):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#688)(self, name_suffix='', archive=None):**
...
&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#705)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1540)(blob):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#348)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#420)(api):**
...
&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#436)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#376)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#452)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#467)(api):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/da55cdc03c9a4db31cc54132dbc61d53e4a8d798/recipes/README.recipes.md#recipe_modules-gerrit
