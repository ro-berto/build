...
#### **class [ClangCoverageApi](/scripts/slave/recipe_modules/clang_coverage/api.py#19)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

This module contains apis to interact with llvm-cov and llvm-profdata.

&emsp; **@property**<br>&mdash; **def [cov\_executable](/scripts/slave/recipe_modules/clang_coverage/api.py#69)(self):**

Returns the path to the llvm-cov executable.

&mdash; **def [instrument](/scripts/slave/recipe_modules/clang_coverage/api.py#135)(self, affected_files):**
...
&emsp; **@property**<br>&mdash; **def [metadata\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#81)(self):**

A temporary directory for the metadata. Created on first access.

&mdash; **def [process\_coverage\_data](/scripts/slave/recipe_modules/clang_coverage/api.py#155)(self, tests):**
...
&mdash; **def [profdata\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#88)(self, step_name=None):**
...
&emsp; **@property**<br>&mdash; **def [profdata\_executable](/scripts/slave/recipe_modules/clang_coverage/api.py#64)(self):**

Returns the path to the llvm-profdata executable.

&emsp; **@property**<br>&mdash; **def [raw\_profile\_merge\_script](/scripts/slave/recipe_modules/clang_coverage/api.py#51)(self):**
...
&emsp; **@property**<br>&mdash; **def [report\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#74)(self):**

A temporary directory to save a report to. Created on first access.

&mdash; **def [shard\_merge](/scripts/slave/recipe_modules/clang_coverage/api.py#219)(self, step_name):**

Returns a merge object understood by the swarming module.

See the docstring for the `merge` parameter of api.swarming.task.

&emsp; **@property**<br>&mdash; **def [using\_coverage](/scripts/slave/recipe_modules/clang_coverage/api.py#112)(self):**
