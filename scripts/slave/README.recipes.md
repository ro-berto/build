...
#### **class [V8Api](/scripts/slave/recipe_modules/v8/api.py#117)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [apply\_bot\_config](/scripts/slave/recipe_modules/v8/api.py#147)(self, builders, tryserver_check=True):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1407)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#312)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [calculate\_patch\_base\_rietveld](/scripts/slave/recipe_modules/v8/api.py#292)(self):**

Calculates the latest commit hash that fits the patch.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#246)(self, revision=None, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#575)(self, \*\*kwargs):**
...
&mdash; **def [dr\_compile](/scripts/slave/recipe_modules/v8/api.py#653)(self):**
...
&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1383)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1336)(self):**

&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#746)(self):**

Delete all gcov counter files.

&mdash; **def [init\_tryserver](/scripts/slave/recipe_modules/v8/api.py#238)(self):**

&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#827)(self, tests):**

&emsp; **@property**<br>&mdash; **def [isolate\_targets](/scripts/slave/recipe_modules/v8/api.py#440)(self):**

&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#464)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#682)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/v8/api.py#208)(self):**

&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1429)(self, available_bisect_range):**
...
&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#699)(self, update_step):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1220)(self, \*\*additional_properties):**

&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1445)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1454)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1434)(self, culprit_range):**

&emsp; **@property**<br>&mdash; **def [run\_dynamorio](/scripts/slave/recipe_modules/v8/api.py#670)(self):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#373)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#832)(self, tests):**

&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#328)(self):**
...
&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#218)(self):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#674)(self, name_suffix='', archive=None):**
...
&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#691)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1458)(blob):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/46a672bafa212d2027fe68198840c68042e815d0/recipes/README.recipes.md#recipe_modules-gerrit
