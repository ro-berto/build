...
&mdash; **def [check\_client\_version](/scripts/slave/recipe_modules/chromium_swarming/api.py#694)(self, step_test_data=None):**

Yields steps to verify compatibility with swarming_client version.

&mdash; **def [collect\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#1022)(self, task, \*\*kwargs):**
...
&mdash; **def [generate\_trigger\_task\_shard\_args](/scripts/slave/recipe_modules/chromium_swarming/api.py#771)(self, task, \*\*kwargs):**
...
&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/chromium_swarming/api.py#1453)(self, prefix, task):**
...
&mdash; **def [gtest\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#612)(self, title, isolated_hash, test_launcher_summary_output=None, extra_args=None, cipd_packages=None, merge=None, \*\*kwargs):**
...
&mdash; **def [isolated\_script\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#659)(self, title, isolated_hash, extra_args=None, idempotent=False, merge=None, \*\*kwargs):**
...
&mdash; **def [report\_stats](/scripts/slave/recipe_modules/chromium_swarming/api.py#1050)(self):**
...
&mdash; **def [trigger\_all\_task\_shards](/scripts/slave/recipe_modules/chromium_swarming/api.py#924)(self, task, shard_indices, \*\*kwargs):**
...
&mdash; **def [trigger\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#699)(self, task, \*\*kwargs):**
...
&mdash; **def [trigger\_task\_shard](/scripts/slave/recipe_modules/chromium_swarming/api.py#968)(self, task, shard_index, \*\*kwargs):**
...
&mdash; **def [instrument](/scripts/slave/recipe_modules/clang_coverage/api.py#190)(self, affected_files):**
...
&mdash; **def [process\_coverage\_data](/scripts/slave/recipe_modules/clang_coverage/api.py#217)(self, tests):**
...
&mdash; **def [shard\_merge](/scripts/slave/recipe_modules/clang_coverage/api.py#361)(self, step_name):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#546)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#660)(api):**
...
&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#379)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#687)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#576)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#703)(api):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#34)(api, path):**

&mdash; **def [GetMacSDKDir](/scripts/slave/recipes/flutter/engine.py#364)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallJazzy](/scripts/slave/recipes/flutter/engine.py#675)(api):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#171)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#481)(api, label, arm64_out, armv7_out, sim_out, bucket_name):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#721)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#367)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#347)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/led_recipes_tester.py#123)(api, repo_name):**

&mdash; **def [trigger\_cl](/scripts/slave/recipes/led_recipes_tester.py#78)(api, recipe, repo_path, recipes_py_path, builder):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8.py#75)(api, binary_size_tracking, build_config, clobber, clobber_all, clusterfuzz_archive, coverage, custom_deps, default_targets, enable_swarming, mb_config_path, set_gclient_var, target_arch, target_platform, track_build_dependencies, triggers, triggers_proxy, use_goma):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/33bd5822245c5b1ace318f3a5340a983889d07c7/recipes/README.recipes.md#recipe_modules-windows_sdk
[recipe_engine/recipe_modules/assertions]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/24332ebdcdd5cbf04f12062f6969ab5fbfc93182/README.recipes.md#recipe_modules-assertions
...
[recipe_engine/recipe_modules/cq]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/24332ebdcdd5cbf04f12062f6969ab5fbfc93182/README.recipes.md#recipe_modules-cq
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/24332ebdcdd5cbf04f12062f6969ab5fbfc93182/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/24332ebdcdd5cbf04f12062f6969ab5fbfc93182/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/24332ebdcdd5cbf04f12062f6969ab5fbfc93182/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/24332ebdcdd5cbf04f12062f6969ab5fbfc93182/recipe_engine/util.py#132
