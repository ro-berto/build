...
&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#569)(self):**
...
&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#443)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#385)(self, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/webrtc/api.py#489)(self, phase=None, override_targets=None):**

&mdash; **def [configure\_isolate](/scripts/slave/recipe_modules/webrtc/api.py#337)(self, phase=None):**

&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/webrtc/api.py#344)(self):**

&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#415)(self):**

&mdash; **def [download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#423)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [ensure\_sdk](/scripts/slave/recipe_modules/webrtc/api.py#447)(self):**

&mdash; **def [get\_binary\_sizes](/scripts/slave/recipe_modules/webrtc/api.py#502)(self, files=None, base_dir=None):**

&mdash; **def [get\_bot](/scripts/slave/recipe_modules/webrtc/api.py#244)(self, bucketname, buildername):**

&mdash; **def [is\_compile\_needed](/scripts/slave/recipe_modules/webrtc/api.py#274)(self, phase=None):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/webrtc/api.py#498)(self):**
...
&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#553)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#610)(self):**
...
&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#452)(self, phase=None):**

&mdash; **def [run\_mb\_ios](/scripts/slave/recipe_modules/webrtc/api.py#472)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#518)(self, phase=None):**
...
&mdash; **def [upload\_to\_perf\_dashboard](/scripts/slave/recipe_modules/webrtc/api.py#626)(self, name, step_result, use_histograms=False):**
