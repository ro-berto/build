...
&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#485)(self, mastername, buildername, update_step, bot_db):**
...
&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#306)(self, bot_config, update_step, bot_db, compile_targets, tests_including_triggered, mb_mastername=None, mb_buildername=None, mb_config_path=None, override_bot_type=None):**
...
&mdash; **def [configure\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#94)(self, bot_config, override_bot_type=None):**
...
&mdash; **def [create\_bot\_db\_from\_master\_dict](/scripts/slave/recipe_modules/chromium_tests/api.py#201)(self, mastername, master_dict):**

&mdash; **def [create\_bot\_db\_object](/scripts/slave/recipe_modules/chromium_tests/api.py#73)(self):**

&mdash; **def [create\_generalized\_bot\_config\_object](/scripts/slave/recipe_modules/chromium_tests/api.py#61)(self, bot_ids, builders=None):**

&mdash; **def [create\_test\_runner](/scripts/slave/recipe_modules/chromium_tests/api.py#254)(self, tests, suffix='', serialize_tests=False):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#725)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#607)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None):**

&mdash; **def [generate\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#228)(self, test_spec, builder_dict, buildername, mastername, swarming_dimensions, scripts_compile_targets, generators, bot_update_step, bot_config):**

&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#825)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#299)(self, bot_config, bot_db, tests):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#857)(self, bot_config=None):**
...
&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium_tests/api.py#91)(self):**

&mdash; **def [get\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#290)(self, bot_config, bot_db):**

Returns a tuple: list of tests, and list of tests on the triggered
testers.

&mdash; **def [is\_precommit\_mode](/scripts/slave/recipe_modules/chromium_tests/api.py#84)(self):**
...
&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#889)(self, mb_config_path=None, bot_config=None):**

&mdash; **def [package\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#427)(self, mastername, buildername, update_step, bot_db):**
...
&mdash; **def [prepare\_checkout](/scripts/slave/recipe_modules/chromium_tests/api.py#206)(self, bot_config, root_solution_revision=None, disable_syntax_validation=False):**

&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#243)(self, test_spec_file):**

&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#584)(self, compile_targets, isolated_targets, name_suffix, mb_mastername=None, mb_buildername=None, mb_config_path=None, android_version_code=None, android_version_name=None):**

&mdash; **def [run\_tests\_on\_tryserver](/scripts/slave/recipe_modules/chromium_tests/api.py#737)(self, bot_config, tests, bot_update_step, affected_files, mb_mastername=None, mb_buildername=None, disable_deapply_patch=False):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium_tests/api.py#187)(self, update_step):**

&mdash; **def [set\_precommit\_mode](/scripts/slave/recipe_modules/chromium_tests/api.py#76)(self):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/chromium_tests/api.py#163)(self, bot_config):**

&emsp; **@property**<br>&mdash; **def [steps](/scripts/slave/recipe_modules/chromium_tests/api.py#39)(self):**

&mdash; **def [trigger\_child\_builds](/scripts/slave/recipe_modules/chromium_tests/api.py#516)(self, mastername, buildername, update_step, bot_db, additional_properties=None):**

&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#947)(self, builders=None, trybots=None):**

&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#43)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#661)(self, bot_config, tests=None):**
...
[DEPS](/scripts/slave/recipe_modules/dart/__init__.py#1): [goma](#recipe_modules-goma), [swarming](#recipe_modules-swarming), [swarming\_client](#recipe_modules-swarming_client), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/cipd][depot_tools/recipe_modules/cipd], [depot\_tools/depot\_tools][depot_tools/recipe_modules/depot_tools], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/gsutil][depot_tools/recipe_modules/gsutil], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [build](/scripts/slave/recipe_modules/dart/api.py#79)(self, build_args=[], isolate=None, name='build dart'):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/dart/api.py#197)(self, tasks):**
...
&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#249)(self):**

Reads the debug.log file

&mdash; **def [read\_result\_file](/scripts/slave/recipe_modules/dart/api.py#230)(self, name, log_name, test_data=''):**
...
&mdash; **def [run\_script](/scripts/slave/recipe_modules/dart/api.py#562)(self, step_name, script, args, isolate_hash, shards, local_shard, environment, tasks, cipd_packages=[]):**
...
&mdash; **def [run\_test\_py](/scripts/slave/recipe_modules/dart/api.py#488)(self, step_name, append_logs, step, isolate_hash, shards, local_shard, environment, tasks, global_config):**
...
&mdash; **def [run\_trigger](/scripts/slave/recipe_modules/dart/api.py#454)(self, step_name, step, isolate_hash):**

&mdash; **def [shard](/scripts/slave/recipe_modules/dart/api.py#159)(self, title, isolate_hash, test_args, os=None, cpu='x86-64', pool='dart.tests', num_shards=0, last_shard_is_local=False, cipd_packages=[]):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#260)(self, test_data):**
...
&mdash; **def [upload\_isolate](/scripts/slave/recipe_modules/dart/api.py#127)(self, isolate_fileset):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#920)(self, tasks, upload_test_results=True):**
...
&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#1095)(self, path):**
...
&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#1180)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#1167)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#1195)(self):**
...
&mdash; **def [compose](/scripts/slave/recipe_modules/isolate/api.py#355)(self, isolate_hashes, step_name=None, \*\*kwargs):**
...
&mdash; **def [collect\_task](/scripts/slave/recipe_modules/swarming/api.py#829)(self, task, \*\*kwargs):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/swarming/api.py#1296)(self, task):**

SwarmingTask -> argument list for 'swarming.py' command.

&mdash; **def [get\_states](/scripts/slave/recipe_modules/swarming/api.py#1145)(self, task_ids, suffix=None):**

Returns the states of a list of tasks.

Uses the 'get_states' endpoint on the server.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/swarming/api.py#1220)(self, prefix, task):**
...
&mdash; **def [report\_stats](/scripts/slave/recipe_modules/swarming/api.py#857)(self):**
...
&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1484)(self, bucket, changes, requests, step_name='trigger', service_account='v8-bot', no_buildset=False):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1624)(self, sequence, subsequence, value):**
...
&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1244)(self):**
...
&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1600)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1543)(self):**

&mdash; **def [get\_changes](/scripts/slave/recipe_modules/v8/api.py#1478)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1646)(self, available_bisect_range):**
...
&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1348)(self, test_spec=EmptyTestSpec, \*\*additional_properties):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1662)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1671)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1651)(self, culprit_range):**
...
&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1270)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1675)(blob):**
...
&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#329)(self):**
...
&mdash; **def [clean\_test\_output](/scripts/slave/recipe_modules/webrtc/api.py#414)(self):**

Remove all test output in out/, since we have tests leaking files.

&mdash; **def [cleanup](/scripts/slave/recipe_modules/webrtc/api.py#407)(self):**
...
&mdash; **def [extract\_build](/scripts/slave/recipe_modules/webrtc/api.py#386)(self):**

&mdash; **def [get\_binary\_sizes](/scripts/slave/recipe_modules/webrtc/api.py#253)(self, files=None, base_dir=None):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#306)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#370)(self):**

&mdash; **def [package\_build](/scripts/slave/recipe_modules/webrtc/api.py#319)(self):**

&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#228)(self, phase=None):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#269)(self, phase=None):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/art.py#603)(api):**
...
&mdash; **def [setup\_target](/scripts/slave/recipes/art.py#217)(api, serial, debug, device, concurrent_collector=True, generational_cc=False, heap_poisoning=False, gcstress=False):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/binary_size_trybot.py#41)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/blink_downstream.py#107)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/dawn.py#105)(api, target_cpu, debug, clang):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/led_recipes_tester.py#51)(api, repo_name):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98e0938d51abf5a58b146e42fd17c6965fe96a53/recipes/README.recipes.md#recipe_modules-windows_sdk
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/05d5dfbcffe7924ac6344f14904224db54a93574/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/05d5dfbcffe7924ac6344f14904224db54a93574/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/05d5dfbcffe7924ac6344f14904224db54a93574/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/05d5dfbcffe7924ac6344f14904224db54a93574/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/recipe_modules/tempfile]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/05d5dfbcffe7924ac6344f14904224db54a93574/README.recipes.md#recipe_modules-tempfile
[recipe_engine/recipe_modules/time]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/05d5dfbcffe7924ac6344f14904224db54a93574/README.recipes.md#recipe_modules-time
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/05d5dfbcffe7924ac6344f14904224db54a93574/recipe_engine/util.py#120
