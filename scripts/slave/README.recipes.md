...
&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#577)(self):**
...
&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#451)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#393)(self, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/webrtc/api.py#497)(self, phase=None, override_targets=None):**

&mdash; **def [configure\_isolate](/scripts/slave/recipe_modules/webrtc/api.py#345)(self, phase=None):**

&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/webrtc/api.py#352)(self):**

&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#423)(self):**

&mdash; **def [download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#431)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [ensure\_sdk](/scripts/slave/recipe_modules/webrtc/api.py#455)(self):**

&mdash; **def [get\_binary\_sizes](/scripts/slave/recipe_modules/webrtc/api.py#510)(self, files=None, base_dir=None):**
...
&mdash; **def [isolate](/scripts/slave/recipe_modules/webrtc/api.py#506)(self):**
...
&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#561)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#618)(self):**
...
&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#460)(self, phase=None):**

&mdash; **def [run\_mb\_ios](/scripts/slave/recipe_modules/webrtc/api.py#480)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#526)(self, phase=None):**
...
&mdash; **def [upload\_to\_perf\_dashboard](/scripts/slave/recipe_modules/webrtc/api.py#634)(self, name, step_result, use_histograms=False):**
