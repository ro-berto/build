...
&mdash; **def [add\_default\_tag](/scripts/slave/recipe_modules/chromium_swarming/api.py#440)(self, tag):**
...
&mdash; **def [check\_client\_version](/scripts/slave/recipe_modules/chromium_swarming/api.py#714)(self, step_test_data=None):**

Yields steps to verify compatibility with swarming_client version.

&mdash; **def [collect\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#1083)(self, task, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [default\_dimensions](/scripts/slave/recipe_modules/chromium_swarming/api.py#375)(self):**
...
&emsp; **@property**<br>&mdash; **def [default\_env](/scripts/slave/recipe_modules/chromium_swarming/api.py#398)(self):**
...
&emsp; **@default_expiration.setter**<br>&mdash; **def [default\_expiration](/scripts/slave/recipe_modules/chromium_swarming/api.py#298)(self, value):**

&emsp; **@default_hard_timeout.setter**<br>&mdash; **def [default\_hard\_timeout](/scripts/slave/recipe_modules/chromium_swarming/api.py#315)(self, value):**

&emsp; **@default_idempotent.setter**<br>&mdash; **def [default\_idempotent](/scripts/slave/recipe_modules/chromium_swarming/api.py#354)(self, value):**

&emsp; **@default_io_timeout.setter**<br>&mdash; **def [default\_io\_timeout](/scripts/slave/recipe_modules/chromium_swarming/api.py#334)(self, value):**

&emsp; **@default_priority.setter**<br>&mdash; **def [default\_priority](/scripts/slave/recipe_modules/chromium_swarming/api.py#425)(self, value):**
...
&mdash; **def [gtest\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#648)(self, name=None, isolated=None, extra_args=None, cipd_packages=None, merge=None, \*\*kwargs):**
...
&mdash; **def [initialize](/scripts/slave/recipe_modules/chromium_swarming/api.py#245)(self):**

&mdash; **def [isolated\_script\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#680)(self):**
...
&mdash; **def [merge\_script\_path](/scripts/slave/recipe_modules/chromium_swarming/api.py#478)(self, name):**
...
&emsp; **@staticmethod**<br>&mdash; **def [prefered\_os\_dimension](/scripts/slave/recipe_modules/chromium_swarming/api.py#460)(platform):**
...
&mdash; **def [report\_stats](/scripts/slave/recipe_modules/chromium_swarming/api.py#1105)(self):**

Report statistics on all tasks ran so far.

&emsp; **@service_account_json.setter**<br>&mdash; **def [service\_account\_json](/scripts/slave/recipe_modules/chromium_swarming/api.py#260)(self, value):**

Service account json to use for swarming.

&mdash; **def [set\_default\_dimension](/scripts/slave/recipe_modules/chromium_swarming/api.py#390)(self, key, value):**

&mdash; **def [set\_default\_env](/scripts/slave/recipe_modules/chromium_swarming/api.py#409)(self, key, value):**

&emsp; **@show_outputs_ref_in_collect_step.setter**<br>&mdash; **def [show\_outputs\_ref\_in\_collect\_step](/scripts/slave/recipe_modules/chromium_swarming/api.py#456)(self, value):**

&mdash; **def [slice\_with\_implied\_cipd\_packages](/scripts/slave/recipe_modules/chromium_swarming/api.py#791)(self, task_slice):**
...
&mdash; **def [slice\_with\_implied\_named\_caches](/scripts/slave/recipe_modules/chromium_swarming/api.py#836)(self, task_slice):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [summary](/scripts/slave/recipe_modules/chromium_swarming/api.py#251)(self):**

&emsp; **@swarming_server.setter**<br>&mdash; **def [swarming\_server](/scripts/slave/recipe_modules/chromium_swarming/api.py#270)(self, value):**

Changes URL of Swarming server to use.

&mdash; **def [task](/scripts/slave/recipe_modules/chromium_swarming/api.py#486)(self, name=None, build_properties=None, cipd_packages=None, collect_step=None, env=None, env_prefixes=None, extra_args=None, failure_as_exception=True, idempotent=None, ignore_task_failure=False, isolated=None, merge=None, named_caches=None, optional_dimensions=None, raw_cmd=None, service_account=None, shards=1, shard_indices=None, task_output_dir=None, task_to_retry=None, trigger_script=None):**
...
&emsp; **@task_output_stdout.setter**<br>&mdash; **def [task\_output\_stdout](/scripts/slave/recipe_modules/chromium_swarming/api.py#435)(self, value):**

&mdash; **def [trigger\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#719)(self, task, \*\*kwargs):**
...
&emsp; **@verbose.setter**<br>&mdash; **def [verbose](/scripts/slave/recipe_modules/chromium_swarming/api.py#280)(self, value):**
...
&mdash; **def [delete\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#548)(self):**
...
&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#536)(self):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#554)(self, test_data):**
...
&emsp; **@property**<br>&mdash; **def [canonical](/scripts/slave/recipe_modules/test_utils/api.py#79)(self):**

&mdash; **def [create\_results\_from\_json](/scripts/slave/recipe_modules/test_utils/api.py#788)(self, data):**

&emsp; **@staticmethod**<br>&mdash; **def [format\_step\_text](/scripts/slave/recipe_modules/test_utils/api.py#110)(data):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [gtest\_results](/scripts/slave/recipe_modules/test_utils/api.py#801)(self, add_json_log=True):**
...
&mdash; **def [limit\_failures](/scripts/slave/recipe_modules/test_utils/api.py#83)(self, failures, limit=None):**
...
&mdash; **def [present\_gtest\_failures](/scripts/slave/recipe_modules/test_utils/api.py#140)(self, step_result, presentation=None):**
...
&mdash; **def [run\_tests](/scripts/slave/recipe_modules/test_utils/api.py#362)(self, caller_api, test_suites, suffix, sort_by_shard=False, retry_failed_shards=False, retry_invalid_shards=False):**
...
&mdash; **def [run\_tests\_with\_patch](/scripts/slave/recipe_modules/test_utils/api.py#480)(self, caller_api, test_suites, retry_failed_shards=False):**
...
&mdash; **def [summarize\_failing\_test\_with\_no\_retries](/scripts/slave/recipe_modules/test_utils/api.py#631)(self, caller_api, test_suite):**

Summarizes a failing test suite that is not going to be retried.

&mdash; **def [summarize\_findit\_flakiness](/scripts/slave/recipe_modules/test_utils/api.py#688)(self, caller_api, test_suites):**
...
&mdash; **def [summarize\_test\_with\_patch\_deapplied](/scripts/slave/recipe_modules/test_utils/api.py#593)(self, caller_api, test_suite):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_results](/scripts/slave/recipe_modules/test_utils/api.py#791)(self, add_json_log=True):**
...
&mdash; **def [apply\_ios\_config](/scripts/slave/recipe_modules/webrtc/api.py#139)(self):**

Generate a JSON config from bot config, apply it to ios recipe module.

&emsp; **@property**<br>&mdash; **def [bucketname](/scripts/slave/recipe_modules/webrtc/api.py#209)(self):**

&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#483)(self):**

&emsp; **@property**<br>&mdash; **def [build\_url](/scripts/slave/recipe_modules/webrtc/api.py#217)(self):**

&emsp; **@property**<br>&mdash; **def [buildername](/scripts/slave/recipe_modules/webrtc/api.py#213)(self):**

&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#370)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#312)(self, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/webrtc/api.py#412)(self, phase=None):**

&mdash; **def [configure\_isolate](/scripts/slave/recipe_modules/webrtc/api.py#255)(self, phase=None):**

&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/webrtc/api.py#271)(self):**

&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#342)(self):**

&mdash; **def [download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#350)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [ensure\_sdk](/scripts/slave/recipe_modules/webrtc/api.py#374)(self):**

&mdash; **def [get\_binary\_sizes](/scripts/slave/recipe_modules/webrtc/api.py#424)(self, files=None, base_dir=None):**

&mdash; **def [get\_bot](/scripts/slave/recipe_modules/webrtc/api.py#225)(self, bucketname, buildername):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/webrtc/api.py#420)(self):**

&emsp; **@property**<br>&mdash; **def [master\_config](/scripts/slave/recipe_modules/webrtc/api.py#228)(self):**

&emsp; **@property**<br>&mdash; **def [mastername](/scripts/slave/recipe_modules/webrtc/api.py#232)(self):**
...
&mdash; **def [related\_bots](/scripts/slave/recipe_modules/webrtc/api.py#236)(self):**

&emsp; **@property**<br>&mdash; **def [revision\_number](/scripts/slave/recipe_modules/webrtc/api.py#203)(self):**

&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#379)(self, phase=None):**

&mdash; **def [run\_mb\_ios](/scripts/slave/recipe_modules/webrtc/api.py#397)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#440)(self, phase=None):**
...
&emsp; **@property**<br>&mdash; **def [should\_download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#241)(self):**
...
### *recipes* / [chromium\_tests:tests/attr\_util](/scripts/slave/recipe_modules/chromium_tests/tests/attr_util.py)
...
[DEPS](/scripts/slave/recipes/devtools/devtools-frontend.py#10): [chromium](#recipe_modules-chromium), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/depot\_tools][depot_tools/recipe_modules/depot_tools], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/git][depot_tools/recipe_modules/git], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipes/devtools/devtools-frontend.py#33)(api):**

&mdash; **def [run\_script](/scripts/slave/recipes/devtools/devtools-frontend.py#83)(api, step_name, script):**

&mdash; **def [test\_cov\_data](/scripts/slave/recipes/devtools/devtools-frontend.py#110)():**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/tricium_clang_tidy_wrapper.py#169)(api):**

&mdash; **def [tricium\_has\_message](/scripts/slave/recipes/tricium_clang_tidy_wrapper.py#247)(check, steps, message):**

&mdash; **def [tricium\_has\_no\_messages](/scripts/slave/recipes/tricium_clang_tidy_wrapper.py#242)(check, steps):**

&mdash; **def [tricium\_has\_replacements](/scripts/slave/recipes/tricium_clang_tidy_wrapper.py#254)(check, steps, \*expected_replacements):**
...
&mdash; **def [GetDEPS](/scripts/slave/recipes/v8/auto_roll_v8_deps.py#115)(api, name, project_name):**

&mdash; **def [RunSteps](/scripts/slave/recipes/v8/auto_roll_v8_deps.py#204)(api):**

&mdash; **def [commit\_messages\_log\_entries](/scripts/slave/recipes/v8/auto_roll_v8_deps.py#156)(api, repo, from_commit, to_commit):**
...
&mdash; **def [create\_gclient\_config](/scripts/slave/recipes/v8/auto_roll_v8_deps.py#195)(api, target_config):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6c6827cbf27df9964f0c8a1fd069f2d31a10b210/recipes/README.recipes.md#recipe_modules-windows_sdk
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9cc10f207c74c1a1d2b5a34436cb21a5dcc57d92/README.recipes.md#recipe_modules-generator_script
[recipe_engine/recipe_modules/isolated]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9cc10f207c74c1a1d2b5a34436cb21a5dcc57d92/README.recipes.md#recipe_modules-isolated
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9cc10f207c74c1a1d2b5a34436cb21a5dcc57d92/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9cc10f207c74c1a1d2b5a34436cb21a5dcc57d92/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/recipe_modules/tricium]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9cc10f207c74c1a1d2b5a34436cb21a5dcc57d92/README.recipes.md#recipe_modules-tricium
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/9cc10f207c74c1a1d2b5a34436cb21a5dcc57d92/recipe_engine/util.py#135
