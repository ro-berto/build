...
&mdash; **def [delete\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#617)(self):**
...
&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#605)(self):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#623)(self, test_data):**
...
&mdash; **def [build\_with\_goma](/scripts/slave/recipe_modules/goma/api.py#553)(self, ninja_command, name=None, ninja_log_outdir=None, ninja_log_compiler=None, goma_env=None, ninja_env=None, \*\*kwargs):**
...
&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1432)(self, requests, project=None, bucket=None, step_name='trigger'):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1536)(self, sequence, subsequence, value):**
...
&mdash; **def [collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#777)(self):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#962)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#968)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#975)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1143)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#873)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#958)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1512)(self, bisect_range):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1461)(self):**
...
&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#978)(self):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#824)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1558)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#1047)(self, test_results):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#839)(self, update_step):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [maybe\_nest](/scripts/slave/recipe_modules/v8/api.py#983)(self, condition, parent_step_name):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1342)(self, test_spec=v8_builders.EmptyTestSpec, \*\*additional_properties):**

&emsp; **@property**<br>&mdash; **def [osx\_sdk\_kind](/scripts/slave/recipe_modules/v8/api.py#650)(self):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1574)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1583)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1563)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#461)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#991)(self, tests):**
...
&emsp; **@property**<br>&mdash; **def [should\_collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#771)(self):**
...
&mdash; **def [ui\_test\_label](/scripts/slave/recipe_modules/v8/api.py#1174)(self, full_test_name):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#817)(self, name_suffix='', archive=None):**
...
&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#831)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1587)(blob):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/art.py#637)(api):**
...
&mdash; **def [AddFiles](/scripts/slave/recipes/flutter/engine.py#117)(api, pkg, relative_paths):**

&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#203)(api):**

&mdash; **def [Build](/scripts/slave/recipes/flutter/engine.py#42)(api, config, \*targets):**

&mdash; **def [BuildFuchsia](/scripts/slave/recipes/flutter/engine.py#349)(api):**
...
&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#249)(api):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#386)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#659)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#567)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#675)(api):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#35)(api, path):**

&mdash; **def [GetMacSDKDir](/scripts/slave/recipes/flutter/engine.py#371)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallJazzy](/scripts/slave/recipes/flutter/engine.py#647)(api):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#194)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#458)(api, label, arm64_out, armv7_out, sim_out, bucket_name):**

&mdash; **def [RunGN](/scripts/slave/recipes/flutter/engine.py#102)(api, \*args):**

&mdash; **def [RunHostTests](/scripts/slave/recipes/flutter/engine.py#53)(api, out_dir, exe_extension=''):**

&mdash; **def [RunIOSTests](/scripts/slave/recipes/flutter/engine.py#523)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#702)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#374)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#354)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#122)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#153)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#179)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#161)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#136)(api, dir_label, parent_dir, folder_name, zip_name, platform=None):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#223)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [UploadWebSdk](/scripts/slave/recipes/flutter/engine.py#186)(api, archive_name):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#212)(api):**
...
&mdash; **def [ConfigureChromiumBuilder](/scripts/slave/recipes/swarming/deterministic_build.py#129)(api, recipe_config):**

&mdash; **def [MoveBuildDirectory](/scripts/slave/recipes/swarming/deterministic_build.py#117)(api, src_dir, dst_dir):**

&mdash; **def [RunSteps](/scripts/slave/recipes/swarming/deterministic_build.py#153)(api, buildername):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/ba1b1f7ab6d0b6c3053826e87ccd109758ffcb27/recipes/README.recipes.md#recipe_modules-windows_sdk
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/39c2db1744c62991c56348ba14b127bfa009925d/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/39c2db1744c62991c56348ba14b127bfa009925d/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/39c2db1744c62991c56348ba14b127bfa009925d/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/39c2db1744c62991c56348ba14b127bfa009925d/recipe_engine/util.py#135
