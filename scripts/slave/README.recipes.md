...
#### **class [ChromiumApi](/scripts/slave/recipe_modules/chromium/api.py#30)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1468)(self, step_name, gs_bucket, gs_acl=None, mode=None, build_name=None, \*\*kwargs):**

Returns a step invoking archive_build.py to archive a Chromium build.

&emsp; **@property**<br>&mdash; **def [build\_properties](/scripts/slave/recipe_modules/chromium/api.py#132)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [chromium\_layout](/scripts/slave/recipe_modules/chromium/api.py#59)(self):**
...
&mdash; **def [clean\_outdir](/scripts/slave/recipe_modules/chromium/api.py#1514)(self):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#947)(self):**

Add an explicit clobber step if requested.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [compile](/scripts/slave/recipe_modules/chromium/api.py#416)(self, targets=None, name=None, out_dir=None, target=None, use_goma_module=False, \*\*kwargs):**
...
&mdash; **def [delete\_old\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#900)(self):**

Remove the old "hermetic" toolchain cache.

This is to expose any lingering dependencies on the old cache.

&mdash; **def [ensure\_chromium\_layout](/scripts/slave/recipe_modules/chromium/api.py#41)(self):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#866)(self, client_type='release'):**

&mdash; **def [ensure\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#909)(self):**

&mdash; **def [ensure\_toolchains](/scripts/slave/recipe_modules/chromium/api.py#943)(self):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1511)(self, _):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [get\_clang\_version](/scripts/slave/recipe_modules/chromium/api.py#814)(self, \*\*kwargs):**

&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium/api.py#82)(self):**

&mdash; **def [get\_cros\_chrome\_sdk\_wrapper](/scripts/slave/recipe_modules/chromium/api.py#831)(self):**
...
&mdash; **def [get\_mac\_toolchain\_installer](/scripts/slave/recipe_modules/chromium/api.py#886)(self):**

&mdash; **def [get\_version](/scripts/slave/recipe_modules/chromium/api.py#141)(self):**
...
&mdash; **def [get\_version\_from\_file](/scripts/slave/recipe_modules/chromium/api.py#153)(self, version_file_path, step_name='get version'):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_analyze](/scripts/slave/recipe_modules/chromium/api.py#1178)(self, mastername, buildername, analyze_input, name=None, mb_path=None, mb_config_path=None, chromium_config=None, build_dir=None, phase=None, \*\*kwargs):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [mb\_failure\_handler](/scripts/slave/recipe_modules/chromium/api.py#1407)(self, name):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_gen](/scripts/slave/recipe_modules/chromium/api.py#1300)(self, mastername, buildername, name=None, mb_path=None, mb_config_path=None, use_goma=True, isolated_targets=None, build_dir=None, phase=None, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None, recursive_lookup=False, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_isolate\_everything](/scripts/slave/recipe_modules/chromium/api.py#1387)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_lookup](/scripts/slave/recipe_modules/chromium/api.py#1234)(self, mastername, buildername, name=None, mb_path=None, mb_config_path=None, recursive=False, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None):**
...
&emsp; **@property**<br>&mdash; **def [output\_dir](/scripts/slave/recipe_modules/chromium/api.py#136)(self):**

Return the path to the built executable directory.

&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1456)(self, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#999)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb\_cmd](/scripts/slave/recipe_modules/chromium/api.py#1076)(self, name, mb_command, mastername, buildername, mb_path=None, mb_config_path=None, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, additional_args=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#957)(self, env=None, \*\*kwargs):**

Run the build-configuration hooks for chromium.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runtest](/scripts/slave/recipe_modules/chromium/api.py#640)(self, test, args=None, xvfb=False, name=None, annotate=None, results_url=None, perf_dashboard_id=None, test_type=None, python_mode=False, point_id=None, revision=None, webkit_revision=None, test_launcher_summary_output=None, perf_id=None, perf_config=None, chartjson_file=False, use_histograms=False, tee_stdout_file=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [sizes](/scripts/slave/recipe_modules/chromium/api.py#764)(self, results_url=None, perf_id=None, platform=None, \*\*kwargs):**

Return a sizes.py invocation.
This uses runtests.py to upload the results to the perf dashboard.

&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1450)(self):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_launcher\_filter](/scripts/slave/recipe_modules/chromium/api.py#636)(self, tests):**
...
&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#591)(self, mastername, buildername, update_step, bot_db):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#832)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#714)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None, read_gn_args=True):**
...
&mdash; **def [generate\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#308)(self, \*args):**
...
&mdash; **def [integration\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1221)(self, builders=None, bots=None):**
...
&mdash; **def [package\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#514)(self, mastername, buildername, update_step, bot_db, reasons=None):**
...
&mdash; **def [run\_tests\_with\_and\_without\_changes](/scripts/slave/recipe_modules/chromium_tests/api.py#1231)(self, builders, mirrored_bots, deapply_changes):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1226)(self, builders=None, trybots=None):**

&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#106)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#773)(self, bot_config, tests=None):**
...
&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#871)(self):**

Absolute path to the build product based on the 'checkout' path.

&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1435)(self, requests, project=None, bucket=None, step_name='trigger'):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1539)(self, sequence, subsequence, value):**
...
&mdash; **def [collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#780)(self):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#706)(self, test_spec=v8_builders.EmptyTestSpec, mb_config_path=None, out_dir=None, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#965)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#971)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#978)(self):**
...
&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#859)(self, revision):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [ensure\_osx\_sdk\_if\_needed](/scripts/slave/recipe_modules/v8/api.py#645)(self):**
...
&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1237)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1146)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#876)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#961)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1515)(self, bisect_range):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1464)(self):**
...
&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#880)(self):**

Delete all gcov counter files.

&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#981)(self):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#827)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1561)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#1050)(self, test_results, test_spec):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#842)(self, update_step):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [maybe\_nest](/scripts/slave/recipe_modules/v8/api.py#986)(self, condition, parent_step_name):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1577)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1586)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1566)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#461)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#994)(self, tests):**
...
&emsp; **@property**<br>&mdash; **def [should\_collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#774)(self):**
...
&emsp; **@property**<br>&mdash; **def [target\_bits](/scripts/slave/recipe_modules/v8/api.py#636)(self):**

Returns target bits (as int) inferred from gn arguments from MB.

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1263)(self):**
...
&mdash; **def [ui\_test\_label](/scripts/slave/recipe_modules/v8/api.py#1177)(self, full_test_name):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#820)(self, name_suffix='', archive=None):**

&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#890)(self):**

Capture coverage data and upload a report.

&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#834)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1590)(blob):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/blink_downstream.py#224)(api):**
...
&mdash; **def [build](/scripts/slave/recipes/blink_downstream.py#94)(api, suffix):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/celab.py#57)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium/tests/compile.py#18)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_android/examples/full.py#97)(api, buildername):**
...
&mdash; **def [NotIdempotent](/scripts/slave/recipe_modules/chromium_tests/tests/api/main_waterfall_steps.py#221)(check, step_odict, step):**

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/api/main_waterfall_steps.py#225)(api, gn_args):**
...
&mdash; **def [BuildAndTest](/scripts/slave/recipes/dart/flutter_engine.py#297)(api, start_dir, checkout_dir, flutter_rev):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/dart/flutter_engine.py#276)(api):**
...
&mdash; **def [AddFiles](/scripts/slave/recipes/flutter/engine.py#124)(api, pkg, relative_paths):**

&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#210)(api):**

&mdash; **def [Build](/scripts/slave/recipes/flutter/engine.py#42)(api, config, \*targets):**

&mdash; **def [BuildFuchsia](/scripts/slave/recipes/flutter/engine.py#356)(api):**

&mdash; **def [BuildFuchsiaArtifactsAndUpload](/scripts/slave/recipes/flutter/engine.py#91)(api):**

&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#542)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#645)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#317)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#256)(api):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#398)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#672)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#580)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#688)(api):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#35)(api, path):**

&mdash; **def [GetMacSDKDir](/scripts/slave/recipes/flutter/engine.py#383)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallJazzy](/scripts/slave/recipes/flutter/engine.py#660)(api):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#201)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#470)(api, label, arm64_out, armv7_out, sim_out, bucket_name):**

&mdash; **def [RunGN](/scripts/slave/recipes/flutter/engine.py#109)(api, \*args):**

&mdash; **def [RunHostTests](/scripts/slave/recipes/flutter/engine.py#53)(api, out_dir, exe_extension=''):**

&mdash; **def [RunIOSTests](/scripts/slave/recipes/flutter/engine.py#536)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#710)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#386)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#366)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#129)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#160)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#186)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#168)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#143)(api, dir_label, parent_dir, folder_name, zip_name, platform=None):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#230)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [UploadWebSdk](/scripts/slave/recipes/flutter/engine.py#193)(api, archive_name):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#219)(api):**
...
&mdash; **def [ConfigureChromiumBuilder](/scripts/slave/recipes/swarming/deterministic_build.py#132)(api, recipe_config):**

&mdash; **def [MoveBuildDirectory](/scripts/slave/recipes/swarming/deterministic_build.py#120)(api, src_dir, dst_dir):**

&mdash; **def [RunSteps](/scripts/slave/recipes/swarming/deterministic_build.py#156)(api, buildername):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/node_integration_ng.py#67)(api, triggers, v8_tot):**

&mdash; **def [run\_with\_retry](/scripts/slave/recipes/v8/node_integration_ng.py#45)(api, step_name, step_fun):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/afe292c860102ab976e9664d7a90d633f7a4ca3a/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/218f005d8f06d6e223cecd87864545b51c544884/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/218f005d8f06d6e223cecd87864545b51c544884/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/218f005d8f06d6e223cecd87864545b51c544884/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/218f005d8f06d6e223cecd87864545b51c544884/recipe_engine/util.py#135
