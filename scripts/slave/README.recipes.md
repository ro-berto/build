...
&mdash; **def [run\_tests\_with\_and\_without\_changes](/scripts/slave/recipe_modules/chromium_tests/api.py#1235)(self, builders, mirrored_bots, deapply_changes):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/angle.py#107)(api, target_cpu, debug, clang):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/boringssl.py#237)(api):**
...
&mdash; **def [BuildAndTest](/scripts/slave/recipes/dart/flutter_engine.py#335)(api, start_dir, checkout_dir, flutter_rev):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/dart/flutter_engine.py#296)(api):**
...
&mdash; **def [AddFiles](/scripts/slave/recipes/flutter/engine.py#172)(api, pkg, relative_paths):**

&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#310)(api):**

&mdash; **def [Build](/scripts/slave/recipes/flutter/engine.py#61)(api, config, \*targets):**

&mdash; **def [BuildAndTestFuchsia](/scripts/slave/recipes/flutter/engine.py#129)(api, build_script, git_rev):**

&mdash; **def [BuildFuchsia](/scripts/slave/recipes/flutter/engine.py#625)(api):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#893)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#1026)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#496)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#357)(api, swarming_task_id):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#706)(api):**

&mdash; **def [BuildNoGoma](/scripts/slave/recipes/flutter/engine.py#73)(api, config, \*targets):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#1056)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#944)(api):**
...
&mdash; **def [DownloadFuchsiaSystemImage](/scripts/slave/recipes/flutter/engine.py#544)(api, target_dir, bucket_name, build_id, image_name):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#1073)(api):**

&mdash; **def [GetCheckoutPath](/scripts/slave/recipes/flutter/engine.py#48)(api):**

&mdash; **def [GetCloudMavenPath](/scripts/slave/recipes/flutter/engine.py#195)(api, artifact_filename, swarming_task_id):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#54)(api, path):**

&mdash; **def [GetFuchsiaBuildId](/scripts/slave/recipes/flutter/engine.py#535)(api):**

&mdash; **def [GetFuchsiaOutputDirs](/scripts/slave/recipes/flutter/engine.py#121)(product):**

&mdash; **def [GetFuchsiaOutputFiles](/scripts/slave/recipes/flutter/engine.py#108)(product):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallGems](/scripts/slave/recipes/flutter/engine.py#1041)(api):**

&mdash; **def [IsolateFuchsiaTestArtifacts](/scripts/slave/recipes/flutter/engine.py#551)(api, checkout, fuchsia_tools, image_name):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#301)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#810)(api, label, arm64_out, armv7_out, sim_out, bucket_name, strip_bitcode=False):**

&mdash; **def [RunGN](/scripts/slave/recipes/flutter/engine.py#146)(api, \*args):**

&mdash; **def [RunGNBitcode](/scripts/slave/recipes/flutter/engine.py#153)(api, \*args):**

&mdash; **def [RunIOSTests](/scripts/slave/recipes/flutter/engine.py#882)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#1094)(api, properties, env_properties):**
...
&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#699)(api):**

&mdash; **def [ShouldUploadPackages](/scripts/slave/recipes/flutter/engine.py#51)(api):**

&mdash; **def [TestFuchsia](/scripts/slave/recipes/flutter/engine.py#581)(api):**
...
&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#689)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#177)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#255)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#286)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#264)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#237)(api, dir_label, parent_dir, folder_name, zip_name, platform=None):**

&mdash; **def [UploadMavenArtifacts](/scripts/slave/recipes/flutter/engine.py#220)(api, artifacts, swarming_task_id):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#330)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [UploadWebSdk](/scripts/slave/recipes/flutter/engine.py#293)(api, archive_name):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#319)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/run_presubmit.py#248)(api):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/15676c0e3ba6f331f16438f79aed7aefb6453142/recipes/README.recipes.md#recipe_modules-windows_sdk
[recipe_engine/recipe_modules/assertions]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f84207a8e5eb80f11bb414e98b4177471d69419e/README.recipes.md#recipe_modules-assertions
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f84207a8e5eb80f11bb414e98b4177471d69419e/README.recipes.md#recipe_modules-generator_script
[recipe_engine/recipe_modules/isolated]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f84207a8e5eb80f11bb414e98b4177471d69419e/README.recipes.md#recipe_modules-isolated
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f84207a8e5eb80f11bb414e98b4177471d69419e/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f84207a8e5eb80f11bb414e98b4177471d69419e/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f84207a8e5eb80f11bb414e98b4177471d69419e/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f84207a8e5eb80f11bb414e98b4177471d69419e/README.recipes.md#recipe_modules-swarming
[recipe_engine/recipe_modules/time]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f84207a8e5eb80f11bb414e98b4177471d69419e/README.recipes.md#recipe_modules-time
[recipe_engine/recipe_modules/tricium]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f84207a8e5eb80f11bb414e98b4177471d69419e/README.recipes.md#recipe_modules-tricium
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f84207a8e5eb80f11bb414e98b4177471d69419e/recipe_engine/util.py#135
