...
&mdash; **def [shard\_merge](/scripts/slave/recipe_modules/clang_coverage/api.py#291)(self, step_name):**
...
#### **class [DartApi](/scripts/slave/recipe_modules/dart/api.py#34)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

Recipe module for code commonly used in dart recipes.

Shouldn't be used elsewhere.

&mdash; **def [build](/scripts/slave/recipe_modules/dart/api.py#103)(self, build_args=None, name='build dart'):**
...
&mdash; **def [checkout](/scripts/slave/recipe_modules/dart/api.py#38)(self, clobber=False, revision=None):**

Checks out the dart code and prepares it for building.

&mdash; **def [collect\_all](/scripts/slave/recipe_modules/dart/api.py#234)(self, tasks, commit, all_results):**

Collects the results of a sharded test run.

&mdash; **def [dart\_executable](/scripts/slave/recipe_modules/dart/api.py#96)(self):**

Returns the path to the checked-in SDK dart executable.

&mdash; **def [delete\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#534)(self):**

Deletes the debug log file

&mdash; **def [download\_parent\_isolate](/scripts/slave/recipe_modules/dart/api.py#154)(self):**

&mdash; **def [get\_latest\_tested\_commit](/scripts/slave/recipe_modules/dart/api.py#275)(self):**

&mdash; **def [get\_secret](/scripts/slave/recipe_modules/dart/api.py#67)(self, name):**

Decrypts the specified secret and returns the location of the result

&mdash; **def [kill\_tasks](/scripts/slave/recipe_modules/dart/api.py#88)(self, ok_ret='any'):**

Kills leftover tasks from previous runs or steps.

&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#522)(self):**

Reads the debug log file

&mdash; **def [run\_script](/scripts/slave/recipe_modules/dart/api.py#951)(self, step_name, script, args, isolate_hash, shards, local_shard, environment, tasks, cipd_packages=None, ignore_failure=False):**
...
&mdash; **def [run\_test\_py](/scripts/slave/recipe_modules/dart/api.py#865)(self, step_name, step, isolate_hash, shards, local_shard, environment, tasks, global_config, all_results):**
...
&mdash; **def [run\_trigger](/scripts/slave/recipe_modules/dart/api.py#829)(self, step_name, step, isolate_hash):**

&mdash; **def [shard](/scripts/slave/recipe_modules/dart/api.py#169)(self, title, isolate_hash, test_args, os=None, cpu='x86-64', pool='dart.tests', num_shards=0, last_shard_is_local=False, cipd_packages=None, ignore_failure=False):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#540)(self, latest, test_data):**
...
&mdash; **def [bootstrap\_swarming](/scripts/slave/recipe_modules/ios/api.py#592)(self):**

Bootstraps Swarming.

&emsp; **@property**<br>&mdash; **def [bucket](/scripts/slave/recipe_modules/ios/api.py#78)(self):**

&mdash; **def [build](/scripts/slave/recipe_modules/ios/api.py#365)(self, analyze=False, mb_path=None, suffix=None, use_mb=True):**
...
&mdash; **def [checkout](/scripts/slave/recipe_modules/ios/api.py#148)(self, gclient_apply_config=None, \*\*kwargs):**

Checks out Chromium.

&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#980)(self, tasks, upload_test_results=True):**

Collects the given Swarming task results.

&emsp; **@property**<br>&mdash; **def [configuration](/scripts/slave/recipe_modules/ios/api.py#83)(self):**

&mdash; **def [ensure\_xcode](/scripts/slave/recipe_modules/ios/api.py#337)(self, xcode_build_version):**

&mdash; **def [get\_mac\_toolchain\_cmd](/scripts/slave/recipe_modules/ios/api.py#331)(self):**

&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#1168)(self, path):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#601)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#773)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_earlgrey\_test](/scripts/slave/recipe_modules/ios/api.py#718)(self, test, shard_size, tmp_dir, isolate_template):**

Isolate earlgrey test into small shards

&mdash; **def [isolate\_test](/scripts/slave/recipe_modules/ios/api.py#622)(self, test, tmp_dir, isolate_template, test_cases=None, shard_num=None):**

Isolates a single test.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#1253)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#1240)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#1268)(self):**

Returns the path to the most recently compiled iossim.

&mdash; **def [parse\_tests](/scripts/slave/recipe_modules/ios/api.py#166)(self, tests, include_dir, start_index=0):**
...
&emsp; **@property**<br>&mdash; **def [platform](/scripts/slave/recipe_modules/ios/api.py#92)(self):**

&mdash; **def [read\_build\_config](/scripts/slave/recipe_modules/ios/api.py#227)(self, master_name=None, build_config_base_dir=None, buildername=None):**
...
&emsp; **@swarming_service_account.setter**<br>&mdash; **def [swarming\_service\_account](/scripts/slave/recipe_modules/ios/api.py#109)(self, val):**

&mdash; **def [symupload](/scripts/slave/recipe_modules/ios/api.py#516)(self, artifact, url):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#1217)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True):**

Runs tests on Swarming as instructed by this bot's build config.

&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#860)(self, tasks):**

Triggers the given Swarming tasks.

&mdash; **def [upload](/scripts/slave/recipe_modules/ios/api.py#562)(self, base_path=None):**

Uploads built artifacts as instructed by this bot's build config.

&mdash; **def [upload\_tgz](/scripts/slave/recipe_modules/ios/api.py#531)(self, artifact, bucket, path):**
...
&emsp; **@property**<br>&mdash; **def [use\_goma](/scripts/slave/recipe_modules/ios/api.py#113)(self):**

&emsp; **@property**<br>&mdash; **def [xcode\_build\_version](/scripts/slave/recipe_modules/ios/api.py#118)(self):**
...
#### **class [SwarmingApi](/scripts/slave/recipe_modules/swarming/api.py#132)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [add\_default\_tag](/scripts/slave/recipe_modules/swarming/api.py#390)(self, tag):**
...
&mdash; **def [collect\_task](/scripts/slave/recipe_modules/swarming/api.py#848)(self, task, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [default\_dimensions](/scripts/slave/recipe_modules/swarming/api.py#325)(self):**
...
&emsp; **@property**<br>&mdash; **def [default\_env](/scripts/slave/recipe_modules/swarming/api.py#348)(self):**
...
&emsp; **@default_expiration.setter**<br>&mdash; **def [default\_expiration](/scripts/slave/recipe_modules/swarming/api.py#248)(self, value):**

&emsp; **@default_hard_timeout.setter**<br>&mdash; **def [default\_hard\_timeout](/scripts/slave/recipe_modules/swarming/api.py#265)(self, value):**

&emsp; **@default_idempotent.setter**<br>&mdash; **def [default\_idempotent](/scripts/slave/recipe_modules/swarming/api.py#304)(self, value):**

&emsp; **@default_io_timeout.setter**<br>&mdash; **def [default\_io\_timeout](/scripts/slave/recipe_modules/swarming/api.py#284)(self, value):**

&emsp; **@default_priority.setter**<br>&mdash; **def [default\_priority](/scripts/slave/recipe_modules/swarming/api.py#375)(self, value):**

&emsp; **@default_user.setter**<br>&mdash; **def [default\_user](/scripts/slave/recipe_modules/swarming/api.py#320)(self, value):**

&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/swarming/api.py#1372)(self, task):**

SwarmingTask -> argument list for go swarming command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/swarming/api.py#1274)(self, prefix, task):**
...
&emsp; **@staticmethod**<br>&mdash; **def [prefered\_os\_dimension](/scripts/slave/recipe_modules/swarming/api.py#419)(platform):**
...
&mdash; **def [report\_stats](/scripts/slave/recipe_modules/swarming/api.py#876)(self):**

Report statistics on all tasks ran so far.

&emsp; **@service_account_json.setter**<br>&mdash; **def [service\_account\_json](/scripts/slave/recipe_modules/swarming/api.py#210)(self, value):**

Service account json to use for swarming.

&mdash; **def [set\_default\_dimension](/scripts/slave/recipe_modules/swarming/api.py#340)(self, key, value):**

&mdash; **def [set\_default\_env](/scripts/slave/recipe_modules/swarming/api.py#359)(self, key, value):**

&emsp; **@show_outputs_ref_in_collect_step.setter**<br>&mdash; **def [show\_outputs\_ref\_in\_collect\_step](/scripts/slave/recipe_modules/swarming/api.py#406)(self, value):**

&emsp; **@show_shards_in_collect_step.setter**<br>&mdash; **def [show\_shards\_in\_collect\_step](/scripts/slave/recipe_modules/swarming/api.py#415)(self, value):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [summary](/scripts/slave/recipe_modules/swarming/api.py#201)(self):**

&emsp; **@swarming_server.setter**<br>&mdash; **def [swarming\_server](/scripts/slave/recipe_modules/swarming/api.py#220)(self, value):**
...
&mdash; **def [wait\_for\_finished\_task\_set](/scripts/slave/recipe_modules/swarming/api.py#1173)(self, task_sets, suffix=None, attempts=0):**
...
#### **class [TestUtilsApi](/scripts/slave/recipe_modules/test_utils/api.py#29)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [create\_results\_from\_json](/scripts/slave/recipe_modules/test_utils/api.py#479)(self, data):**

&mdash; **def [create\_results\_from\_json\_if\_needed](/scripts/slave/recipe_modules/test_utils/api.py#482)(self, data):**

&emsp; **@staticmethod**<br>&mdash; **def [format\_step\_text](/scripts/slave/recipe_modules/test_utils/api.py#86)(data):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [gtest\_results](/scripts/slave/recipe_modules/test_utils/api.py#499)(self, add_json_log=True):**
...
&mdash; **def [limit\_failures](/scripts/slave/recipe_modules/test_utils/api.py#59)(self, failures, limit=None):**
...
&mdash; **def [present\_gtest\_failures](/scripts/slave/recipe_modules/test_utils/api.py#116)(self, step_result, presentation=None):**
...
&mdash; **def [run\_tests](/scripts/slave/recipe_modules/test_utils/api.py#166)(self, caller_api, tests, suffix, sort_by_shard=False):**
...
&mdash; **def [run\_tests\_with\_patch](/scripts/slave/recipe_modules/test_utils/api.py#222)(self, caller_api, tests):**
...
&mdash; **def [summarize\_failing\_test\_with\_no\_retries](/scripts/slave/recipe_modules/test_utils/api.py#406)(self, caller_api, test_suite):**

Summarizes a failing test suite that is not going to be retried.

&mdash; **def [summarize\_findit\_flakiness](/scripts/slave/recipe_modules/test_utils/api.py#424)(self, caller_api, test_suites):**
...
&mdash; **def [summarize\_test\_with\_patch\_deapplied](/scripts/slave/recipe_modules/test_utils/api.py#318)(self, caller_api, test_suite):**
...
&mdash; **def [summarize\_test\_with\_patch\_reapplied](/scripts/slave/recipe_modules/test_utils/api.py#362)(self, caller_api, test_suite):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_results](/scripts/slave/recipe_modules/test_utils/api.py#489)(self, add_json_log=True):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#475)(self):**

&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#857)(self):**

Absolute path to the build product based on the 'checkout' path.

&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1454)(self, bucket, changes, requests, step_name='trigger', service_account='v8-bot', add_buildset_tag=True):**
...
&emsp; **@property**<br>&mdash; **def [builderset](/scripts/slave/recipe_modules/v8/api.py#483)(self):**

Returns a list of names of this builder and all its triggered testers.

&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1597)(self, sequence, subsequence, value):**
...
&mdash; **def [collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#766)(self):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#692)(self, test_spec=v8_builders.EmptyTestSpec, mb_config_path=None, out_dir=None, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#951)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#957)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#964)(self):**

&mdash; **def [dedupe\_tests](/scripts/slave/recipe_modules/v8/api.py#525)(self, high_prec_tests, low_prec_tests):**

Dedupe tests with lower precedence.

&emsp; **@property**<br>&mdash; **def [depot\_tools\_path](/scripts/slave/recipe_modules/v8/api.py#793)(self):**

Returns path to depot_tools pinned in the V8 checkout.

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#845)(self, revision):**

&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1219)(self):**

&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#507)(self):**

Returns runnable testing.BaseTest objects for each extra test specified
by parent_test_spec property.

&mdash; **def [extra\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#516)(self, test_spec):**

Returns runnable testing.BaseTest objects for each extra test specified
in the test spec of the current builder.

&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1132)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#862)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#947)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1573)(self, bisect_range):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1516)(self):**

&mdash; **def [get\_changes](/scripts/slave/recipe_modules/v8/api.py#1448)(self):**
...
&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#866)(self):**

Delete all gcov counter files.

&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#967)(self):**

&mdash; **def [isolate\_targets\_from\_tests](/scripts/slave/recipe_modules/v8/api.py#565)(self, tests):**
...
&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#585)(self, isolate_targets, out_dir=None):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#813)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1619)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#1036)(self, test_results):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#828)(self, update_step):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [maybe\_nest](/scripts/slave/recipe_modules/v8/api.py#972)(self, condition, parent_step_name):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1323)(self, test_spec=v8_builders.EmptyTestSpec, \*\*additional_properties):**
...
&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#531)(self, root):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1635)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1644)(self, ref, step_name_desc):**

Read and return the version at a paricular ref.

&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#503)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1624)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#466)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#980)(self, tests):**
...
&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#491)(self):**

&emsp; **@property**<br>&mdash; **def [should\_collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#760)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#495)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#499)(self):**

&emsp; **@property**<br>&mdash; **def [target\_bits](/scripts/slave/recipe_modules/v8/api.py#634)(self):**

Returns target bits (as int) inferred from gn arguments from MB.

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1245)(self):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#806)(self, name_suffix='', archive=None):**

&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#876)(self):**

Capture coverage data and upload a report.

&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#820)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1648)(blob):**
...
#### **class [WebRTCApi](/scripts/slave/recipe_modules/webrtc/api.py#78)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [apply\_bot\_config](/scripts/slave/recipe_modules/webrtc/api.py#102)(self, builders, recipe_configs):**

&mdash; **def [apply\_ios\_config](/scripts/slave/recipe_modules/webrtc/api.py#137)(self):**

Generate a JSON config from bot config, apply it to ios recipe module.

&emsp; **@property**<br>&mdash; **def [bucketname](/scripts/slave/recipe_modules/webrtc/api.py#201)(self):**

&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#464)(self):**

&emsp; **@property**<br>&mdash; **def [build\_url](/scripts/slave/recipe_modules/webrtc/api.py#209)(self):**

&emsp; **@property**<br>&mdash; **def [buildername](/scripts/slave/recipe_modules/webrtc/api.py#205)(self):**

&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#356)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#296)(self, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/webrtc/api.py#398)(self, phase=None):**

&mdash; **def [configure\_isolate](/scripts/slave/recipe_modules/webrtc/api.py#247)(self, phase=None):**

&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/webrtc/api.py#261)(self):**

&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#328)(self):**

&mdash; **def [download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#336)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [ensure\_sdk](/scripts/slave/recipe_modules/webrtc/api.py#360)(self):**

&mdash; **def [get\_binary\_sizes](/scripts/slave/recipe_modules/webrtc/api.py#409)(self, files=None, base_dir=None):**

&mdash; **def [get\_bot](/scripts/slave/recipe_modules/webrtc/api.py#217)(self, bucketname, buildername):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/webrtc/api.py#405)(self):**

&emsp; **@property**<br>&mdash; **def [master\_config](/scripts/slave/recipe_modules/webrtc/api.py#220)(self):**

&emsp; **@property**<br>&mdash; **def [mastername](/scripts/slave/recipe_modules/webrtc/api.py#224)(self):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#448)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#505)(self):**

&mdash; **def [related\_bots](/scripts/slave/recipe_modules/webrtc/api.py#228)(self):**

&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#365)(self, phase=None):**

&mdash; **def [run\_mb\_ios](/scripts/slave/recipe_modules/webrtc/api.py#383)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#425)(self, phase=None):**
...
&emsp; **@property**<br>&mdash; **def [should\_download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#233)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#240)(self):**

&mdash; **def [upload\_to\_perf\_dashboard](/scripts/slave/recipe_modules/webrtc/api.py#521)(self, name, step_result):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/art.py#648)(api):**
...
&mdash; **def [setup\_aosp\_builder](/scripts/slave/recipes/art.py#470)(api, read_barrier):**
...
&mdash; **def [setup\_target](/scripts/slave/recipes/art.py#230)(api, serial, device, debug, concurrent_collector=True, generational_cc=True, heap_poisoning=False, gcstress=False):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/binary_size_trybot.py#65)(api, analyze_targets, compile_targets):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/celab.py#42)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_codesearch.py#149)(api, root_solution_revision, root_solution_revision_timestamp):**
...
[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/api/trybot_steps_with_specific_tests.py#9): [chromium\_tests](#recipe_modules-chromium_tests), [swarming](#recipe_modules-swarming), [test\_utils](#recipe_modules-test_utils), [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_trybot.py#39)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/dart/examples/example.py#166)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/dart/examples/example-checkout.py#14)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/findit/chromium/compile_isolate.py#63)(api, target_mastername, target_testername, revision, isolated_targets):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/findit/chromium/flake.py#74)(api, target_mastername, target_testername, test_revision, tests, buildbucket, test_repeat_count, skip_tests):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/findit/chromium/test.py#121)(api, target_mastername, target_testername, good_revision, bad_revision, tests, buildbucket, use_analyze, suspected_revisions, test_on_good_revision, test_repeat_count):**
...
&mdash; **def [AddFiles](/scripts/slave/recipes/flutter/engine.py#90)(api, pkg, relative_paths):**

&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#157)(api):**

&mdash; **def [Build](/scripts/slave/recipes/flutter/engine.py#39)(api, config, \*targets, \*\*kwargs):**

&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#512)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#624)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#282)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#203)(api):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#361)(api):**
...
&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#542)(api):**
...
&emsp; **@contextmanager**<br>&mdash; **def [InstallJazzy](/scripts/slave/recipes/flutter/engine.py#639)(api):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#148)(api, label):**
...
&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/engine.py#336)(api, ios_tools_path, target_version):**

Locates and switches to a version of Xcode matching target_version.

&mdash; **def [RunGN](/scripts/slave/recipes/flutter/engine.py#75)(api, \*args):**
...
&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#348)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#318)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#98)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#125)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#140)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#133)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#112)(api, dir_label, parent_dir, folder_name, zip_name):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#177)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#166)(api):**
...
&mdash; **def [CreateAndUploadFlutterPackage](/scripts/slave/recipes/flutter/flutter.py#275)(api, git_hash, branch):**

Prepares, builds, and uploads an all-inclusive archive package.

&mdash; **def [DecryptKMS](/scripts/slave/recipes/flutter/flutter.py#91)(api, step_name, crypto_key_path, ciphertext_file, plaintext_file):**

&mdash; **def [EnsureCloudKMS](/scripts/slave/recipes/flutter/flutter.py#81)(api, version=None):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/flutter.py#111)(api, git_hash, path):**

&mdash; **def [GetGradleDirName](/scripts/slave/recipes/flutter/flutter.py#214)(api):**

&mdash; **def [GetGradleDistributionUrl](/scripts/slave/recipes/flutter/flutter.py#204)(api):**

&mdash; **def [GetGradleZipFileName](/scripts/slave/recipes/flutter/flutter.py#210)(api):**
...
&mdash; **def [InstallGradle](/scripts/slave/recipes/flutter/flutter.py#217)(api, checkout):**

&mdash; **def [InstallOpenJDK](/scripts/slave/recipes/flutter/flutter.py#57)(api):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/flutter.py#174)(api, ios_tools_path, target_version):**

Locates and switches to a version of Xcode matching target_version.

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/flutter.py#308)(api):**

&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/flutter.py#188)(api):**

&mdash; **def [UploadFlutterCoverage](/scripts/slave/recipes/flutter/flutter.py#236)(api):**
...
[DEPS](/scripts/slave/recipe_modules/ios/examples/full.py#7): [ios](#recipe_modules-ios), [swarming](#recipe_modules-swarming), [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/ios/examples/full.py#18)(api):**
...
[DEPS](/scripts/slave/recipes/openscreen.py#7): [goma](#recipe_modules-goma), [depot\_tools/depot\_tools][depot_tools/recipe_modules/depot_tools], [depot\_tools/git][depot_tools/recipe_modules/git], [depot\_tools/osx\_sdk][depot_tools/recipe_modules/osx_sdk], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [RunSteps](/scripts/slave/recipes/pdfium.py#289)(api, memory_tool, skia, skia_paths, xfa, v8, target_cpu, clang, msvc, rel, jumbo, skip_test, target_os):**

&mdash; **def [dict\_to\_str](/scripts/slave/recipes/pdfium.py#339)(props):**

Returns the given dictionary as a string of space
separated key/value pairs sorted by keys.

&mdash; **def [get\_gold\_ignore\_hashes](/scripts/slave/recipes/pdfium.py#376)(api, out_dir):**
...
&mdash; **def [get\_gold\_params](/scripts/slave/recipes/pdfium.py#308)(api, build_config, revision):**
...
&mdash; **def [gold\_build\_config](/scripts/slave/recipes/pdfium.py#349)(args):**
...
&mdash; **def [gs\_cp](/scripts/slave/recipes/pdfium.py#480)(api, name, src, dst, multithreaded=False, extra_args=None):**

Copy the src to dst in Google storage.

&mdash; **def [upload\_dm\_results](/scripts/slave/recipes/pdfium.py#432)(api, results_dir, revision, test_type):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/run_presubmit.py#116)(api):**
...
&mdash; **def [ConfigureChromiumBuilder](/scripts/slave/recipes/swarming/deterministic_build.py#122)(api, recipe_config):**

&mdash; **def [MoveBuildDirectory](/scripts/slave/recipes/swarming/deterministic_build.py#110)(api, src_dir, dst_dir):**

&mdash; **def [RunSteps](/scripts/slave/recipes/swarming/deterministic_build.py#146)(api, buildername):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/swarming/examples/full.py#40)(api, platforms, custom_trigger_script, show_outputs_ref_in_collect_step, show_shards_in_collect_step, gtest_task, isolated_script_task, merge, trigger_script, named_caches, service_account, wait_for_tasks):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/archive.py#142)(api, build_config, target_arch, target_bits, target_platform):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/flako.py#532)(api, bisect_mastername, bisect_buildername, build_config, extra_args, initial_commit_offset, max_calibration_attempts, isolated_name, num_shards, repetitions, repro_only, swarming_dimensions, swarming_priority, test_name, timeout_sec, total_timeout_sec, to_revision, variant):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/webrtc/ios.py#246)(api):**
...
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/06d1040fab75709fd0cbea3d3cbfa8774cb826f0/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/06d1040fab75709fd0cbea3d3cbfa8774cb826f0/recipes/README.recipes.md#recipe_modules-depot_tools
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/06d1040fab75709fd0cbea3d3cbfa8774cb826f0/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/06d1040fab75709fd0cbea3d3cbfa8774cb826f0/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/06d1040fab75709fd0cbea3d3cbfa8774cb826f0/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/06d1040fab75709fd0cbea3d3cbfa8774cb826f0/recipes/README.recipes.md#recipe_modules-gsutil
...
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/06d1040fab75709fd0cbea3d3cbfa8774cb826f0/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/06d1040fab75709fd0cbea3d3cbfa8774cb826f0/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/06d1040fab75709fd0cbea3d3cbfa8774cb826f0/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/06d1040fab75709fd0cbea3d3cbfa8774cb826f0/recipes/README.recipes.md#recipe_modules-windows_sdk
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3fd6d5382c9a43f9bcd7ed8cf855b0f60889cc0e/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3fd6d5382c9a43f9bcd7ed8cf855b0f60889cc0e/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3fd6d5382c9a43f9bcd7ed8cf855b0f60889cc0e/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3fd6d5382c9a43f9bcd7ed8cf855b0f60889cc0e/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3fd6d5382c9a43f9bcd7ed8cf855b0f60889cc0e/README.recipes.md#recipe_modules-swarming
[recipe_engine/recipe_modules/tempfile]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3fd6d5382c9a43f9bcd7ed8cf855b0f60889cc0e/README.recipes.md#recipe_modules-tempfile
[recipe_engine/recipe_modules/time]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3fd6d5382c9a43f9bcd7ed8cf855b0f60889cc0e/README.recipes.md#recipe_modules-time
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3fd6d5382c9a43f9bcd7ed8cf855b0f60889cc0e/recipe_engine/util.py#132
