...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [compile](/scripts/slave/recipe_modules/chromium/api.py#358)(self, targets=None, name=None, out_dir=None, target=None, use_goma_module=False, \*\*kwargs):**
...
&mdash; **def [delete\_old\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#804)(self):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#770)(self, client_type='release'):**

&mdash; **def [ensure\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#813)(self):**
...
&mdash; **def [get\_cros\_chrome\_sdk\_wrapper](/scripts/slave/recipe_modules/chromium/api.py#741)(self):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb](/scripts/slave/recipe_modules/chromium/api.py#1042)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, isolated_targets=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, gn_args_location=None, gn_args_max_text_lines=None, mb_command='gen', \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb\_cmd](/scripts/slave/recipe_modules/chromium/api.py#975)(self, name, mb_command, mastername, buildername, additional_args=None, env=None, mb_path=None, mb_config_path=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [sizes](/scripts/slave/recipe_modules/chromium/api.py#684)(self, results_url=None, perf_id=None, platform=None, \*\*kwargs):**
...
&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#316)(self, bot_config, update_step, bot_db, compile_targets, tests_including_triggered, mb_mastername=None, mb_buildername=None, mb_config_path=None, override_bot_type=None):**
...
&mdash; **def [create\_test\_runner](/scripts/slave/recipe_modules/chromium_tests/api.py#264)(self, tests, suffix='', serialize_tests=False):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#736)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#615)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None):**

&mdash; **def [generate\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#238)(self, test_spec, builder_dict, buildername, mastername, swarming_dimensions, scripts_compile_targets, generators, bot_update_step, bot_config):**

&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#958)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#309)(self, bot_config, bot_db, tests):**
...
&mdash; **def [get\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#300)(self, bot_config, bot_db):**
...
&mdash; **def [prepare\_checkout](/scripts/slave/recipe_modules/chromium_tests/api.py#216)(self, bot_config, root_solution_revision=None, disable_syntax_validation=False):**
...
&mdash; **def [collect\_task](/scripts/slave/recipe_modules/swarming/api.py#832)(self, task, \*\*kwargs):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/swarming/api.py#1299)(self, task):**

SwarmingTask -> argument list for 'swarming.py' command.

&mdash; **def [get\_states](/scripts/slave/recipe_modules/swarming/api.py#1148)(self, task_ids, suffix=None):**

Returns the states of a list of tasks.

Uses the 'get_states' endpoint on the server.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/swarming/api.py#1223)(self, prefix, task):**
...
&mdash; **def [report\_stats](/scripts/slave/recipe_modules/swarming/api.py#860)(self):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#432)(self):**
...
&emsp; **@property**<br>&mdash; **def [builderset](/scripts/slave/recipe_modules/v8/api.py#440)(self):**
...
&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#687)(self, test_spec=EmptyTestSpec, mb_config_path=None, out_dir=None, \*\*kwargs):**
...
&mdash; **def [dedupe\_tests](/scripts/slave/recipe_modules/v8/api.py#487)(self, high_prec_tests, low_prec_tests):**
...
&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1202)(self):**

&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#469)(self):**

Returns runnable testing.BaseTest objects for each extra test specified
by parent_test_spec property.

&mdash; **def [extra\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#478)(self, test_spec):**
...
&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1558)(self, bisect_range, use_swarming=False):**
...
&emsp; **@property**<br>&mdash; **def [isolate\_targets](/scripts/slave/recipe_modules/v8/api.py#547)(self):**

Returns the isolate targets statically known from builders.py.

&mdash; **def [isolate\_targets\_from\_tests](/scripts/slave/recipe_modules/v8/api.py#527)(self, tests):**
...
&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#570)(self, isolate_targets, out_dir=None):**
...
&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1306)(self, test_spec=EmptyTestSpec, \*\*additional_properties):**
...
&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#493)(self, root):**
...
&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#465)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1609)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#423)(self, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#448)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/v8/api.py#461)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#452)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#456)(self):**

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1228)(self):**
...
&mdash; **def [BuildLinux](/scripts/slave/recipes/dart/flutter_engine.py#55)(api, checkout_dir):**

&mdash; **def [BuildLinuxAndroidArm](/scripts/slave/recipes/dart/flutter_engine.py#43)(api, checkout_dir):**

&mdash; **def [BuildLinuxAndroidx86](/scripts/slave/recipes/dart/flutter_engine.py#38)(api, checkout_dir):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/dart/flutter_engine.py#70)(api):**

&mdash; **def [RunGN](/scripts/slave/recipes/dart/flutter_engine.py#27)(api, checkout_dir, \*args):**

&mdash; **def [RunSteps](/scripts/slave/recipes/dart/flutter_engine.py#119)(api):**

&mdash; **def [TestFlutter](/scripts/slave/recipes/dart/flutter_engine.py#97)(api, start_dir, just_built_dart_sdk):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/dart/flutter_engine.py#61)(api, checkout_dir):**
...
[DEPS](/scripts/slave/recipes/findit/chromium/compile_isolate.py#21): [chromium](#recipe_modules-chromium), [chromium\_android](#recipe_modules-chromium_android), [chromium\_checkout](#recipe_modules-chromium_checkout), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [findit](#recipe_modules-findit), [isolate](#recipe_modules-isolate), [swarming](#recipe_modules-swarming), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [RunSteps](/scripts/slave/recipes/findit/chromium/compile_isolate.py#58)(api, target_mastername, target_testername, revision, isolated_targets):**
...
&mdash; **def [AddFiles](/scripts/slave/recipes/flutter/engine.py#76)(api, pkg, relative_paths):**

&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#140)(api):**

&mdash; **def [Build](/scripts/slave/recipes/flutter/engine.py#35)(api, config, \*targets, \*\*kwargs):**

&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#432)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#512)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#242)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#165)(api):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#304)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#528)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#460)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#544)(api):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#28)(api, path):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#131)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#360)(api, label, arm64_out, armv7_out, sim_out, bucket_name):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/engine.py#283)(api, ios_tools_path, target_version):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#559)(api):**

&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#296)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#265)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#81)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#108)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#123)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#116)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#95)(api, dir_label, parent_dir, folder_name, zip_name):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#149)(api, upload_dir, lib_flutter_path):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/swarming/examples/full.py#38)(api, platforms, show_isolated_out_in_collect_step, show_shards_in_collect_step, gtest_task, isolated_script_task, merge, trigger_script, named_caches, service_account, get_states):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/flako.py#403)(api, bisect_mastername, bisect_buildername, build_config, extra_args, initial_commit_offset, isolated_name, repetitions, swarming_dimensions, test_name, timeout_sec, total_timeout_sec, to_revision, variant):**

&mdash; **def [bisect](/scripts/slave/recipes/v8/flako.py#304)(api, depot, initial_commit_offset, is_bad_func, offset):**
...
&mdash; **def [setup\_swarming](/scripts/slave/recipes/v8/flako.py#387)(api, swarming_dimensions):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7b54572eb0c18346d82a76e85b854c3ec316a3bd/recipes/README.recipes.md#recipe_modules-windows_sdk
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f7a834467c55fc302e5da1bdc0ef78c7bdecf2d9/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f7a834467c55fc302e5da1bdc0ef78c7bdecf2d9/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f7a834467c55fc302e5da1bdc0ef78c7bdecf2d9/README.recipes.md#recipe_modules-scheduler
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/f7a834467c55fc302e5da1bdc0ef78c7bdecf2d9/recipe_engine/util.py#132
