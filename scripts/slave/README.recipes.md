...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1340)(self, step_name, gs_bucket, gs_acl=None, mode=None, build_name=None, \*\*kwargs):**

Returns a step invoking archive_build.py to archive a Chromium build.

&emsp; **@property**<br>&mdash; **def [build\_properties](/scripts/slave/recipe_modules/chromium/api.py#131)(self):**
...
&mdash; **def [clean\_outdir](/scripts/slave/recipe_modules/chromium/api.py#1386)(self):**
...
&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1383)(self, _):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [get\_clang\_version](/scripts/slave/recipe_modules/chromium/api.py#750)(self, \*\*kwargs):**

&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium/api.py#81)(self):**

&mdash; **def [get\_cros\_chrome\_sdk\_wrapper](/scripts/slave/recipe_modules/chromium/api.py#767)(self):**
...
&mdash; **def [get\_version](/scripts/slave/recipe_modules/chromium/api.py#140)(self):**
...
&mdash; **def [get\_version\_from\_file](/scripts/slave/recipe_modules/chromium/api.py#152)(self, version_file_path, step_name='get version'):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_isolate\_everything](/scripts/slave/recipe_modules/chromium/api.py#1302)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [output\_dir](/scripts/slave/recipe_modules/chromium/api.py#135)(self):**

Return the path to the built executable directory.

&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1328)(self, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [sizes](/scripts/slave/recipe_modules/chromium/api.py#700)(self, results_url=None, perf_id=None, platform=None, \*\*kwargs):**

Return a sizes.py invocation.
This uses runtests.py to upload the results to the perf dashboard.

&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1322)(self):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_launcher\_filter](/scripts/slave/recipe_modules/chromium/api.py#572)(self, tests):**
...
&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/chromium_swarming/api.py#1639)(self, project_name, precommit, mastername=None, default_priority=None, path_to_testing_dir=None):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/chromium_swarming/api.py#1590)(self, task):**

SwarmingTask -> argument list for go swarming command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/chromium_swarming/api.py#1431)(self, prefix, task):**
...
&mdash; **def [wait\_for\_finished\_task\_set](/scripts/slave/recipe_modules/chromium_swarming/api.py#1340)(self, task_sets, suffix=None, attempts=0):**
...
&emsp; **@property**<br>&mdash; **def [all\_generators](/scripts/slave/recipe_modules/chromium_tests/api.py#64)(self):**

&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#557)(self, mastername, buildername, update_step, bot_db):**
...
&emsp; **@property**<br>&mdash; **def [builders](/scripts/slave/recipe_modules/chromium_tests/api.py#43)(self):**

&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#388)(self, bot_config, update_step, bot_db, compile_targets, tests_including_triggered, mb_mastername=None, mb_buildername=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=False, override_bot_type=None):**
...
&mdash; **def [create\_bot\_db\_from\_master\_dict](/scripts/slave/recipe_modules/chromium_tests/api.py#243)(self, mastername, master_dict):**
...
&mdash; **def [create\_test\_runner](/scripts/slave/recipe_modules/chromium_tests/api.py#298)(self, tests, suffix='', serialize_tests=False):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#798)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#680)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None, read_gn_args=True):**

&mdash; **def [generate\_tests\_from\_source\_side\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#267)(self, source_side_spec, builder_dict, buildername, mastername, swarming_dimensions, scripts_compile_targets, bot_update_step):**

&mdash; **def [generate\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#283)(self, \*args):**

&mdash; **def [get\_android\_version\_details](/scripts/slave/recipe_modules/chromium_tests/api.py#358)(self, bot_config, log_details=False):**

&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#949)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#343)(self, bot_config, bot_db, tests):**
...
&mdash; **def [get\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#334)(self, bot_config, bot_db):**
...
&mdash; **def [package\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#480)(self, mastername, buildername, update_step, bot_db, reasons=None):**
...
&mdash; **def [prepare\_checkout](/scripts/slave/recipe_modules/chromium_tests/api.py#248)(self, bot_config, \*\*kwargs):**

&mdash; **def [read\_source\_side\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#286)(self, source_side_spec_file):**

&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#656)(self, compile_targets, isolated_targets, name_suffix, mb_mastername=None, mb_buildername=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=False, android_version_code=None, android_version_name=None):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium_tests/api.py#229)(self, update_step):**
...
&emsp; **@property**<br>&mdash; **def [steps](/scripts/slave/recipe_modules/chromium_tests/api.py#47)(self):**

The steps module, which contains various Test python classes.

Usage is generally discouraged.

&emsp; **@property**<br>&mdash; **def [swarming\_extra\_args](/scripts/slave/recipe_modules/chromium_tests/api.py#78)(self):**

&mdash; **def [trigger\_child\_builds](/scripts/slave/recipe_modules/chromium_tests/api.py#588)(self, mastername, buildername, update_step, bot_db, additional_properties=None):**

&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1160)(self, builders=None, trybots=None):**

&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#74)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#739)(self, bot_config, tests=None):**
...
&emsp; **@property**<br>&mdash; **def [generate\_individual\_metadata](/scripts/slave/recipe_modules/clang_coverage/api.py#120)(self):**

True if we should generate per-target metadata for this build.

&mdash; **def [instrument](/scripts/slave/recipe_modules/clang_coverage/api.py#238)(self, affected_files):**
...
&mdash; **def [process\_coverage\_data](/scripts/slave/recipe_modules/clang_coverage/api.py#265)(self, tests):**
...
&mdash; **def [profdata\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#132)(self, step_name=None):**
...
&mdash; **def [shard\_merge](/scripts/slave/recipe_modules/clang_coverage/api.py#448)(self, step_name, additional_merge=None):**
...
&emsp; **@property**<br>&mdash; **def [using\_coverage](/scripts/slave/recipe_modules/clang_coverage/api.py#156)(self):**
...
&mdash; **def [build](/scripts/slave/recipe_modules/cronet/api.py#58)(self, mastername=None, buildername=None, targets=None, use_goma=True):**

&mdash; **def [get\_bucket](/scripts/slave/recipe_modules/cronet/api.py#90)(self, platform):**

&mdash; **def [get\_version](/scripts/slave/recipe_modules/cronet/api.py#84)(self):**

&mdash; **def [init\_and\_sync](/scripts/slave/recipe_modules/cronet/api.py#39)(self, recipe_config, kwargs, chromium_apply_config=None):**

&mdash; **def [run\_perf\_tests](/scripts/slave/recipe_modules/cronet/api.py#152)(self, perf_id):**

&mdash; **def [run\_tests](/scripts/slave/recipe_modules/cronet/api.py#131)(self, unit_tests=None, instrumentation_tests=INSTRUMENTATION_TESTS):**

&mdash; **def [sizes](/scripts/slave/recipe_modules/cronet/api.py#116)(self, perf_id):**

&mdash; **def [upload\_package](/scripts/slave/recipe_modules/cronet/api.py#96)(self, build_config, cronetdir=None, platform='android'):**
...
&mdash; **def [collect\_all](/scripts/slave/recipe_modules/dart/api.py#229)(self, steps):**
...
&mdash; **def [delete\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#611)(self):**
...
&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#599)(self):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#617)(self, test_data):**
...
&mdash; **def [bootstrap\_swarming](/scripts/slave/recipe_modules/ios/api.py#552)(self):**

Bootstraps Swarming.

&emsp; **@property**<br>&mdash; **def [bucket](/scripts/slave/recipe_modules/ios/api.py#39)(self):**

&mdash; **def [build](/scripts/slave/recipe_modules/ios/api.py#326)(self, analyze=False, mb_path=None, suffix=None, use_mb=True):**
...
&mdash; **def [get\_mac\_toolchain\_cmd](/scripts/slave/recipe_modules/ios/api.py#291)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#561)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#757)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_earlgrey\_test](/scripts/slave/recipe_modules/ios/api.py#700)(self, test, shard_size, tmp_dir, isolate_template, bot=None):**

Isolate earlgrey test into small shards

&mdash; **def [isolate\_test](/scripts/slave/recipe_modules/ios/api.py#582)(self, test, tmp_dir, isolate_template, test_cases=None, shard_num=None):**
...
&mdash; **def [symupload](/scripts/slave/recipe_modules/ios/api.py#476)(self, artifact, url):**
...
&mdash; **def [upload](/scripts/slave/recipe_modules/ios/api.py#522)(self, base_path=None):**

Uploads built artifacts as instructed by this bot's build config.

&mdash; **def [upload\_tgz](/scripts/slave/recipe_modules/ios/api.py#491)(self, artifact, bucket, path):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#469)(self):**
...
&emsp; **@property**<br>&mdash; **def [builderset](/scripts/slave/recipe_modules/v8/api.py#477)(self):**

Returns a list of names of this builder and all its triggered testers.

&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1520)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#410)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#365)(self, revision=None, \*\*kwargs):**

&mdash; **def [collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#761)(self):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#687)(self, test_spec=v8_builders.EmptyTestSpec, mb_config_path=None, out_dir=None, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#946)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#952)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#959)(self):**

&mdash; **def [dedupe\_tests](/scripts/slave/recipe_modules/v8/api.py#519)(self, high_prec_tests, low_prec_tests):**

Dedupe tests with lower precedence.

&emsp; **@property**<br>&mdash; **def [depot\_tools\_path](/scripts/slave/recipe_modules/v8/api.py#788)(self):**
...
&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#501)(self):**

Returns runnable testing.BaseTest objects for each extra test specified
by parent_test_spec property.

&mdash; **def [extra\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#510)(self, test_spec):**

Returns runnable testing.BaseTest objects for each extra test specified
in the test spec of the current builder.

&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1127)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#857)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#942)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1496)(self, bisect_range):**
...
&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#962)(self):**

&mdash; **def [isolate\_targets\_from\_tests](/scripts/slave/recipe_modules/v8/api.py#559)(self, tests):**
...
&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#579)(self, isolate_targets, out_dir=None):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#808)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1542)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#1031)(self, test_results):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#823)(self, update_step):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [maybe\_nest](/scripts/slave/recipe_modules/v8/api.py#967)(self, condition, parent_step_name):**
...
&mdash; **def [parse\_revision\_props](/scripts/slave/recipe_modules/v8/api.py#387)(self, got_revision, got_revision_cp=None):**
...
&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#525)(self, root):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1558)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1567)(self, ref, step_name_desc):**

Read and return the version at a paricular ref.

&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#497)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1547)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#460)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#975)(self, tests):**

&mdash; **def [set\_chromium\_configs](/scripts/slave/recipe_modules/v8/api.py#339)(self, clobber, default_targets):**

&mdash; **def [set\_gclient\_custom\_deps](/scripts/slave/recipe_modules/v8/api.py#334)(self, custom_deps):**

Configures additional gclient custom_deps to be synced.

&mdash; **def [set\_gclient\_custom\_var](/scripts/slave/recipe_modules/v8/api.py#325)(self, var_name):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#426)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#485)(self):**

&emsp; **@property**<br>&mdash; **def [should\_collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#755)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#489)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#493)(self):**

&emsp; **@property**<br>&mdash; **def [target\_bits](/scripts/slave/recipe_modules/v8/api.py#629)(self):**
...
&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#345)(self):**
...
&mdash; **def [ui\_test\_label](/scripts/slave/recipe_modules/v8/api.py#1158)(self, full_test_name):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#801)(self, name_suffix='', archive=None):**
...
&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#815)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1571)(blob):**
...
&mdash; **def [setup\_aosp\_builder](/scripts/slave/recipes/art.py#484)(api, read_barrier):**
...
&mdash; **def [setup\_target](/scripts/slave/recipes/art.py#232)(api, device, debug, concurrent_collector=True, generational_cc=True, heap_poisoning=False, gcstress=False):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/celab.py#54)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_clang_coverage_tot.py#55)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_codesearch.py#148)(api, root_solution_revision, root_solution_revision_timestamp):**
...
[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/steps/swarming_gtest_test.py#5): [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [clang\_coverage](#recipe_modules-clang_coverage), [isolate](#recipe_modules-isolate), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [BuildAndTest](/scripts/slave/recipes/dart/flutter_engine.py#285)(api, start_dir, checkout_dir, flutter_rev):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/dart/flutter_engine.py#264)(api):**

&mdash; **def [TestEngine](/scripts/slave/recipes/dart/flutter_engine.py#63)(api, checkout_dir):**

&mdash; **def [TestFlutter](/scripts/slave/recipes/dart/flutter_engine.py#233)(api, start_dir, just_built_dart_sdk):**
...
[DEPS](/scripts/slave/recipes/findit/chromium/compile_isolate.py#19): [chromium](#recipe_modules-chromium), [chromium\_android](#recipe_modules-chromium_android), [chromium\_checkout](#recipe_modules-chromium_checkout), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [findit](#recipe_modules-findit), [isolate](#recipe_modules-isolate), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/git][depot_tools/recipe_modules/git], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [RunSteps](/scripts/slave/recipes/findit/chromium/compile_isolate.py#60)(api, target_mastername, target_testername, revision, isolated_targets):**
...
[DEPS](/scripts/slave/recipes/findit/chromium/flake.py#12): [adb](#recipe_modules-adb), [chromium](#recipe_modules-chromium), [chromium\_android](#recipe_modules-chromium_android), [chromium\_checkout](#recipe_modules-chromium_checkout), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [filter](#recipe_modules-filter), [findit](#recipe_modules-findit), [isolate](#recipe_modules-isolate), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/git][depot_tools/recipe_modules/git], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipes/findit/chromium/flake.py#67)(api, target_mastername, target_testername, test_revision, tests, test_repeat_count, skip_tests):**
...
[DEPS](/scripts/slave/recipes/swarming/staging.py#17): [chromium](#recipe_modules-chromium), [chromium\_checkout](#recipe_modules-chromium_checkout), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [isolate](#recipe_modules-isolate), [swarming\_client](#recipe_modules-swarming_client), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/archive.py#174)(api, build_config, target_arch, target_bits, target_platform):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/flako.py#535)(api, bisect_mastername, bisect_buildername, build_config, extra_args, initial_commit_offset, max_calibration_attempts, isolated_name, num_shards, repetitions, repro_only, swarming_dimensions, swarming_priority, swarming_expiration, test_name, timeout_sec, total_timeout_sec, to_revision, variant):**

&mdash; **def [bisect](/scripts/slave/recipes/v8/flako.py#433)(api, depot, initial_commit_offset, is_bad_func, offset):**
...
&mdash; **def [setup\_swarming](/scripts/slave/recipes/v8/flako.py#516)(api, swarming_dimensions, swarming_priority, swarming_expiration):**
...
[DEPS](/scripts/slave/recipes/webrtc/ios.py#10): [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [ios](#recipe_modules-ios), [webrtc](#recipe_modules-webrtc), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipes/webrtc/ios.py#431)(api):**
...
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/caa04a27513e729e26f3a76d0267ea52a6fa43c1/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/caa04a27513e729e26f3a76d0267ea52a6fa43c1/recipes/README.recipes.md#recipe_modules-depot_tools
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/caa04a27513e729e26f3a76d0267ea52a6fa43c1/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/caa04a27513e729e26f3a76d0267ea52a6fa43c1/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/caa04a27513e729e26f3a76d0267ea52a6fa43c1/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/caa04a27513e729e26f3a76d0267ea52a6fa43c1/recipes/README.recipes.md#recipe_modules-gsutil
...
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/caa04a27513e729e26f3a76d0267ea52a6fa43c1/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/caa04a27513e729e26f3a76d0267ea52a6fa43c1/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/caa04a27513e729e26f3a76d0267ea52a6fa43c1/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/caa04a27513e729e26f3a76d0267ea52a6fa43c1/recipes/README.recipes.md#recipe_modules-windows_sdk
[recipe_engine/recipe_modules/assertions]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/a5456c47f654f8cab699314f687a1f40aa99a3d2/README.recipes.md#recipe_modules-assertions
...
[recipe_engine/recipe_modules/cq]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/a5456c47f654f8cab699314f687a1f40aa99a3d2/README.recipes.md#recipe_modules-cq
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/a5456c47f654f8cab699314f687a1f40aa99a3d2/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/a5456c47f654f8cab699314f687a1f40aa99a3d2/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/a5456c47f654f8cab699314f687a1f40aa99a3d2/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/a5456c47f654f8cab699314f687a1f40aa99a3d2/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/a5456c47f654f8cab699314f687a1f40aa99a3d2/README.recipes.md#recipe_modules-swarming
[recipe_engine/recipe_modules/tempfile]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/a5456c47f654f8cab699314f687a1f40aa99a3d2/README.recipes.md#recipe_modules-tempfile
[recipe_engine/recipe_modules/time]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/a5456c47f654f8cab699314f687a1f40aa99a3d2/README.recipes.md#recipe_modules-time
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/a5456c47f654f8cab699314f687a1f40aa99a3d2/recipe_engine/util.py#135
