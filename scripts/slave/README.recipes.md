...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [apply\_syzyasan](/scripts/slave/recipe_modules/chromium/api.py#1040)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1052)(self, step_name, gs_bucket, gs_acl=None, mode=None, \*\*kwargs):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#799)(self):**

Add an explicit clobber step if requested.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [compile](/scripts/slave/recipe_modules/chromium/api.py#345)(self, targets=None, name=None, out_dir=None, target=None, use_goma_module=False, \*\*kwargs):**
...
&mdash; **def [delete\_old\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#753)(self):**

Remove the old "hermetic" toolchain cache.

This is to expose any lingering dependencies on the old cache.

&mdash; **def [ensure\_chromium\_layout](/scripts/slave/recipe_modules/chromium/api.py#38)(self):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#725)(self, canary=False):**

&mdash; **def [ensure\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#762)(self):**

&mdash; **def [ensure\_toolchains](/scripts/slave/recipe_modules/chromium/api.py#795)(self):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1093)(self, test_name):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [get\_clang\_version](/scripts/slave/recipe_modules/chromium/api.py#681)(self, \*\*kwargs):**

&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium/api.py#82)(self):**

&mdash; **def [get\_cros\_chrome\_sdk\_wrapper](/scripts/slave/recipe_modules/chromium/api.py#695)(self, clean=False):**
...
&mdash; **def [get\_env](/scripts/slave/recipe_modules/chromium/api.py#113)(self):**

&mdash; **def [get\_mac\_toolchain\_installer](/scripts/slave/recipe_modules/chromium/api.py#743)(self):**
...
&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1028)(self, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#845)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gyp\_chromium](/scripts/slave/recipe_modules/chromium/api.py#837)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb](/scripts/slave/recipe_modules/chromium/api.py#908)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, isolated_targets=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, gyp_script=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#809)(self, env=None, \*\*kwargs):**

Run the build-configuration hooks for chromium.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runtest](/scripts/slave/recipe_modules/chromium/api.py#510)(self, test, args=None, xvfb=False, name=None, annotate=None, results_url=None, perf_dashboard_id=None, test_type=None, python_mode=False, parallel=False, point_id=None, revision=None, webkit_revision=None, test_launcher_summary_output=None, flakiness_dash=None, perf_id=None, perf_config=None, chartjson_file=False, disable_src_side_runtest_py=False, tee_stdout_file=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [sizes](/scripts/slave/recipe_modules/chromium/api.py#638)(self, results_url=None, perf_id=None, platform=None, \*\*kwargs):**

Return a sizes.py invocation.
This uses runtests.py to upload the results to the perf dashboard.

&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1022)(self):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_launcher\_filter](/scripts/slave/recipe_modules/chromium/api.py#506)(self, tests):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [update\_clang](/scripts/slave/recipe_modules/chromium/api.py#1012)(self):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#680)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#562)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None):**
...
&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#773)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#290)(self, bot_config, bot_db, tests):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#813)(self, bot_config=None):**
...
&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#845)(self, mb_config_path=None, bot_config=None):**
...
&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#542)(self, compile_targets, isolated_targets, name_suffix, mb_mastername=None, mb_buildername=None, mb_config_path=None):**

&mdash; **def [run\_tests\_on\_tryserver](/scripts/slave/recipe_modules/chromium_tests/api.py#692)(self, bot_config, tests, bot_update_step, affected_files, mb_mastername=None, mb_buildername=None, disable_deapply_patch=False):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#874)(self):**

&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#44)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#616)(self, bot_config, tests=None):**
...
&mdash; **def [build](/scripts/slave/recipe_modules/dart/api.py#36)(self, build_args=[], isolate=None, name='build dart'):**
...
&mdash; **def [checkout](/scripts/slave/recipe_modules/dart/api.py#12)(self, clobber=False):**

Checks out the dart code and prepares it for building.

&mdash; **def [collect](/scripts/slave/recipe_modules/dart/api.py#154)(self, tasks):**

Collects the results of a sharded test run.

&mdash; **def [collect\_all](/scripts/slave/recipe_modules/dart/api.py#171)(self, deferred_tasks):**

Collects the results of a sharded test run.

&mdash; **def [download\_parent\_isolate](/scripts/slave/recipe_modules/dart/api.py#101)(self):**

&mdash; **def [kill\_tasks](/scripts/slave/recipe_modules/dart/api.py#29)(self):**

Kills leftover tasks from previous runs or steps.

&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#206)(self):**

Reads the debug.log file

&mdash; **def [read\_result\_file](/scripts/slave/recipe_modules/dart/api.py#187)(self, name, log_name, test_data=''):**
...
&mdash; **def [run\_script](/scripts/slave/recipe_modules/dart/api.py#454)(self, step_name, script, args, isolate_hash, shards, local_shard, environment, tasks):**
...
&mdash; **def [run\_test\_py](/scripts/slave/recipe_modules/dart/api.py#410)(self, step_name, append_logs, step, isolate_hash, shards, local_shard, environment, tasks):**
...
&mdash; **def [run\_trigger](/scripts/slave/recipe_modules/dart/api.py#376)(self, step_name, step, isolate_hash):**

&mdash; **def [shard](/scripts/slave/recipe_modules/dart/api.py#115)(self, title, isolate_hash, test_args, os=None, cpu='x86-64', pool='dart.tests', num_shards=0, last_shard_is_local=False):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#217)(self, test_data):**
...
&mdash; **def [upload\_isolate](/scripts/slave/recipe_modules/dart/api.py#84)(self, isolate_fileset):**
...
&emsp; **@property**<br>&mdash; **def [build\_data\_dir](/scripts/slave/recipe_modules/goma/api.py#162)(self):**

&mdash; **def [build\_with\_goma](/scripts/slave/recipe_modules/goma/api.py#436)(self, ninja_command, name=None, ninja_log_outdir=None, ninja_log_compiler=None, goma_env=None, ninja_env=None, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [cloudtail\_exe](/scripts/slave/recipe_modules/goma/api.py#51)(self):**

&emsp; **@property**<br>&mdash; **def [cloudtail\_pid\_file](/scripts/slave/recipe_modules/goma/api.py#58)(self):**

&emsp; **@property**<br>&mdash; **def [cloudtail\_service\_account\_json\_path](/scripts/slave/recipe_modules/goma/api.py#47)(self):**

&emsp; **@property**<br>&mdash; **def [default\_cache\_path](/scripts/slave/recipe_modules/goma/api.py#81)(self):**

&emsp; **@property**<br>&mdash; **def [default\_cache\_path\_per\_slave](/scripts/slave/recipe_modules/goma/api.py#72)(self):**

&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/goma/api.py#128)(self, canary=False):**

&emsp; **@property**<br>&mdash; **def [goma\_ctl](/scripts/slave/recipe_modules/goma/api.py#153)(self):**

&emsp; **@property**<br>&mdash; **def [goma\_dir](/scripts/slave/recipe_modules/goma/api.py#157)(self):**

&emsp; **@property**<br>&mdash; **def [jobs](/scripts/slave/recipe_modules/goma/api.py#87)(self):**
...
&emsp; **@property**<br>&mdash; **def [json\_path](/scripts/slave/recipe_modules/goma/api.py#62)(self):**

&emsp; **@property**<br>&mdash; **def [jsonstatus](/scripts/slave/recipe_modules/goma/api.py#67)(self):**

&emsp; **@property**<br>&mdash; **def [recommended\_goma\_jobs](/scripts/slave/recipe_modules/goma/api.py#96)(self):**
...
&mdash; **def [set\_goma\_dir\_for\_local\_test](/scripts/slave/recipe_modules/goma/api.py#120)(self, goma_dir):**

This function is made for local recipe test only.
Do not use in recipes used by buildbots.

&mdash; **def [start](/scripts/slave/recipe_modules/goma/api.py#225)(self, env=None, \*\*kwargs):**
...
&mdash; **def [stop](/scripts/slave/recipe_modules/goma/api.py#305)(self, ninja_log_outdir=None, ninja_log_compiler=None, ninja_log_command=None, build_exit_status=None, \*\*kwargs):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#863)(self, tasks, upload_test_results=True):**
...
&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#1033)(self, path):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#528)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#669)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_earlgrey\_test](/scripts/slave/recipe_modules/ios/api.py#632)(self, test, shard_size, tmp_dir, isolate_template):**
...
&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#1118)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#1105)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#1133)(self):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#1082)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True):**

Runs tests on Swarming as instructed by this bot's build config.

&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#769)(self, tasks):**
...
#### **class [V8Api](/scripts/slave/recipe_modules/v8/api.py#115)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [apply\_bot\_config](/scripts/slave/recipe_modules/v8/api.py#144)(self, builders, tryserver_check=True):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#383)(self):**

&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#798)(self):**

&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1488)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#289)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#243)(self, revision=None, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#643)(self, test_spec=None, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#874)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#880)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#887)(self):**

&mdash; **def [download\_build](/scripts/slave/recipe_modules/v8/api.py#774)(self, name_suffix='', archive=None):**

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#786)(self, revision):**

&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1185)(self):**

&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#431)(self):**
...
&mdash; **def [extra\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#443)(self, test_spec):**

Returns runnable testing.BaseTest objects for each extra test specified
in the test spec of the current builder.

&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1049)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#805)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#870)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1464)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1417)(self):**

&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#809)(self):**

Delete all gcov counter files.

&mdash; **def [init\_tryserver](/scripts/slave/recipe_modules/v8/api.py#235)(self):**

&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#890)(self, tests):**

&emsp; **@property**<br>&mdash; **def [isolate\_targets](/scripts/slave/recipe_modules/v8/api.py#501)(self):**

&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#525)(self, extra_targets=None):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#740)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/v8/api.py#205)(self):**

&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1510)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#950)(self, test_results):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#757)(self, update_step):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1285)(self, test_spec=None, \*\*additional_properties):**

&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#452)(self):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1526)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1535)(self, ref, step_name_desc):**

Read and return the version at a paricular ref.

&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#404)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1515)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#350)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#895)(self, tests):**

&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#305)(self):**

&mdash; **def [setup\_mips\_toolchain](/scripts/slave/recipe_modules/v8/api.py#374)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#387)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/v8/api.py#400)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#391)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#395)(self):**

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1211)(self):**

&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#215)(self):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#732)(self, name_suffix='', archive=None):**

&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#816)(self):**

Capture coverage data and upload a report.

&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#749)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1539)(blob):**
...
&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#279)(self):**

&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#195)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#147)(self, \*\*kwargs):**

&mdash; **def [clean\_test\_output](/scripts/slave/recipe_modules/webrtc/api.py#363)(self):**

Remove all test output in out/, since we have tests leaking files.

&mdash; **def [cleanup](/scripts/slave/recipe_modules/webrtc/api.py#356)(self):**

&mdash; **def [compile](/scripts/slave/recipe_modules/webrtc/api.py#205)(self):**
...
&mdash; **def [extract\_build](/scripts/slave/recipe_modules/webrtc/api.py#335)(self):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#256)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#320)(self):**

&mdash; **def [package\_build](/scripts/slave/recipe_modules/webrtc/api.py#269)(self):**

&mdash; **def [run\_baremetal\_test](/scripts/slave/recipe_modules/webrtc/api.py#251)(self, test, name=None, gtest_args=None, args=None, parallel=True):**

&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#199)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#214)(self):**
...
&mdash; **def [virtual\_webcam\_check](/scripts/slave/recipe_modules/webrtc/api.py#371)(self):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/dart/dart_vm.py#144)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/dart/neo.py#66)(api):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#334)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#400)(api):**
...
&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#416)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#356)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#432)(api):**
...
&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#301)(api, label, device_out, sim_out, bucket_name):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/engine.py#224)(api, ios_tools_path, target_version):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#447)(api):**

&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#237)(api):**

&mdash; **def [TestEngine](/scripts/slave/recipes/flutter/engine.py#217)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#206)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/flutter.py#174)(api):**
...
&mdash; **def [get\_gold\_params](/scripts/slave/recipes/pdfium.py#247)(api, build_config, revision):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6034966c95cf967f6deba6493d90a65b2ec60f51/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/buildbucket]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3bc7426647d70d8ba58b895becc276ac3518917c/README.recipes.md#recipe_modules-buildbucket
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3bc7426647d70d8ba58b895becc276ac3518917c/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3bc7426647d70d8ba58b895becc276ac3518917c/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3bc7426647d70d8ba58b895becc276ac3518917c/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/3bc7426647d70d8ba58b895becc276ac3518917c/recipe_engine/util.py#120
