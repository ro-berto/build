...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1520)(self, step_name, gs_bucket, gs_acl=None, mode=None, build_name=None, \*\*kwargs):**
...
&mdash; **def [clean\_outdir](/scripts/slave/recipe_modules/chromium/api.py#1566)(self):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#1028)(self):**
...
&mdash; **def [ensure\_toolchains](/scripts/slave/recipe_modules/chromium/api.py#1024)(self):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1563)(self, _):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_analyze](/scripts/slave/recipe_modules/chromium/api.py#1259)(self, mastername, buildername, analyze_input, name=None, mb_path=None, mb_config_path=None, chromium_config=None, build_dir=None, phase=None, \*\*kwargs):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [mb\_failure\_handler](/scripts/slave/recipe_modules/chromium/api.py#1488)(self, name):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_gen](/scripts/slave/recipe_modules/chromium/api.py#1381)(self, mastername, buildername, name=None, mb_path=None, mb_config_path=None, use_goma=True, isolated_targets=None, build_dir=None, phase=None, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None, recursive_lookup=False, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_isolate\_everything](/scripts/slave/recipe_modules/chromium/api.py#1468)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_lookup](/scripts/slave/recipe_modules/chromium/api.py#1315)(self, mastername, buildername, name=None, mb_path=None, mb_config_path=None, recursive=False, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None):**
...
&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1508)(self, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#1080)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb\_cmd](/scripts/slave/recipe_modules/chromium/api.py#1157)(self, name, mb_command, mastername, buildername, mb_path=None, mb_config_path=None, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, additional_args=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#1038)(self, env=None, \*\*kwargs):**
...
&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1502)(self):**
...
&mdash; **def [coverage\_report](/scripts/slave/recipe_modules/chromium_android/api.py#1284)(self, upload=True, \*\*kwargs):**
...
&mdash; **def [get\_changed\_lines\_for\_revision](/scripts/slave/recipe_modules/chromium_android/api.py#1401)(self):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [handle\_exit\_codes](/scripts/slave/recipe_modules/chromium_android/api.py#1462)(self):**
...
&mdash; **def [incremental\_coverage\_report](/scripts/slave/recipe_modules/chromium_android/api.py#1330)(self):**
...
&mdash; **def [run\_webview\_cts](/scripts/slave/recipe_modules/chromium_android/api.py#1241)(self, android_platform, arch, command_line_args=None, suffix=None, json_results_file=None, result_details=False):**
...
&mdash; **def [staged\_files\_matching\_filter](/scripts/slave/recipe_modules/chromium_android/api.py#1442)(self, diff_filter):**
...
&mdash; **def [test\_runner](/scripts/slave/recipe_modules/chromium_android/api.py#1485)(self, step_name, args=None, wrapper_script_suite_name=None, pass_adb_path=True, \*\*kwargs):**
...
#### **class [SwarmingApi](/scripts/slave/recipe_modules/chromium_swarming/api.py#175)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [add\_default\_tag](/scripts/slave/recipe_modules/chromium_swarming/api.py#436)(self, tag):**
...
&mdash; **def [check\_client\_version](/scripts/slave/recipe_modules/chromium_swarming/api.py#719)(self, step_test_data=None):**
...
&emsp; **@property**<br>&mdash; **def [default\_dimensions](/scripts/slave/recipe_modules/chromium_swarming/api.py#371)(self):**
...
&emsp; **@property**<br>&mdash; **def [default\_env](/scripts/slave/recipe_modules/chromium_swarming/api.py#394)(self):**
...
&emsp; **@default_expiration.setter**<br>&mdash; **def [default\_expiration](/scripts/slave/recipe_modules/chromium_swarming/api.py#294)(self, value):**

&emsp; **@default_hard_timeout.setter**<br>&mdash; **def [default\_hard\_timeout](/scripts/slave/recipe_modules/chromium_swarming/api.py#311)(self, value):**

&emsp; **@default_idempotent.setter**<br>&mdash; **def [default\_idempotent](/scripts/slave/recipe_modules/chromium_swarming/api.py#350)(self, value):**

&emsp; **@default_io_timeout.setter**<br>&mdash; **def [default\_io\_timeout](/scripts/slave/recipe_modules/chromium_swarming/api.py#330)(self, value):**

&emsp; **@default_priority.setter**<br>&mdash; **def [default\_priority](/scripts/slave/recipe_modules/chromium_swarming/api.py#421)(self, value):**
...
&mdash; **def [gtest\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#653)(self, name=None, isolated=None, extra_args=None, cipd_packages=None, merge=None, \*\*kwargs):**
...
&mdash; **def [initialize](/scripts/slave/recipe_modules/chromium_swarming/api.py#243)(self):**

&mdash; **def [isolated\_script\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#685)(self):**
...
&mdash; **def [merge\_script\_path](/scripts/slave/recipe_modules/chromium_swarming/api.py#483)(self, name):**
...
&emsp; **@staticmethod**<br>&mdash; **def [prefered\_os\_dimension](/scripts/slave/recipe_modules/chromium_swarming/api.py#465)(platform):**
...
&emsp; **@service_account_json.setter**<br>&mdash; **def [service\_account\_json](/scripts/slave/recipe_modules/chromium_swarming/api.py#256)(self, value):**

Service account json to use for swarming.

&mdash; **def [set\_default\_dimension](/scripts/slave/recipe_modules/chromium_swarming/api.py#386)(self, key, value):**

&mdash; **def [set\_default\_env](/scripts/slave/recipe_modules/chromium_swarming/api.py#405)(self, key, value):**

&emsp; **@show_outputs_ref_in_collect_step.setter**<br>&mdash; **def [show\_outputs\_ref\_in\_collect\_step](/scripts/slave/recipe_modules/chromium_swarming/api.py#452)(self, value):**

&emsp; **@show_shards_in_collect_step.setter**<br>&mdash; **def [show\_shards\_in\_collect\_step](/scripts/slave/recipe_modules/chromium_swarming/api.py#461)(self, value):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [summary](/scripts/slave/recipe_modules/chromium_swarming/api.py#247)(self):**

&emsp; **@swarming_server.setter**<br>&mdash; **def [swarming\_server](/scripts/slave/recipe_modules/chromium_swarming/api.py#266)(self, value):**

Changes URL of Swarming server to use.

&mdash; **def [task](/scripts/slave/recipe_modules/chromium_swarming/api.py#491)(self, name=None, build_properties=None, cipd_packages=None, collect_step=None, env=None, env_prefixes=None, extra_args=None, failure_as_exception=True, idempotent=None, ignore_task_failure=False, isolated=None, merge=None, named_caches=None, optional_dimensions=None, raw_cmd=None, service_account=None, shards=1, shard_indices=None, task_output_dir=None, task_to_retry=None, trigger_script=None):**
...
&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#592)(self, mastername, buildername, update_step, bot_db):**
...
&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#418)(self, bot_config, update_step, bot_db, compile_targets, tests_including_triggered, mb_mastername=None, mb_buildername=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=False, override_bot_type=None):**
...
&mdash; **def [create\_bot\_db\_from\_master\_dict](/scripts/slave/recipe_modules/chromium_tests/api.py#268)(self, mastername, master_dict):**
...
&mdash; **def [create\_test\_runner](/scripts/slave/recipe_modules/chromium_tests/api.py#319)(self, tests, suffix='', serialize_tests=False, retry_failed_shards=False, retry_invalid_shards=False):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#836)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#718)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None, read_gn_args=True):**

&mdash; **def [generate\_tests\_from\_source\_side\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#292)(self, source_side_spec, builder_dict, buildername, mastername, swarming_dimensions, scripts_compile_targets, bot_update_step):**

&mdash; **def [get\_android\_version\_details](/scripts/slave/recipe_modules/chromium_tests/api.py#388)(self, bot_config, log_details=False):**

&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#1000)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#373)(self, bot_config, bot_db, tests):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#1034)(self, bot_config=None):**
...
&mdash; **def [get\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#364)(self, bot_config, bot_db):**
...
&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1066)(self, mb_config_path=None, builders=None):**
...
&mdash; **def [package\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#515)(self, mastername, buildername, update_step, bot_db, reasons=None):**
...
&mdash; **def [prepare\_checkout](/scripts/slave/recipe_modules/chromium_tests/api.py#273)(self, bot_config, \*\*kwargs):**

&mdash; **def [read\_source\_side\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#307)(self, source_side_spec_file):**

&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#691)(self, compile_targets, isolated_targets, name_suffix, mb_mastername=None, mb_buildername=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=False, android_version_code=None, android_version_name=None):**

&mdash; **def [run\_tests\_with\_and\_without\_changes](/scripts/slave/recipe_modules/chromium_tests/api.py#1260)(self, builders, mirrored_bots, deapply_changes):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/chromium_tests/api.py#229)(self, bot_config):**
...
&mdash; **def [trigger\_child\_builds](/scripts/slave/recipe_modules/chromium_tests/api.py#623)(self, mastername, buildername, update_step, bot_db, additional_properties=None):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#777)(self, bot_config, tests=None):**
...
&emsp; **@property**<br>&mdash; **def [cov\_executable](/scripts/slave/recipe_modules/code_coverage/api.py#127)(self):**
...
&mdash; **def [instrument](/scripts/slave/recipe_modules/code_coverage/api.py#251)(self, affected_files):**
...
&emsp; **@property**<br>&mdash; **def [is\_clang\_coverage](/scripts/slave/recipe_modules/code_coverage/api.py#86)(self):**

&emsp; **@property**<br>&mdash; **def [is\_java\_coverage](/scripts/slave/recipe_modules/code_coverage/api.py#92)(self):**

&emsp; **@property**<br>&mdash; **def [merge\_scripts\_location](/scripts/slave/recipe_modules/code_coverage/api.py#97)(self):**

&emsp; **@property**<br>&mdash; **def [metadata\_dir](/scripts/slave/recipe_modules/code_coverage/api.py#139)(self):**

A temporary directory for the metadata. Created on first access.

&mdash; **def [process\_clang\_coverage\_data](/scripts/slave/recipe_modules/code_coverage/api.py#302)(self, tests):**
...
&mdash; **def [process\_coverage\_data](/scripts/slave/recipe_modules/code_coverage/api.py#284)(self, tests):**
...
&mdash; **def [profdata\_dir](/scripts/slave/recipe_modules/code_coverage/api.py#151)(self, step_name=None):**
...
&emsp; **@property**<br>&mdash; **def [profdata\_executable](/scripts/slave/recipe_modules/code_coverage/api.py#122)(self):**

Returns the path to the llvm-profdata executable.

&emsp; **@property**<br>&mdash; **def [raw\_profile\_merge\_script](/scripts/slave/recipe_modules/code_coverage/api.py#109)(self):**
...
&emsp; **@property**<br>&mdash; **def [report\_dir](/scripts/slave/recipe_modules/code_coverage/api.py#132)(self):**
...
&emsp; **@property**<br>&mdash; **def [step\_merge\_script](/scripts/slave/recipe_modules/code_coverage/api.py#104)(self):**

Returns the script that merges indexed profiles from multiple targets.

&emsp; **@property**<br>&mdash; **def [using\_coverage](/scripts/slave/recipe_modules/code_coverage/api.py#175)(self):**
...
&mdash; **def [collect\_all](/scripts/slave/recipe_modules/dart/api.py#235)(self, steps):**
...
&mdash; **def [delete\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#631)(self):**

Deletes the debug log file

&mdash; **def [download\_parent\_isolate](/scripts/slave/recipe_modules/dart/api.py#144)(self):**
...
&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#619)(self):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#637)(self, test_data):**
...
&mdash; **def [build\_with\_goma](/scripts/slave/recipe_modules/goma/api.py#555)(self, ninja_command, name=None, ninja_log_outdir=None, ninja_log_compiler=None, goma_env=None, ninja_env=None, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [debug](/scripts/slave/recipe_modules/goma/api.py#139)(self):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/goma/api.py#168)(self, client_type=None, additional_platforms=None):**
...
&emsp; **@property**<br>&mdash; **def [extra\_package\_path](/scripts/slave/recipe_modules/goma/api.py#126)(self):**

&emsp; **@property**<br>&mdash; **def [goma\_ctl](/scripts/slave/recipe_modules/goma/api.py#218)(self):**

&emsp; **@property**<br>&mdash; **def [goma\_dir](/scripts/slave/recipe_modules/goma/api.py#222)(self):**

&mdash; **def [initialize](/scripts/slave/recipe_modules/goma/api.py#64)(self):**

&emsp; **@property**<br>&mdash; **def [jobs](/scripts/slave/recipe_modules/goma/api.py#130)(self):**
...
&emsp; **@property**<br>&mdash; **def [recommended\_goma\_jobs](/scripts/slave/recipe_modules/goma/api.py#148)(self):**
...
&mdash; **def [start](/scripts/slave/recipe_modules/goma/api.py#295)(self, env=None, \*\*kwargs):**
...
&mdash; **def [stop](/scripts/slave/recipe_modules/goma/api.py#378)(self, build_exit_status, ninja_log_outdir=None, ninja_log_compiler=None, ninja_log_command=None, build_step_name='', \*\*kwargs):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/art.py#643)(api):**
...
&mdash; **def [setup\_target](/scripts/slave/recipes/art.py#234)(api, device, debug, concurrent_collector=True, generational_cc=True, heap_poisoning=False, gcstress=False):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/steps/artifact_links.py#25)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/client.nacl.sdk.recipe_autogen.py#125)(api):**

&mdash; **def [sdk\_multi\_steps](/scripts/slave/recipes/client.nacl.sdk.recipe_autogen.py#23)(api):**

&mdash; **def [sdk\_multirel\_steps](/scripts/slave/recipes/client.nacl.sdk.recipe_autogen.py#67)(api):**
...
&mdash; **def [BuildAndTest](/scripts/slave/recipes/dart/flutter_engine.py#301)(api, start_dir, checkout_dir, flutter_rev):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/dart/flutter_engine.py#91)(api, checkout_dir):**

&mdash; **def [BuildLinuxAndroidArm](/scripts/slave/recipes/dart/flutter_engine.py#75)(api, checkout_dir):**
...
&mdash; **def [GetCheckout](/scripts/slave/recipes/dart/flutter_engine.py#114)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/dart/flutter_engine.py#280)(api):**
...
&mdash; **def [TestObservatory](/scripts/slave/recipes/dart/flutter_engine.py#103)(api, checkout_dir):**
...
&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#190)(api):**
...
&mdash; **def [BuildFuchsiaArtifactsAndUpload](/scripts/slave/recipes/flutter/engine.py#70)(api):**

&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#529)(api):**
...
&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#237)(api, swarming_task_id):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#386)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#657)(api):**
...
&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#674)(api):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#44)(api, path):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallGems](/scripts/slave/recipes/flutter/engine.py#642)(api):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#181)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#451)(api, label, arm64_out, armv7_out, sim_out, bucket_name):**
...
&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#379)(api):**

&mdash; **def [ShouldUploadPackages](/scripts/slave/recipes/flutter/engine.py#41)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#369)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#107)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#140)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#166)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#148)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#122)(api, dir_label, parent_dir, folder_name, zip_name, platform=None):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#210)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [UploadWebSdk](/scripts/slave/recipes/flutter/engine.py#173)(api, archive_name):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#199)(api):**
...
&mdash; **def [CreateAndUploadFlutterPackage](/scripts/slave/recipes/flutter/flutter.py#128)(api, git_hash, branch):**

Prepares, builds, and uploads an all-inclusive archive package.

&mdash; **def [DecryptKMS](/scripts/slave/recipes/flutter/flutter.py#82)(api, step_name, crypto_key_path, ciphertext_file, plaintext_file):**

&mdash; **def [EnsureCloudKMS](/scripts/slave/recipes/flutter/flutter.py#72)(api, version=None):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/flutter.py#93)(api, git_hash, path):**

&emsp; **@contextmanager**<br>&mdash; **def [Install7za](/scripts/slave/recipes/flutter/flutter.py#46)(api):**

&mdash; **def [InstallOpenJDK](/scripts/slave/recipes/flutter/flutter.py#60)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/flutter.py#163)(api):**

&mdash; **def [UploadFlutterCoverage](/scripts/slave/recipes/flutter/flutter.py#98)(api):**
...
&mdash; **def [GetDEPS](/scripts/slave/recipes/v8/auto_roll_v8_deps.py#88)(api, name, repo):**

&mdash; **def [RunSteps](/scripts/slave/recipes/v8/auto_roll_v8_deps.py#168)(api):**

&mdash; **def [commit\_messages\_log\_entries](/scripts/slave/recipes/v8/auto_roll_v8_deps.py#129)(api, repo, from_commit, to_commit):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/flako.py#543)(api, bisect_mastername, bisect_buildername, build_config, extra_args, initial_commit_offset, max_calibration_attempts, isolated_name, num_shards, repetitions, repro_only, swarming_dimensions, swarming_priority, swarming_expiration, test_name, timeout_sec, total_timeout_sec, to_revision, variant):**

&mdash; **def [bisect](/scripts/slave/recipes/v8/flako.py#441)(api, depot, initial_commit_offset, is_bad_func, offset):**
...
&mdash; **def [setup\_swarming](/scripts/slave/recipes/v8/flako.py#524)(api, swarming_dimensions, swarming_priority, swarming_expiration):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/9f4b37db0e36216cdb09dadc07e200ca25c14ea6/recipes/README.recipes.md#recipe_modules-windows_sdk
[recipe_engine/recipe_modules/assertions]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/54c9a286d41d9f711837dd4c002fc7fbc9bfde83/README.recipes.md#recipe_modules-assertions
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/54c9a286d41d9f711837dd4c002fc7fbc9bfde83/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/54c9a286d41d9f711837dd4c002fc7fbc9bfde83/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/54c9a286d41d9f711837dd4c002fc7fbc9bfde83/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/54c9a286d41d9f711837dd4c002fc7fbc9bfde83/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/54c9a286d41d9f711837dd4c002fc7fbc9bfde83/README.recipes.md#recipe_modules-swarming
[recipe_engine/recipe_modules/tempfile]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/54c9a286d41d9f711837dd4c002fc7fbc9bfde83/README.recipes.md#recipe_modules-tempfile
[recipe_engine/recipe_modules/time]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/54c9a286d41d9f711837dd4c002fc7fbc9bfde83/README.recipes.md#recipe_modules-time
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/54c9a286d41d9f711837dd4c002fc7fbc9bfde83/recipe_engine/util.py#135
