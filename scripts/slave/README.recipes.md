...
&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1463)(self, bucket, changes, requests, step_name='trigger', service_account='v8-bot', no_buildset=False):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1603)(self, sequence, subsequence, value):**
...
&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#336)(self, revision=None, \*\*kwargs):**
...
&mdash; **def [download\_build](/scripts/slave/recipe_modules/v8/api.py#849)(self, name_suffix='', archive=None):**
...
&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1136)(duration_in_seconds):**
...
&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1579)(self, bisect_range):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1522)(self):**

&mdash; **def [get\_changes](/scripts/slave/recipe_modules/v8/api.py#1457)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1625)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#1040)(self, test_results):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1641)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1650)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1630)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#441)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#985)(self, tests):**

&mdash; **def [set\_gclient\_custom\_deps](/scripts/slave/recipe_modules/v8/api.py#311)(self, custom_deps):**

Configures additional gclient custom_deps to be synced.

&mdash; **def [set\_gclient\_custom\_var](/scripts/slave/recipe_modules/v8/api.py#302)(self, var_name):**
...
&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#316)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1654)(blob):**
