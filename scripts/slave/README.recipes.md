...
&mdash; **def [BuildExamples](/scripts/slave/recipes/flutter/flutter.py#118)(api, git_hash, flutter_executable):**

&mdash; **def [CreateAndUploadFlutterPackage](/scripts/slave/recipes/flutter/flutter.py#288)(api, git_hash, branch):**

Prepares, builds, and uploads an all-inclusive archive package.

&mdash; **def [DecryptKMS](/scripts/slave/recipes/flutter/flutter.py#92)(api, step_name, crypto_key_path, ciphertext_file, plaintext_file):**

&mdash; **def [EnsureCloudKMS](/scripts/slave/recipes/flutter/flutter.py#82)(api, version=None):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/flutter.py#112)(api, git_hash, path):**

&mdash; **def [GetGradleDirName](/scripts/slave/recipes/flutter/flutter.py#227)(api):**

&mdash; **def [GetGradleDistributionUrl](/scripts/slave/recipes/flutter/flutter.py#217)(api):**

&mdash; **def [GetGradleZipFileName](/scripts/slave/recipes/flutter/flutter.py#223)(api):**

&mdash; **def [GetPuppetApiTokenPath](/scripts/slave/recipes/flutter/flutter.py#103)(api, token_name):**

Returns the path to a the token file

The file is located where ChromeOps Puppet drops generic secrets.

&emsp; **@contextmanager**<br>&mdash; **def [InstallGem](/scripts/slave/recipes/flutter/flutter.py#70)(api, gem_name, gem_version):**

&mdash; **def [InstallGradle](/scripts/slave/recipes/flutter/flutter.py#230)(api, checkout):**

&mdash; **def [InstallOpenJDK](/scripts/slave/recipes/flutter/flutter.py#58)(api):**

&mdash; **def [RunFindXcode](/scripts/slave/recipes/flutter/flutter.py#187)(api, ios_tools_path, target_version):**
...
&mdash; **def [UploadFlutterCoverage](/scripts/slave/recipes/flutter/flutter.py#249)(api):**
