...
#### **class [ClangCoverageApi](/scripts/slave/recipe_modules/clang_coverage/api.py#25)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

This module contains apis to interact with llvm-cov and llvm-profdata.

&emsp; **@property**<br>&mdash; **def [cov\_executable](/scripts/slave/recipe_modules/clang_coverage/api.py#77)(self):**
...
&mdash; **def [instrument](/scripts/slave/recipe_modules/clang_coverage/api.py#151)(self, affected_files):**
...
&emsp; **@property**<br>&mdash; **def [metadata\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#89)(self):**

A temporary directory for the metadata. Created on first access.

&mdash; **def [process\_coverage\_data](/scripts/slave/recipe_modules/clang_coverage/api.py#176)(self, tests):**
...
&mdash; **def [profdata\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#103)(self, step_name=None):**
...
&emsp; **@property**<br>&mdash; **def [profdata\_executable](/scripts/slave/recipe_modules/clang_coverage/api.py#72)(self):**

Returns the path to the llvm-profdata executable.

&emsp; **@property**<br>&mdash; **def [raw\_profile\_merge\_script](/scripts/slave/recipe_modules/clang_coverage/api.py#59)(self):**
...
&emsp; **@property**<br>&mdash; **def [report\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#82)(self):**

A temporary directory to save a report to. Created on first access.

&mdash; **def [shard\_merge](/scripts/slave/recipe_modules/clang_coverage/api.py#255)(self, step_name):**

Returns a merge object understood by the swarming module.

See the docstring for the `merge` parameter of api.swarming.task.

&emsp; **@property**<br>&mdash; **def [src\_and\_report\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#96)(self):**

A temporary directory to copy source and html report report to.

&emsp; **@property**<br>&mdash; **def [using\_coverage](/scripts/slave/recipe_modules/clang_coverage/api.py#127)(self):**
...
&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#1165)(self, path):**
...
&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#1250)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#1237)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#1265)(self):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#1214)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True):**
...
&mdash; **def [compare\_build\_artifacts](/scripts/slave/recipe_modules/isolate/api.py#278)(self, first_dir, second_dir):**

Compare the artifacts from 2 builds.

&mdash; **def [compose](/scripts/slave/recipe_modules/isolate/api.py#300)(self, isolate_hashes, step_name=None, \*\*kwargs):**
...
&mdash; **def [check\_client\_version](/scripts/slave/recipe_modules/swarming/api.py#631)(self, step_test_data=None):**

Yields steps to verify compatibility with swarming_client version.

&mdash; **def [collect\_task](/scripts/slave/recipe_modules/swarming/api.py#822)(self, task, \*\*kwargs):**
...
&mdash; **def [get\_collect\_cmd\_args\_for\_python](/scripts/slave/recipe_modules/swarming/api.py#1369)(self, task):**

SwarmingTask -> argument list for 'swarming.py' command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/swarming/api.py#1256)(self, prefix, task):**
...
&mdash; **def [gtest\_task](/scripts/slave/recipe_modules/swarming/api.py#550)(self, title, isolated_hash, test_launcher_summary_output=None, extra_args=None, cipd_packages=None, merge=None, \*\*kwargs):**
...
&mdash; **def [isolated\_script\_task](/scripts/slave/recipe_modules/swarming/api.py#596)(self, title, isolated_hash, extra_args=None, idempotent=False, merge=None, \*\*kwargs):**
...
&mdash; **def [report\_stats](/scripts/slave/recipe_modules/swarming/api.py#850)(self):**
...
&mdash; **def [trigger\_task](/scripts/slave/recipe_modules/swarming/api.py#636)(self, task, \*\*kwargs):**
...
&mdash; **def [wait\_for\_finished\_task\_set](/scripts/slave/recipe_modules/swarming/api.py#1158)(self, task_sets, suffix=None, attempts=0):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/52411ecf1fa5d12f3ea0a4bb4afa350e92a49b28/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/95a3eec6ae5226c402ca15514f2ccc39d5b367c9/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/95a3eec6ae5226c402ca15514f2ccc39d5b367c9/README.recipes.md#recipe_modules-led
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/95a3eec6ae5226c402ca15514f2ccc39d5b367c9/recipe_engine/util.py#132
