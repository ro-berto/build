...
&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#541)(self, builder_id, update_step, build_config):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#786)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#658)(self, builder_id, update_step, build_config, build_archive_url=None, build_revision=None, override_bot_type=None, read_gn_args=True):**
...
&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#309)(self, bot_config, build_config, tests):**
...
&mdash; **def [package\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#465)(self, builder_id, update_step, build_config, reasons=None):**
...
&mdash; **def [trigger\_child\_builds](/scripts/slave/recipe_modules/chromium_tests/api.py#592)(self, builder_id, update_step, build_config, additional_properties=None):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#724)(self, bot_config, tests=None):**
