...
&mdash; **def [collect\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#1087)(self, task, \*\*kwargs):**
...
&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/chromium_swarming/api.py#1473)(self, prefix, task):**
...
&mdash; **def [report\_stats](/scripts/slave/recipe_modules/chromium_swarming/api.py#1109)(self):**
...
&mdash; **def [wait\_for\_finished\_task\_set](/scripts/slave/recipe_modules/chromium_swarming/api.py#1393)(self, task_sets, suffix=None, attempts=0):**
...
&mdash; **def [checkout\_generated\_files\_repo\_and\_sync](/scripts/slave/recipe_modules/codesearch/api.py#237)(self):**
...
&mdash; **def [download\_browser](/scripts/slave/recipe_modules/dart/api.py#827)(self, runtime, version):**
...
&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#495)(self):**

&emsp; **@property**<br>&mdash; **def [build\_url](/scripts/slave/recipe_modules/webrtc/api.py#223)(self):**

&emsp; **@property**<br>&mdash; **def [buildername](/scripts/slave/recipe_modules/webrtc/api.py#219)(self):**

&mdash; **def [check\_swarming\_version](/scripts/slave/recipe_modules/webrtc/api.py#379)(self):**

&mdash; **def [checkout](/scripts/slave/recipe_modules/webrtc/api.py#321)(self, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/webrtc/api.py#421)(self, phase=None, override_targets=None):**

&mdash; **def [configure\_isolate](/scripts/slave/recipe_modules/webrtc/api.py#261)(self, phase=None):**

&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/webrtc/api.py#280)(self):**

&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#351)(self):**

&mdash; **def [download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#359)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [ensure\_sdk](/scripts/slave/recipe_modules/webrtc/api.py#383)(self):**

&mdash; **def [get\_binary\_sizes](/scripts/slave/recipe_modules/webrtc/api.py#436)(self, files=None, base_dir=None):**

&mdash; **def [get\_bot](/scripts/slave/recipe_modules/webrtc/api.py#231)(self, bucketname, buildername):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/webrtc/api.py#432)(self):**

&emsp; **@property**<br>&mdash; **def [master\_config](/scripts/slave/recipe_modules/webrtc/api.py#234)(self):**

&emsp; **@property**<br>&mdash; **def [mastername](/scripts/slave/recipe_modules/webrtc/api.py#238)(self):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#479)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#536)(self):**

&mdash; **def [related\_bots](/scripts/slave/recipe_modules/webrtc/api.py#242)(self):**

&emsp; **@property**<br>&mdash; **def [revision\_number](/scripts/slave/recipe_modules/webrtc/api.py#209)(self):**

&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#388)(self, phase=None):**

&mdash; **def [run\_mb\_ios](/scripts/slave/recipe_modules/webrtc/api.py#406)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#452)(self, phase=None):**
...
&emsp; **@property**<br>&mdash; **def [should\_download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#247)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_video\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#254)(self):**

&mdash; **def [upload\_to\_perf\_dashboard](/scripts/slave/recipe_modules/webrtc/api.py#552)(self, name, step_result):**
...
[DEPS](/scripts/slave/recipe_modules/chromium/tests/mb_isolate_everything.py#7): [chromium](#recipe_modules-chromium)

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium/tests/mb_isolate_everything.py#9)(api):**
...
[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/api/download_and_unzip_build.py#7): [chromium](#recipe_modules-chromium), [chromium\_tests](#recipe_modules-chromium_tests), [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/properties][recipe_engine/recipe_modules/properties]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/api/download_and_unzip_build.py#14)(api):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/7c34a225375d758beb8225e2171fcd3c031f0e8c/recipes/README.recipes.md#recipe_modules-windows_sdk
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/90eb05b0df05f7840e58ff3c9f3685af0c89a27d/README.recipes.md#recipe_modules-generator_script
[recipe_engine/recipe_modules/isolated]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/90eb05b0df05f7840e58ff3c9f3685af0c89a27d/README.recipes.md#recipe_modules-isolated
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/90eb05b0df05f7840e58ff3c9f3685af0c89a27d/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/90eb05b0df05f7840e58ff3c9f3685af0c89a27d/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/recipe_modules/tricium]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/90eb05b0df05f7840e58ff3c9f3685af0c89a27d/README.recipes.md#recipe_modules-tricium
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/90eb05b0df05f7840e58ff3c9f3685af0c89a27d/recipe_engine/util.py#135
