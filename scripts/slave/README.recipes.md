...
&mdash; **def [run\_script](/scripts/slave/recipe_modules/dart/api.py#593)(self, step_name, script, args, isolate_hash, shards, local_shard, environment, tasks, cipd_packages=[]):**
