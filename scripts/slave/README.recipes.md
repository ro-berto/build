...
&mdash; **def [additional\_goma\_dir](/scripts/slave/recipe_modules/goma/api.py#220)(self, platform):**
...
&emsp; **@property**<br>&mdash; **def [bigquery\_service\_account\_json\_path](/scripts/slave/recipe_modules/goma/api.py#82)(self):**
...
&emsp; **@property**<br>&mdash; **def [cloudtail\_exe](/scripts/slave/recipe_modules/goma/api.py#86)(self):**

&emsp; **@property**<br>&mdash; **def [cloudtail\_pid\_file](/scripts/slave/recipe_modules/goma/api.py#93)(self):**

&emsp; **@property**<br>&mdash; **def [cloudtail\_service\_account\_json\_path](/scripts/slave/recipe_modules/goma/api.py#73)(self):**

&emsp; **@property**<br>&mdash; **def [counterz\_path](/scripts/slave/recipe_modules/goma/api.py#77)(self):**

&emsp; **@property**<br>&mdash; **def [debug](/scripts/slave/recipe_modules/goma/api.py#140)(self):**
...
&emsp; **@property**<br>&mdash; **def [default\_cache\_path\_per\_slave](/scripts/slave/recipe_modules/goma/api.py#107)(self):**

&emsp; **@property**<br>&mdash; **def [default\_client\_path](/scripts/slave/recipe_modules/goma/api.py#123)(self):**

&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/goma/api.py#169)(self, client_type=None, additional_platforms=None):**
...
&emsp; **@property**<br>&mdash; **def [goma\_ctl](/scripts/slave/recipe_modules/goma/api.py#232)(self):**

&emsp; **@property**<br>&mdash; **def [goma\_dir](/scripts/slave/recipe_modules/goma/api.py#236)(self):**

&mdash; **def [initialize](/scripts/slave/recipe_modules/goma/api.py#65)(self):**

&emsp; **@property**<br>&mdash; **def [jobs](/scripts/slave/recipe_modules/goma/api.py#131)(self):**
...
&emsp; **@property**<br>&mdash; **def [json\_path](/scripts/slave/recipe_modules/goma/api.py#97)(self):**

&emsp; **@property**<br>&mdash; **def [jsonstatus](/scripts/slave/recipe_modules/goma/api.py#102)(self):**

&emsp; **@property**<br>&mdash; **def [recommended\_goma\_jobs](/scripts/slave/recipe_modules/goma/api.py#149)(self):**
...
&emsp; **@property**<br>&mdash; **def [service\_account\_json\_path](/scripts/slave/recipe_modules/goma/api.py#69)(self):**

&mdash; **def [start](/scripts/slave/recipe_modules/goma/api.py#309)(self, env=None, \*\*kwargs):**
...
&mdash; **def [stop](/scripts/slave/recipe_modules/goma/api.py#392)(self, build_exit_status, ninja_log_outdir=None, ninja_log_compiler=None, ninja_log_command=None, build_step_name='', \*\*kwargs):**
...
&mdash; **def [BuildAndTest](/scripts/slave/recipes/dart/flutter_engine.py#305)(api, start_dir, checkout_dir, flutter_rev):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/dart/flutter_engine.py#284)(api):**
...
&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#232)(api):**

&mdash; **def [Build](/scripts/slave/recipes/flutter/engine.py#52)(api, config, \*targets):**

&mdash; **def [BuildFuchsia](/scripts/slave/recipes/flutter/engine.py#439)(api):**

&mdash; **def [BuildFuchsiaArtifactsAndUpload](/scripts/slave/recipes/flutter/engine.py#71)(api):**

&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#634)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#751)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#400)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#279)(api, swarming_task_id):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#461)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#781)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#669)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#798)(api):**

&mdash; **def [GetCloudMavenPath](/scripts/slave/recipes/flutter/engine.py#126)(api, artifact_filename):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#45)(api, path):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallGems](/scripts/slave/recipes/flutter/engine.py#766)(api):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#223)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#556)(api, label, arm64_out, armv7_out, sim_out, bucket_name):**

&mdash; **def [RunGN](/scripts/slave/recipes/flutter/engine.py#90)(api, \*args):**

&mdash; **def [RunIOSTests](/scripts/slave/recipes/flutter/engine.py#623)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#819)(api, properties, env_properties):**

&mdash; **def [RunTests](/scripts/slave/recipes/flutter/engine.py#63)(api, out_dir, android_out_dir=None, types='all'):**

&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#454)(api):**

&mdash; **def [ShouldUploadPackages](/scripts/slave/recipes/flutter/engine.py#42)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#444)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#108)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#182)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#208)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#190)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#164)(api, dir_label, parent_dir, folder_name, zip_name, platform=None):**

&mdash; **def [UploadMavenArtifacts](/scripts/slave/recipes/flutter/engine.py#149)(api, artifacts):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#252)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [UploadWebSdk](/scripts/slave/recipes/flutter/engine.py#215)(api, archive_name):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#241)(api):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2d6b67c590bc21568b1165f36102605d736c9dc1/recipes/README.recipes.md#recipe_modules-windows_sdk
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/e15c164ce655619b0f7ca5cabb1da02134b43a92/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/e15c164ce655619b0f7ca5cabb1da02134b43a92/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/e15c164ce655619b0f7ca5cabb1da02134b43a92/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/e15c164ce655619b0f7ca5cabb1da02134b43a92/recipe_engine/util.py#135
