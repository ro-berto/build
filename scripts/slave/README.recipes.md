...
&mdash; **def [AddFiles](/scripts/slave/recipes/flutter/engine.py#113)(api, pkg, relative_paths):**

&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#199)(api):**

&mdash; **def [Build](/scripts/slave/recipes/flutter/engine.py#41)(api, config, \*targets):**

&mdash; **def [BuildFuchsia](/scripts/slave/recipes/flutter/engine.py#345)(api):**

&mdash; **def [BuildFuchsiaArtifactsAndUpload](/scripts/slave/recipes/flutter/engine.py#88)(api):**

&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#525)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#628)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#306)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#245)(api):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#382)(api):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#655)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#563)(api):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#671)(api):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#34)(api, path):**

&mdash; **def [GetMacSDKDir](/scripts/slave/recipes/flutter/engine.py#367)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallJazzy](/scripts/slave/recipes/flutter/engine.py#643)(api):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#190)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#454)(api, label, arm64_out, armv7_out, sim_out, bucket_name):**

&mdash; **def [RunGN](/scripts/slave/recipes/flutter/engine.py#98)(api, \*args):**

&mdash; **def [RunHostTests](/scripts/slave/recipes/flutter/engine.py#52)(api, out_dir, exe_extension=''):**

&mdash; **def [RunIOSTests](/scripts/slave/recipes/flutter/engine.py#519)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#689)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#370)(api):**

&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#350)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#118)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#149)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#175)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#157)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#132)(api, dir_label, parent_dir, folder_name, zip_name, platform=None):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#219)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [UploadWebSdk](/scripts/slave/recipes/flutter/engine.py#182)(api, archive_name):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#208)(api):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/6ab53d93e90c81d2192866d33bb0b54996a9da3b/recipes/README.recipes.md#recipe_modules-gerrit
