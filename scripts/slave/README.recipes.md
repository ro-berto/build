...
#### **class [ClangCoverageApi](/scripts/slave/recipe_modules/clang_coverage/api.py#16)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

This module contains apis to interact with llvm-cov and llvm-profdata.

&emsp; **@property**<br>&mdash; **def [cov\_executable](/scripts/slave/recipe_modules/clang_coverage/api.py#66)(self):**

Returns the path to the llvm-cov executable.

&mdash; **def [instrument](/scripts/slave/recipe_modules/clang_coverage/api.py#132)(self, affected_files):**
...
&emsp; **@property**<br>&mdash; **def [metadata\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#78)(self):**

A temporary directory for the metadata. Created on first access.

&mdash; **def [process\_coverage\_data](/scripts/slave/recipe_modules/clang_coverage/api.py#152)(self, tests):**
...
&mdash; **def [profdata\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#85)(self, step_name=None):**
...
&emsp; **@property**<br>&mdash; **def [profdata\_executable](/scripts/slave/recipe_modules/clang_coverage/api.py#61)(self):**

Returns the path to the llvm-profdata executable.

&emsp; **@property**<br>&mdash; **def [raw\_profile\_merge\_script](/scripts/slave/recipe_modules/clang_coverage/api.py#48)(self):**
...
&emsp; **@property**<br>&mdash; **def [report\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#71)(self):**

A temporary directory to save a report to. Created on first access.

&mdash; **def [shard\_merge](/scripts/slave/recipe_modules/clang_coverage/api.py#216)(self, step_name):**

Returns a merge object understood by the swarming module.

See the docstring for the `merge` parameter of api.swarming.task.

&emsp; **@property**<br>&mdash; **def [using\_coverage](/scripts/slave/recipe_modules/clang_coverage/api.py#109)(self):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/171c07458e2f624b26c3f82d70e51676ffa9a31f/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/0c993cb828b335e2fc0528c149f8060c35ebf0ac/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/0c993cb828b335e2fc0528c149f8060c35ebf0ac/README.recipes.md#recipe_modules-led
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/0c993cb828b335e2fc0528c149f8060c35ebf0ac/recipe_engine/util.py#132
