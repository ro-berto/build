...
&mdash; **def [apply\_bot\_config](/scripts/slave/recipe_modules/webrtc/api.py#53)(self, builders, recipe_configs):**
...
&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/webrtc/api.py#99)(self):**

&mdash; **def [download\_audio\_quality\_tools](/scripts/slave/recipe_modules/webrtc/api.py#157)(self):**
...
&mdash; **def [setup\_aosp\_builder](/scripts/slave/recipes/art.py#401)(api, read_barrier):**
...
&mdash; **def [setup\_target](/scripts/slave/recipes/art.py#213)(api, serial, debug, device, concurrent_collector=True, heap_poisoning=False, gcstress=False):**
