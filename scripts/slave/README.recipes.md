...
&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/chromium_swarming/api.py#1701)(self, project_name, precommit, mastername=None, default_priority=None, path_to_testing_dir=None):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/chromium_swarming/api.py#1652)(self, task):**

SwarmingTask -> argument list for go swarming command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/chromium_swarming/api.py#1469)(self, prefix, task):**
...
&mdash; **def [wait\_for\_finished\_task\_set](/scripts/slave/recipe_modules/chromium_swarming/api.py#1389)(self, task_sets, suffix=None, attempts=0):**
...
&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#538)(self, builder_id, update_step, bot_config):**
...
&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#355)(self, bot_config, update_step, build_config, compile_targets, tests_including_triggered, builder_id=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=False, override_bot_type=None):**
...
&mdash; **def [create\_test\_runner](/scripts/slave/recipe_modules/chromium_tests/api.py#272)(self, tests, suffix='', serialize_tests=False, retry_failed_shards=False, retry_invalid_shards=False):**
...
&mdash; **def [deapply\_deps](/scripts/slave/recipe_modules/chromium_tests/api.py#1200)(self, bot_update_step):**

&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#771)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#653)(self, builder_id, update_step, bot_config, build_archive_url=None, build_revision=None, override_bot_type=None, read_gn_args=True):**

&mdash; **def [generate\_tests\_from\_source\_side\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#245)(self, source_side_spec, bot_spec, buildername, mastername, swarming_dimensions, scripts_compile_targets, bot_update_step):**

&mdash; **def [get\_android\_version\_details](/scripts/slave/recipe_modules/chromium_tests/api.py#325)(self, bot_config, log_details=False):**

&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#951)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#985)(self, bot_config=None):**
...
&mdash; **def [inbound\_transfer](/scripts/slave/recipe_modules/chromium_tests/api.py#1127)(self, bot, bot_update_step, build_config):**
...
&mdash; **def [integration\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1223)(self, builders=None, bots=None):**

&mdash; **def [log](/scripts/slave/recipe_modules/chromium_tests/api.py#114)(self, message):**

&mdash; **def [lookup\_bot\_metadata](/scripts/slave/recipe_modules/chromium_tests/api.py#1357)(self, builders=None, mirrored_bots=None):**

&mdash; **def [lookup\_builder\_gn\_args](/scripts/slave/recipe_modules/chromium_tests/api.py#1620)(self, bot_meta_data, mb_config_path=None, mb_phase=None, builders=None):**

&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1017)(self, mb_config_path=None, mb_phase=None, builders=None):**
...
&mdash; **def [outbound\_transfer](/scripts/slave/recipe_modules/chromium_tests/api.py#1072)(self, bot, bot_update_step, build_config):**
...
&mdash; **def [package\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#467)(self, builder_id, update_step, bot_config, reasons=None):**
...
&mdash; **def [prepare\_checkout](/scripts/slave/recipe_modules/chromium_tests/api.py#227)(self, bot_config, \*\*kwargs):**

&mdash; **def [read\_source\_side\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#260)(self, source_side_spec_file):**
...
&mdash; **def [run\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#1645)(self, bot_meta_data, tests):**

&mdash; **def [run\_tests\_with\_and\_without\_changes](/scripts/slave/recipe_modules/chromium_tests/api.py#1245)(self, builders, mirrored_bots, deapply_changes, tests=None):**
...
&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium_tests/api.py#216)(self, update_step):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1228)(self, builders=None, trybots=None):**

&mdash; **def [trybot\_steps\_for\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#1234)(self, builders=None, trybots=None, tests=None):**
...
&mdash; **def [AddFiles](/scripts/slave/recipes/flutter/engine.py#203)(api, pkg, relative_paths):**

&mdash; **def [AnalyzeDartUI](/scripts/slave/recipes/flutter/engine.py#375)(api):**

&mdash; **def [Build](/scripts/slave/recipes/flutter/engine.py#73)(api, config, \*targets):**

&mdash; **def [BuildAndTestFuchsia](/scripts/slave/recipes/flutter/engine.py#154)(api, build_script, git_rev):**

&mdash; **def [BuildFontSubset](/scripts/slave/recipes/flutter/engine.py#54)(api):**

&mdash; **def [BuildFuchsia](/scripts/slave/recipes/flutter/engine.py#810)(api):**
...
&mdash; **def [BuildIOS](/scripts/slave/recipes/flutter/engine.py#1131)(api):**

&mdash; **def [BuildJavadoc](/scripts/slave/recipes/flutter/engine.py#1297)(api):**

&mdash; **def [BuildLinux](/scripts/slave/recipes/flutter/engine.py#587)(api):**

&mdash; **def [BuildLinuxAndroid](/scripts/slave/recipes/flutter/engine.py#436)(api, swarming_task_id):**

&mdash; **def [BuildMac](/scripts/slave/recipes/flutter/engine.py#899)(api):**

&mdash; **def [BuildNoGoma](/scripts/slave/recipes/flutter/engine.py#85)(api, config, \*targets):**

&mdash; **def [BuildObjcDoc](/scripts/slave/recipes/flutter/engine.py#1362)(api):**

Builds documentation for the Objective-C variant of engine.

&mdash; **def [BuildWindows](/scripts/slave/recipes/flutter/engine.py#1195)(api):**

&mdash; **def [CancelBuilds](/scripts/slave/recipes/flutter/engine.py#115)(api, builds):**

&mdash; **def [CollectBuilds](/scripts/slave/recipes/flutter/engine.py#120)(api, builds):**

&mdash; **def [DownloadFuchsiaSystemImage](/scripts/slave/recipes/flutter/engine.py#649)(api, target_dir, bucket_name, build_id, image_name):**

&mdash; **def [GetCheckout](/scripts/slave/recipes/flutter/engine.py#1380)(api):**

&mdash; **def [GetCheckoutPath](/scripts/slave/recipes/flutter/engine.py#58)(api):**

&mdash; **def [GetCloudMavenPath](/scripts/slave/recipes/flutter/engine.py#226)(api, artifact_filename, swarming_task_id):**

&mdash; **def [GetCloudPath](/scripts/slave/recipes/flutter/engine.py#66)(api, path):**

&mdash; **def [GetFlutterFuchsiaBuildTargets](/scripts/slave/recipes/flutter/engine.py#125)(product, include_test_targets=False):**

&mdash; **def [GetFuchsiaBuildId](/scripts/slave/recipes/flutter/engine.py#640)(api):**

&mdash; **def [GetFuchsiaOutputDirs](/scripts/slave/recipes/flutter/engine.py#141)(product, build_mode, target_arch):**

&mdash; **def [GetFuchsiaOutputFiles](/scripts/slave/recipes/flutter/engine.py#132)(product):**

&mdash; **def [GetRemoteFileName](/scripts/slave/recipes/flutter/engine.py#740)(exec_path):**

&emsp; **@contextmanager**<br>&mdash; **def [InstallGems](/scripts/slave/recipes/flutter/engine.py#1341)(api):**

&mdash; **def [IsolateFuchsiaTestArtifacts](/scripts/slave/recipes/flutter/engine.py#656)(api, checkout, fuchsia_tools, image_name, fuchsia_test_script):**
...
&mdash; **def [LintAndroidHost](/scripts/slave/recipes/flutter/engine.py#427)(api):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [MakeTempDir](/scripts/slave/recipes/flutter/engine.py#366)(api, label):**

&mdash; **def [PackageIOSVariant](/scripts/slave/recipes/flutter/engine.py#1042)(api, label, arm64_out, armv7_out, sim_out, bucket_name, strip_bitcode=False):**

&mdash; **def [PackageWindowsDesktopVariant](/scripts/slave/recipes/flutter/engine.py#1178)(api, label, bucket_name):**

&mdash; **def [RunGN](/scripts/slave/recipes/flutter/engine.py#173)(api, \*args):**

&mdash; **def [RunGNBitcode](/scripts/slave/recipes/flutter/engine.py#181)(api, \*args):**

&mdash; **def [RunIOSTests](/scripts/slave/recipes/flutter/engine.py#1119)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/flutter/engine.py#1402)(api, properties, env_properties):**
...
&emsp; **@contextmanager**<br>&mdash; **def [SetupMacOSSDK](/scripts/slave/recipes/flutter/engine.py#1321)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [SetupXcode](/scripts/slave/recipes/flutter/engine.py#891)(api):**

&mdash; **def [ShouldUploadPackages](/scripts/slave/recipes/flutter/engine.py#62)(api):**

&mdash; **def [TestFuchsia](/scripts/slave/recipes/flutter/engine.py#693)(api):**
...
&mdash; **def [TestObservatory](/scripts/slave/recipes/flutter/engine.py#880)(api):**

&mdash; **def [UploadArtifacts](/scripts/slave/recipes/flutter/engine.py#208)(api, platform, file_paths, archive_name='artifacts.zip'):**

&mdash; **def [UploadDartPackage](/scripts/slave/recipes/flutter/engine.py#290)(api, package_name):**

&mdash; **def [UploadDartSdk](/scripts/slave/recipes/flutter/engine.py#347)(api, archive_name):**

&mdash; **def [UploadFlutterPatchedSdk](/scripts/slave/recipes/flutter/engine.py#322)(api):**

&mdash; **def [UploadFolder](/scripts/slave/recipes/flutter/engine.py#268)(api, dir_label, parent_dir, folder_name, zip_name, platform=None):**

&mdash; **def [UploadFuchsiaDebugSymbols](/scripts/slave/recipes/flutter/engine.py#785)(api):**

&mdash; **def [UploadFuchsiaDebugSymbolsToSymbolServer](/scripts/slave/recipes/flutter/engine.py#751)(api, arch, symbol_dirs):**
...
&mdash; **def [UploadMavenArtifacts](/scripts/slave/recipes/flutter/engine.py#250)(api, artifacts, swarming_task_id):**

&mdash; **def [UploadSkyEngineDartPackage](/scripts/slave/recipes/flutter/engine.py#317)(api):**

&mdash; **def [UploadSkyEngineToCIPD](/scripts/slave/recipes/flutter/engine.py#299)(api, package_name):**

&mdash; **def [UploadTreeMap](/scripts/slave/recipes/flutter/engine.py#395)(api, upload_dir, lib_flutter_path, android_triple):**

&mdash; **def [UploadWebSdk](/scripts/slave/recipes/flutter/engine.py#356)(api, archive_name):**

&mdash; **def [VerifyExportedSymbols](/scripts/slave/recipes/flutter/engine.py#384)(api):**
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/8d094c42eda98ce18f2f09c95ab3c0c75f9abb07/README.recipes.md#recipe_modules-generator_script
[recipe_engine/recipe_modules/isolated]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/8d094c42eda98ce18f2f09c95ab3c0c75f9abb07/README.recipes.md#recipe_modules-isolated
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/8d094c42eda98ce18f2f09c95ab3c0c75f9abb07/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/resultdb]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/8d094c42eda98ce18f2f09c95ab3c0c75f9abb07/README.recipes.md#recipe_modules-resultdb
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/8d094c42eda98ce18f2f09c95ab3c0c75f9abb07/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/recipe_modules/tricium]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/8d094c42eda98ce18f2f09c95ab3c0c75f9abb07/README.recipes.md#recipe_modules-tricium
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/8d094c42eda98ce18f2f09c95ab3c0c75f9abb07/recipe_engine/util.py#135
