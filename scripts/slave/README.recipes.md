...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#668)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#550)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None):**
...
&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#761)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#287)(self, bot_config, bot_db, tests):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#801)(self, bot_config=None):**
...
&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#833)(self, mb_config_path=None, bot_config=None):**
...
&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#530)(self, compile_targets, isolated_targets, name_suffix, mb_mastername=None, mb_buildername=None, mb_config_path=None):**

&mdash; **def [run\_tests\_on\_tryserver](/scripts/slave/recipe_modules/chromium_tests/api.py#680)(self, bot_config, tests, bot_update_step, affected_files, mb_mastername=None, mb_buildername=None, disable_deapply_patch=False):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#862)(self):**

&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#44)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#604)(self, bot_config, tests=None):**
...
&mdash; **def [build](/scripts/slave/recipe_modules/cronet/api.py#56)(self, targets=None, use_revision=True, use_goma=True):**

&mdash; **def [get\_version](/scripts/slave/recipe_modules/cronet/api.py#73)(self):**
...
&mdash; **def [run\_perf\_tests](/scripts/slave/recipe_modules/cronet/api.py#130)(self):**

&mdash; **def [run\_tests](/scripts/slave/recipe_modules/cronet/api.py#111)(self, build_config, unit_tests=UNIT_TESTS, instrumentation_tests=INSTRUMENTATION_TESTS):**

&mdash; **def [sizes](/scripts/slave/recipe_modules/cronet/api.py#99)(self, perf_id):**

&mdash; **def [upload\_package](/scripts/slave/recipe_modules/cronet/api.py#79)(self, build_config, cronetdir=None, platform='android'):**
...
&mdash; **def [bootstrap\_swarming](/scripts/slave/recipe_modules/ios/api.py#530)(self):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#870)(self, tasks, upload_test_results=True):**
...
&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#1040)(self, path):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#537)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#677)(self, scripts_dir='src/ios/build/bots/scripts'):**
...
&mdash; **def [isolate\_test](/scripts/slave/recipe_modules/ios/api.py#554)(self, test, tmp_dir, isolate_template, test_cases=None, shard_num=None):**

Isolates a single test.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#1125)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#1112)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#1140)(self):**
...
&mdash; **def [symupload](/scripts/slave/recipe_modules/ios/api.py#454)(self, artifact, url):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#1089)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True):**

Runs tests on Swarming as instructed by this bot's build config.

&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#776)(self, tasks):**

Triggers the given Swarming tasks.

&mdash; **def [upload](/scripts/slave/recipe_modules/ios/api.py#500)(self, base_path=None):**

Uploads built artifacts as instructed by this bot's build config.

&mdash; **def [upload\_tgz](/scripts/slave/recipe_modules/ios/api.py#469)(self, artifact, bucket, path):**
...
&mdash; **def [setup\_aosp\_builder](/scripts/slave/recipes/art.py#393)(api, read_barrier):**
...
&mdash; **def [setup\_target](/scripts/slave/recipes/art.py#205)(api, serial, debug, device, concurrent_collector=True, heap_poisoning=False, gcstress=False):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/pdfium.py#204)(api, memory_tool, skia, xfa, v8, target_cpu, clang, msvc, rel, skip_test, target_os):**

&mdash; **def [dict\_to\_str](/scripts/slave/recipes/pdfium.py#254)(props):**

Returns the given dictionary as a string of space
separated key/value pairs sorted by keys.

&mdash; **def [get\_gold\_ignore\_hashes](/scripts/slave/recipes/pdfium.py#289)(api, out_dir):**
...
&mdash; **def [get\_gold\_params](/scripts/slave/recipes/pdfium.py#220)(api, build_config, revision):**
...
&mdash; **def [gold\_build\_config](/scripts/slave/recipes/pdfium.py#263)(args):**
...
&mdash; **def [gs\_cp](/scripts/slave/recipes/pdfium.py#392)(api, name, src, dst, multithreaded=False, extra_args=None):**

Copy the src to dst in Google storage.

&mdash; **def [upload\_dm\_results](/scripts/slave/recipes/pdfium.py#344)(api, results_dir, revision):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/df27bf6f0034ac718433f8c745f9229514aca960/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/buildbucket]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/08d3beff2085cf4a5e1c62188c45eb0cb42d3833/README.recipes.md#recipe_modules-buildbucket
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/08d3beff2085cf4a5e1c62188c45eb0cb42d3833/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/08d3beff2085cf4a5e1c62188c45eb0cb42d3833/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/08d3beff2085cf4a5e1c62188c45eb0cb42d3833/recipe_engine/util.py#120
