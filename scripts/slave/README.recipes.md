...
&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#506)(self, mastername, buildername, update_step, bot_db):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#752)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#627)(self, mastername, buildername, update_step, bot_db, build_archive_url=None, build_revision=None, override_bot_type=None, read_gn_args=True):**
...
&mdash; **def [package\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#448)(self, mastername, buildername, update_step, bot_db):**
...
&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#605)(self, compile_targets, isolated_targets, name_suffix, mb_mastername=None, mb_buildername=None, mb_config_path=None, android_version_code=None, android_version_name=None):**
...
&mdash; **def [trigger\_child\_builds](/scripts/slave/recipe_modules/chromium_tests/api.py#537)(self, mastername, buildername, update_step, bot_db, additional_properties=None):**

&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1155)(self, builders=None, trybots=None):**

&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#43)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#686)(self, bot_config, tests=None):**
### *recipe_modules* / [clang\_coverage](/scripts/slave/recipe_modules/clang_coverage)

[DEPS](/scripts/slave/recipe_modules/clang_coverage/__init__.py#5): [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/gsutil][depot_tools/recipe_modules/gsutil], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python]
...
&mdash; **def [create\_report](/scripts/slave/recipe_modules/clang_coverage/api.py#89)(self):**
...
&mdash; **def [profdata\_dir](/scripts/slave/recipe_modules/clang_coverage/api.py#55)(self, step_name=None):**
...
&emsp; **@property**<br>&mdash; **def [profdata\_executable](/scripts/slave/recipe_modules/clang_coverage/api.py#48)(self):**

Returns the path to the llvm-profdata deployed by gclient hooks.

&emsp; **@property**<br>&mdash; **def [raw\_profile\_merge\_script](/scripts/slave/recipe_modules/clang_coverage/api.py#39)(self):**
...
&mdash; **def [shard\_merge](/scripts/slave/recipe_modules/clang_coverage/api.py#110)(self, step_name):**

Returns a merge object understood by the swarming module.

See the docstring for the `merge` parameter of api.swarming.task.

&emsp; **@property**<br>&mdash; **def [using\_coverage](/scripts/slave/recipe_modules/clang_coverage/api.py#79)(self):**
...
&mdash; **def [collect\_all](/scripts/slave/recipe_modules/dart/api.py#214)(self, deferred_tasks):**

Collects the results of a sharded test run.

&mdash; **def [dart\_executable](/scripts/slave/recipe_modules/dart/api.py#87)(self):**

&mdash; **def [deflake\_results](/scripts/slave/recipe_modules/dart/api.py#272)(self, step_name, args, environment):**

&mdash; **def [download\_parent\_isolate](/scripts/slave/recipe_modules/dart/api.py#142)(self):**

&mdash; **def [download\_results](/scripts/slave/recipe_modules/dart/api.py#256)(self, name):**
...
&mdash; **def [present\_results](/scripts/slave/recipe_modules/dart/api.py#351)(self, step_name):**

&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#392)(self):**

Reads the debug.log file

&mdash; **def [read\_result\_file](/scripts/slave/recipe_modules/dart/api.py#373)(self, name, log_name, test_data=''):**
...
&mdash; **def [report\_new\_results](/scripts/slave/recipe_modules/dart/api.py#200)(self):**
...
&mdash; **def [run\_new\_steps](/scripts/slave/recipe_modules/dart/api.py#207)(self):**

Boolean that controls whther to run the new
workflow that uploads test results to cloud
storage and deflakes changed tests.

&mdash; **def [run\_script](/scripts/slave/recipe_modules/dart/api.py#721)(self, step_name, script, args, isolate_hash, shards, local_shard, environment, tasks, cipd_packages=None, ignore_failure=False):**
...
&mdash; **def [run\_test\_py](/scripts/slave/recipe_modules/dart/api.py#637)(self, step_name, append_logs, step, isolate_hash, shards, local_shard, environment, tasks, global_config):**
...
&mdash; **def [run\_trigger](/scripts/slave/recipe_modules/dart/api.py#601)(self, step_name, step, isolate_hash):**

&mdash; **def [shard](/scripts/slave/recipe_modules/dart/api.py#156)(self, title, isolate_hash, test_args, os=None, cpu='x86-64', pool='dart.tests', num_shards=0, last_shard_is_local=False, cipd_packages=None, ignore_failure=False):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#403)(self, test_data):**
...
&mdash; **def [upload\_isolate](/scripts/slave/recipe_modules/dart/api.py#122)(self, isolate_fileset):**

Builds an isolate

&mdash; **def [upload\_results](/scripts/slave/recipe_modules/dart/api.py#307)(self, name):**
...
&mdash; **def [get\_perftest\_data](/scripts/slave/recipe_modules/ios/api.py#1137)(self, path):**
...
&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#1222)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#1209)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#1237)(self):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#1186)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#446)(self):**

&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#864)(self):**

Absolute path to the build product based on the 'checkout' path.

&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1458)(self, bucket, changes, requests, step_name='trigger', service_account='v8-bot', no_buildset=False):**
...
&emsp; **@property**<br>&mdash; **def [builderset](/scripts/slave/recipe_modules/v8/api.py#454)(self):**

Returns a list of names of this builder and all its triggered testers.

&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1598)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#386)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#328)(self, revision=None, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#703)(self, test_spec=v8_builders.EmptyTestSpec, mb_config_path=None, out_dir=None, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#959)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#965)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#972)(self):**

&mdash; **def [dedupe\_tests](/scripts/slave/recipe_modules/v8/api.py#501)(self, high_prec_tests, low_prec_tests):**
...
&mdash; **def [download\_build](/scripts/slave/recipe_modules/v8/api.py#844)(self, name_suffix='', archive=None):**

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#852)(self, revision):**

&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1218)(self):**

&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#483)(self):**

Returns runnable testing.BaseTest objects for each extra test specified
by parent_test_spec property.

&mdash; **def [extra\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#492)(self, test_spec):**
...
&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#869)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#955)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1574)(self, bisect_range):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1517)(self):**

&mdash; **def [get\_changes](/scripts/slave/recipe_modules/v8/api.py#1452)(self):**
...
&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#873)(self):**

Delete all gcov counter files.

&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#975)(self):**

&emsp; **@property**<br>&mdash; **def [isolate\_targets](/scripts/slave/recipe_modules/v8/api.py#561)(self):**

Returns the isolate targets statically known from builders.py.

&mdash; **def [isolate\_targets\_from\_tests](/scripts/slave/recipe_modules/v8/api.py#541)(self, tests):**
...
&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#586)(self, isolate_targets, out_dir=None):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1620)(self, available_bisect_range):**
...
&mdash; **def [parse\_revision\_props](/scripts/slave/recipe_modules/v8/api.py#363)(self, got_revision, got_revision_cp=None):**
...
&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#507)(self, root):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1636)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1645)(self, ref, step_name_desc):**

Read and return the version at a paricular ref.

&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#479)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1625)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#437)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#980)(self, tests):**

&mdash; **def [set\_gclient\_custom\_deps](/scripts/slave/recipe_modules/v8/api.py#303)(self, custom_deps):**

Configures additional gclient custom_deps to be synced.

&mdash; **def [set\_gclient\_custom\_var](/scripts/slave/recipe_modules/v8/api.py#294)(self, var_name):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#402)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#462)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/v8/api.py#475)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#466)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#470)(self):**

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1244)(self):**

&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#308)(self):**
...
&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#883)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1649)(blob):**
...
[DEPS](/scripts/slave/recipe_modules/clang_coverage/tests/full.py#7): [clang\_coverage](#recipe_modules-clang_coverage), [recipe\_engine/properties][recipe_engine/recipe_modules/properties]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/clang_coverage/tests/full.py#13)(api):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/98f1e59b41c6c580cd168ac4456bf27d78c12a95/recipes/README.recipes.md#recipe_modules-gerrit
