...
#### **class [ChromiumTestsApi](/scripts/slave/recipe_modules/chromium_tests/api.py#74)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [add\_builders](/scripts/slave/recipe_modules/chromium_tests/api.py#93)(self, builders):**
...
&emsp; **@property**<br>&mdash; **def [builders](/scripts/slave/recipe_modules/chromium_tests/api.py#81)(self):**

&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#400)(self, bot_config, update_step, bot_db, compile_targets, tests_including_triggered, mb_mastername=None, mb_buildername=None, mb_config_path=None, override_bot_type=None):**
...
&mdash; **def [configure\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#125)(self, bot_config, override_bot_type=None):**

&mdash; **def [create\_bot\_config\_object](/scripts/slave/recipe_modules/chromium_tests/api.py#97)(self, mastername, buildername, builders=None):**

&mdash; **def [create\_bot\_db\_from\_master\_dict](/scripts/slave/recipe_modules/chromium_tests/api.py#225)(self, mastername, master_dict):**

&mdash; **def [create\_bot\_db\_object](/scripts/slave/recipe_modules/chromium_tests/api.py#104)(self):**

&mdash; **def [create\_generalized\_bot\_config\_object](/scripts/slave/recipe_modules/chromium_tests/api.py#101)(self, bot_ids):**

&mdash; **def [create\_test\_runner](/scripts/slave/recipe_modules/chromium_tests/api.py#277)(self, tests, suffix='', serialize_tests=False):**
...
&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#706)(self, bot_update_step):**
...
&mdash; **def [generate\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#250)(self, test_spec, builder_dict, buildername, mastername, enable_swarming, swarming_dimensions, scripts_compile_targets, generators, bot_update_step, bot_config):**

&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#799)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#375)(self, bot_config, bot_db, tests):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#839)(self, bot_config=None):**
...
&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium_tests/api.py#122)(self):**

&mdash; **def [get\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#366)(self, bot_config, bot_db):**

Returns a tuple: list of tests, and list of tests on the triggered
testers.

&mdash; **def [is\_precommit\_mode](/scripts/slave/recipe_modules/chromium_tests/api.py#115)(self):**
...
&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#871)(self, mb_config_path=None, bot_config=None):**

&mdash; **def [prepare\_checkout](/scripts/slave/recipe_modules/chromium_tests/api.py#230)(self, bot_config, root_solution_revision=None, disable_syntax_validation=False):**
...
&mdash; **def [run\_tests\_on\_tryserver](/scripts/slave/recipe_modules/chromium_tests/api.py#718)(self, bot_config, tests, bot_update_step, affected_files, mb_mastername=None, mb_buildername=None, disable_deapply_patch=False):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium_tests/api.py#211)(self, update_step):**

&mdash; **def [set\_precommit\_mode](/scripts/slave/recipe_modules/chromium_tests/api.py#107)(self):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/chromium_tests/api.py#199)(self, bot_config):**

&emsp; **@property**<br>&mdash; **def [steps](/scripts/slave/recipe_modules/chromium_tests/api.py#85)(self):**

&mdash; **def [transient\_check](/scripts/slave/recipe_modules/chromium_tests/api.py#382)(self, update_step, command):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#899)(self):**

&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#89)(self):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/dart/api.py#141)(self, tasks):**

Collects the results of a sharded test run.

&mdash; **def [collect\_all](/scripts/slave/recipe_modules/dart/api.py#158)(self, deferred_tasks):**

Collects the results of a sharded test run.

&mdash; **def [download\_parent\_isolate](/scripts/slave/recipe_modules/dart/api.py#87)(self):**

&mdash; **def [kill\_tasks](/scripts/slave/recipe_modules/dart/api.py#22)(self):**

Kills leftover tasks from previous runs or steps.

&mdash; **def [read\_debug\_log](/scripts/slave/recipe_modules/dart/api.py#193)(self):**

Reads the debug.log file

&mdash; **def [read\_result\_file](/scripts/slave/recipe_modules/dart/api.py#174)(self, name, log_name, test_data=''):**
...
&mdash; **def [run\_script](/scripts/slave/recipe_modules/dart/api.py#438)(self, step_name, script, args, isolate_hash, shards, local_shard, environment, tasks):**
...
&mdash; **def [run\_test\_py](/scripts/slave/recipe_modules/dart/api.py#395)(self, step_name, append_logs, step, isolate_hash, shards, local_shard, environment, tasks):**
...
&mdash; **def [run\_trigger](/scripts/slave/recipe_modules/dart/api.py#361)(self, step_name, step, isolate_hash):**

&mdash; **def [shard](/scripts/slave/recipe_modules/dart/api.py#103)(self, title, isolate_hash, test_args, os=None, cpu='x86-64', pool='Dart.LUCI', num_shards=0, last_shard_is_local=False):**
...
&mdash; **def [test](/scripts/slave/recipe_modules/dart/api.py#204)(self, test_data):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/dart/examples/example.py#112)(api):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/bf7e8d8a50010c241aadd724b5c04c860542556d/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/458606ee71924034a3b2c49bbacdac131e59237f/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/458606ee71924034a3b2c49bbacdac131e59237f/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/458606ee71924034a3b2c49bbacdac131e59237f/recipe_engine/util.py#119
