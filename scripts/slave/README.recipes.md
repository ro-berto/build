...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1498)(self, step_name, gs_bucket, gs_acl=None, mode=None, build_name=None, \*\*kwargs):**
...
&mdash; **def [clean\_outdir](/scripts/slave/recipe_modules/chromium/api.py#1544)(self):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#1009)(self):**

Add an explicit clobber step if requested.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [compile](/scripts/slave/recipe_modules/chromium/api.py#471)(self, targets=None, name=None, out_dir=None, target=None, use_goma_module=False, \*\*kwargs):**
...
&mdash; **def [delete\_old\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#960)(self):**
...
&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/chromium/api.py#926)(self, client_type='release'):**

&mdash; **def [ensure\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#969)(self):**

&mdash; **def [ensure\_toolchains](/scripts/slave/recipe_modules/chromium/api.py#1005)(self):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1541)(self, _):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [get\_clang\_version](/scripts/slave/recipe_modules/chromium/api.py#874)(self, \*\*kwargs):**

&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium/api.py#85)(self):**

&mdash; **def [get\_cros\_chrome\_sdk\_wrapper](/scripts/slave/recipe_modules/chromium/api.py#891)(self):**
...
&mdash; **def [get\_mac\_toolchain\_installer](/scripts/slave/recipe_modules/chromium/api.py#946)(self):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_analyze](/scripts/slave/recipe_modules/chromium/api.py#1237)(self, mastername, buildername, analyze_input, name=None, mb_path=None, mb_config_path=None, chromium_config=None, build_dir=None, phase=None, \*\*kwargs):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [mb\_failure\_handler](/scripts/slave/recipe_modules/chromium/api.py#1466)(self, name):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_gen](/scripts/slave/recipe_modules/chromium/api.py#1359)(self, mastername, buildername, name=None, mb_path=None, mb_config_path=None, use_goma=True, isolated_targets=None, build_dir=None, phase=None, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None, recursive_lookup=False, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_isolate\_everything](/scripts/slave/recipe_modules/chromium/api.py#1446)(self, mastername, buildername, use_goma=True, mb_path=None, mb_config_path=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_lookup](/scripts/slave/recipe_modules/chromium/api.py#1293)(self, mastername, buildername, name=None, mb_path=None, mb_config_path=None, recursive=False, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None):**
...
&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1486)(self, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#1058)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb\_cmd](/scripts/slave/recipe_modules/chromium/api.py#1135)(self, name, mb_command, mastername, buildername, mb_path=None, mb_config_path=None, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, additional_args=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#1019)(self, env=None, \*\*kwargs):**

Run the build-configuration hooks for chromium.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [runtest](/scripts/slave/recipe_modules/chromium/api.py#708)(self, test, args=None, xvfb=False, name=None, annotate=None, results_url=None, perf_dashboard_id=None, test_type=None, python_mode=False, point_id=None, revision=None, webkit_revision=None, test_launcher_summary_output=None, perf_id=None, perf_config=None, chartjson_file=False, use_histograms=False, tee_stdout_file=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [sizes](/scripts/slave/recipe_modules/chromium/api.py#825)(self, results_url=None, perf_id=None, platform=None, \*\*kwargs):**

Return a sizes.py invocation.
This uses runtests.py to upload the results to the perf dashboard.

&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1480)(self):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_launcher\_filter](/scripts/slave/recipe_modules/chromium/api.py#704)(self, tests):**
...
&mdash; **def [android\_build\_wrapper](/scripts/slave/recipe_modules/chromium_android/api.py#1124)(self, logcat_gs_bucket='chromium-android'):**

&mdash; **def [android\_test\_wrapper](/scripts/slave/recipe_modules/chromium_android/api.py#1141)(self, _logcat_gs_bucket='chromium-android'):**
...
&mdash; **def [common\_tests\_final\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#1103)(self, logcat_gs_bucket='chromium-android', force_latest_version=False, checkout_dir=None):**

&mdash; **def [common\_tests\_setup\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#1079)(self, perf_setup=False, \*\*provision_kwargs):**

&mdash; **def [configure\_from\_properties](/scripts/slave/recipe_modules/chromium_android/api.py#65)(self, config_name, \*\*kwargs):**

&mdash; **def [copy\_gtest\_results](/scripts/slave/recipe_modules/chromium_android/api.py#880)(self, result_step, active_step):**
...
&mdash; **def [create\_result\_details](/scripts/slave/recipe_modules/chromium_android/api.py#885)(self, step_name, json_results_file):**
...
&mdash; **def [generate\_breakpad\_symbols](/scripts/slave/recipe_modules/chromium_android/api.py#948)(self, symbols_dir, binary_path, root_chromium_dir):**
...
&mdash; **def [logcat\_dump](/scripts/slave/recipe_modules/chromium_android/api.py#913)(self, gs_bucket=None):**
...
&mdash; **def [run\_bisect\_script](/scripts/slave/recipe_modules/chromium_android/api.py#1148)(self, extra_src='', path_to_config='', \*\*kwargs):**
...
&mdash; **def [run\_test\_suite](/scripts/slave/recipe_modules/chromium_android/api.py#1164)(self, suite, verbose=True, tool=None, result_details=False, store_tombstones=False, name=None, json_results_file=None, shard_timeout=None, args=None, \*\*kwargs):**
...
&mdash; **def [stack\_tool\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#1019)(self, force_latest_version=False):**

&mdash; **def [stackwalker](/scripts/slave/recipe_modules/chromium_android/api.py#972)(self, root_chromium_dir, binary_paths):**
...
&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/chromium_swarming/api.py#1745)(self, project_name, precommit, mastername=None, default_priority=None, path_to_testing_dir=None):**
...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/chromium_swarming/api.py#1696)(self, task):**

SwarmingTask -> argument list for go swarming command.

&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/chromium_swarming/api.py#1519)(self, prefix, task):**
...
&mdash; **def [instrument](/scripts/slave/recipe_modules/code_coverage/api.py#239)(self, affected_files):**
...
&mdash; **def [process\_clang\_coverage\_data](/scripts/slave/recipe_modules/code_coverage/api.py#295)(self, tests):**
...
&mdash; **def [process\_java\_coverage\_data](/scripts/slave/recipe_modules/code_coverage/api.py#340)(self, \*\*kwargs):**
...
&mdash; **def [shard\_merge](/scripts/slave/recipe_modules/code_coverage/api.py#553)(self, step_name, additional_merge=None):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#878)(self, triggered_tests):**
...
&mdash; **def [generate\_test\_from\_task](/scripts/slave/recipe_modules/ios/api.py#842)(self, task, upload_test_results=True, result_callback=None):**
...
&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#756)(self, scripts_dir='src/ios/build/bots/scripts'):**
...
&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#953)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#940)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#968)(self):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#903)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True, retry_failed_shards=False):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/art.py#650)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/celab.py#61)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/pdfium.py#513)(api, memory_tool, skia, skia_paths, xfa, v8, target_cpu, clang, msvc, rel, component, skip_test, target_os):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/tricium_metrics.py#68)(api):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/osx_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-osx_sdk
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-tryserver
[depot_tools/recipe_modules/windows_sdk]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/41be80f6159c6c91914dbfc4dcd6b59d183f9f3b/recipes/README.recipes.md#recipe_modules-windows_sdk
[recipe_engine/recipe_modules/assertions]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/97ead225e3da23cbd18605e0f4cec0417412da64/README.recipes.md#recipe_modules-assertions
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/97ead225e3da23cbd18605e0f4cec0417412da64/README.recipes.md#recipe_modules-generator_script
[recipe_engine/recipe_modules/isolated]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/97ead225e3da23cbd18605e0f4cec0417412da64/README.recipes.md#recipe_modules-isolated
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/97ead225e3da23cbd18605e0f4cec0417412da64/README.recipes.md#recipe_modules-led
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/97ead225e3da23cbd18605e0f4cec0417412da64/README.recipes.md#recipe_modules-scheduler
[recipe_engine/recipe_modules/service_account]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/97ead225e3da23cbd18605e0f4cec0417412da64/README.recipes.md#recipe_modules-service_account
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/97ead225e3da23cbd18605e0f4cec0417412da64/README.recipes.md#recipe_modules-swarming
[recipe_engine/recipe_modules/time]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/97ead225e3da23cbd18605e0f4cec0417412da64/README.recipes.md#recipe_modules-time
[recipe_engine/recipe_modules/tricium]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/97ead225e3da23cbd18605e0f4cec0417412da64/README.recipes.md#recipe_modules-tricium
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/97ead225e3da23cbd18605e0f4cec0417412da64/recipe_engine/util.py#135
