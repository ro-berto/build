...
**[Recipes](#Recipes)**
  ...
  * [angle](#recipes-angle)
  * [angle_chromium](#recipes-angle_chromium)
  * [angle_chromium_trybot](#recipes-angle_chromium_trybot)
  ...
  * [chromium:tests/bad_config](#recipes-chromium_tests_bad_config)
  ...
  * [chromium_android:tests/read_denylist](#recipes-chromium_android_tests_read_denylist)
  ...
  * [chromium_tests:tests/api/set_swarming_command_lines](#recipes-chromium_tests_tests_api_set_swarming_command_lines)
  ...
  * [chromium_tests:tests/api/trybot_steps_analyze_autoroll](#recipes-chromium_tests_tests_api_trybot_steps_analyze_autoroll)
  ...
  * [chromium_tests:tests/steps/layout_tests_handler](#recipes-chromium_tests_tests_steps_layout_tests_handler)
  ...
  * [dawn](#recipes-dawn)
  * [devtools/devtools-backend](#recipes-devtools_devtools-backend)
...
&mdash; **def [clusterfuzz\_archive](/scripts/slave/recipe_modules/archive/api.py#173)(self, build_dir, update_properties, gs_bucket, archive_prefix, archive_subdir_suffix='', gs_acl=None, revision_dir=None, primary_project=None, bitness=None, use_legacy=True, sortkey_datetime=None, \*\*kwargs):**
...
&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/archive/api.py#346)(self, step_name, target, build_url, src_dir=None, build_revision=None, build_archive_url=None, \*\*kwargs):**
...
&mdash; **def [legacy\_download\_url](/scripts/slave/recipe_modules/archive/api.py#462)(self, gs_bucket_name, extra_url_components=None):**
...
&mdash; **def [legacy\_platform\_name](/scripts/slave/recipe_modules/archive/api.py#402)(self):**

Replicates the behavior of PlatformName() in chromium_utils.py.

&mdash; **def [legacy\_upload\_url](/scripts/slave/recipe_modules/archive/api.py#451)(self, gs_bucket_name, extra_url_components=None):**
...
#### **class [BuilderGroupApi](/scripts/slave/recipe_modules/builder_group/api.py#33)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&emsp; **@property**<br>&mdash; **def [for\_bisect](/scripts/slave/recipe_modules/builder_group/api.py#60)(self):**
...
&emsp; **@property**<br>&mdash; **def [for\_current](/scripts/slave/recipe_modules/builder_group/api.py#35)(self):**

Get the builder group for the currently running builder.

&emsp; **@property**<br>&mdash; **def [for\_parent](/scripts/slave/recipe_modules/builder_group/api.py#42)(self):**

Get the builder group for the parent builder.

&emsp; **@property**<br>&mdash; **def [for\_target](/scripts/slave/recipe_modules/builder_group/api.py#49)(self):**
...
[DEPS](/scripts/slave/recipe_modules/chromium/__init__.py#9): [adb](#recipe_modules-adb), [build](#recipe_modules-build), [builder\_group](#recipe_modules-builder_group), [chromite](#recipe_modules-chromite), [gn](#recipe_modules-gn), [goma](#recipe_modules-goma), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/depot\_tools][depot_tools/recipe_modules/depot_tools], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/git][depot_tools/recipe_modules/git], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/cipd][recipe_engine/recipe_modules/cipd], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]

#### **class [ChromiumApi](/scripts/slave/recipe_modules/chromium/api.py#47)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [apply\_config](/scripts/slave/recipe_modules/chromium/api.py#70)(self, config_name, config_object=None, \*args, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [archive\_build](/scripts/slave/recipe_modules/chromium/api.py#1573)(self, step_name, gs_bucket, gs_acl=None, mode=None, build_name=None, \*\*kwargs):**

Returns a step invoking archive_build.py to archive a Chromium build.

&emsp; **@property**<br>&mdash; **def [build\_properties](/scripts/slave/recipe_modules/chromium/api.py#160)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [chromium\_layout](/scripts/slave/recipe_modules/chromium/api.py#91)(self):**
...
&mdash; **def [clobber\_if\_needed](/scripts/slave/recipe_modules/chromium/api.py#1064)(self):**

Add an explicit clobber step if requested.

&emsp; **@_with_chromium_layout**<br>&mdash; **def [compile](/scripts/slave/recipe_modules/chromium/api.py#546)(self, targets=None, name=None, out_dir=None, target=None, use_goma_module=False, \*\*kwargs):**
...
&mdash; **def [delete\_old\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#1006)(self):**

Remove the old "hermetic" toolchain cache.

This is to expose any lingering dependencies on the old cache.

&mdash; **def [ensure\_chromium\_layout](/scripts/slave/recipe_modules/chromium/api.py#75)(self):**
...
&mdash; **def [ensure\_mac\_toolchain](/scripts/slave/recipe_modules/chromium/api.py#1015)(self):**

&mdash; **def [ensure\_toolchains](/scripts/slave/recipe_modules/chromium/api.py#1060)(self):**

&mdash; **def [get\_annotate\_by\_test\_name](/scripts/slave/recipe_modules/chromium/api.py#1626)(self, _):**

&mdash; **def [get\_builder\_id](/scripts/slave/recipe_modules/chromium/api.py#201)(self):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [get\_clang\_version](/scripts/slave/recipe_modules/chromium/api.py#951)(self, \*\*kwargs):**

&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium/api.py#116)(self):**

&mdash; **def [get\_env](/scripts/slave/recipe_modules/chromium/api.py#141)(self):**

&mdash; **def [get\_mac\_toolchain\_installer](/scripts/slave/recipe_modules/chromium/api.py#990)(self):**

&mdash; **def [get\_version](/scripts/slave/recipe_modules/chromium/api.py#169)(self):**
...
&mdash; **def [get\_version\_from\_file](/scripts/slave/recipe_modules/chromium/api.py#181)(self, version_file_path, step_name='get version'):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [guard\_compile](/scripts/slave/recipe_modules/chromium/api.py#517)(self, suffix=''):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_analyze](/scripts/slave/recipe_modules/chromium/api.py#1283)(self, builder_id, analyze_input, name=None, mb_path=None, mb_config_path=None, chromium_config=None, build_dir=None, phase=None, \*\*kwargs):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [mb\_failure\_handler](/scripts/slave/recipe_modules/chromium/api.py#1541)(self, name):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_gen](/scripts/slave/recipe_modules/chromium/api.py#1413)(self, builder_id, name=None, mb_path=None, mb_config_path=None, use_goma=True, isolated_targets=None, build_dir=None, phase=None, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None, recursive_lookup=False, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_isolate\_everything](/scripts/slave/recipe_modules/chromium/api.py#1509)(self, builder_id, use_goma=True, mb_path=None, mb_config_path=None, name=None, build_dir=None, android_version_code=None, android_version_name=None, phase=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [mb\_lookup](/scripts/slave/recipe_modules/chromium/api.py#1338)(self, builder_id, name=None, mb_path=None, mb_config_path=None, recursive=False, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, gn_args_location=None, gn_args_max_text_lines=None):**
...
&emsp; **@property**<br>&mdash; **def [output\_dir](/scripts/slave/recipe_modules/chromium/api.py#164)(self):**

Return the path to the built executable directory.

&mdash; **def [process\_dumps](/scripts/slave/recipe_modules/chromium/api.py#1561)(self, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_gn](/scripts/slave/recipe_modules/chromium/api.py#1102)(self, use_goma=False, gn_path=None, build_dir=None, \*\*kwargs):**

&emsp; **@_with_chromium_layout**<br>&mdash; **def [run\_mb\_cmd](/scripts/slave/recipe_modules/chromium/api.py#1175)(self, name, mb_command, builder_id, mb_path=None, mb_config_path=None, chromium_config=None, phase=None, use_goma=True, android_version_code=None, android_version_name=None, additional_args=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium/api.py#1074)(self, env=None, \*\*kwargs):**
...
&emsp; **@_with_chromium_layout**<br>&mdash; **def [sizes](/scripts/slave/recipe_modules/chromium/api.py#896)(self, results_url=None, perf_id=None, platform=None, \*\*kwargs):**

Return a sizes.py invocation.
This uses runtests.py to upload the results to the perf dashboard.

&mdash; **def [taskkill](/scripts/slave/recipe_modules/chromium/api.py#1555)(self):**
...
&emsp; **@property**<br>&mdash; **def [xcode\_build\_version](/scripts/slave/recipe_modules/chromium/api.py#59)(self):**
...
#### **class [AndroidApi](/scripts/slave/recipe_modules/chromium_android/api.py#21)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [adb\_install\_apk](/scripts/slave/recipe_modules/chromium_android/api.py#663)(self, apk, allow_downgrade=False, keep_data=False, devices=None):**

&mdash; **def [apk\_path](/scripts/slave/recipe_modules/chromium_android/api.py#660)(self, apk):**

&mdash; **def [authorize\_adb\_devices](/scripts/slave/recipe_modules/chromium_android/api.py#386)(self):**

&emsp; **@property**<br>&mdash; **def [blacklist\_file](/scripts/slave/recipe_modules/chromium_android/api.py#407)(self):**

&mdash; **def [clean\_local\_files](/scripts/slave/recipe_modules/chromium_android/api.py#150)(self, clean_pyc_files=True):**

&mdash; **def [common\_tests\_final\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#919)(self, force_latest_version=False, checkout_dir=None):**

&mdash; **def [common\_tests\_setup\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#908)(self, \*\*provision_kwargs):**
...
&mdash; **def [coverage\_report](/scripts/slave/recipe_modules/chromium_android/api.py#1018)(self, upload=True, \*\*kwargs):**
...
&mdash; **def [create\_result\_details](/scripts/slave/recipe_modules/chromium_android/api.py#721)(self, step_name, json_results_file):**

&emsp; **@property**<br>&mdash; **def [denylist\_file](/scripts/slave/recipe_modules/chromium_android/api.py#394)(self):**

&emsp; **@property**<br>&mdash; **def [denylist\_flag](/scripts/slave/recipe_modules/chromium_android/api.py#347)(self):**

&mdash; **def [device\_recovery](/scripts/slave/recipe_modules/chromium_android/api.py#487)(self, \*\*kwargs):**

&mdash; **def [device\_status](/scripts/slave/recipe_modules/chromium_android/api.py#500)(self, \*\*kwargs):**

&mdash; **def [device\_status\_check](/scripts/slave/recipe_modules/chromium_android/api.py#414)(self):**
...
&mdash; **def [generate\_breakpad\_symbols](/scripts/slave/recipe_modules/chromium_android/api.py#785)(self, symbols_dir, binary_path, root_chromium_dir):**
...
&mdash; **def [get\_changed\_lines\_for\_revision](/scripts/slave/recipe_modules/chromium_android/api.py#1136)(self):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [handle\_exit\_codes](/scripts/slave/recipe_modules/chromium_android/api.py#1200)(self):**

Handles exit codes emitted by the test runner and other scripts.

&mdash; **def [host\_info](/scripts/slave/recipe_modules/chromium_android/api.py#418)(self, args=None, \*\*kwargs):**

&mdash; **def [incremental\_coverage\_report](/scripts/slave/recipe_modules/chromium_android/api.py#1065)(self):**
...
&mdash; **def [init\_and\_sync](/scripts/slave/recipe_modules/chromium_android/api.py#111)(self, gclient_config='android_bare', with_branch_heads=False, use_bot_update=True, use_git_cache=True):**

&emsp; **@property**<br>&mdash; **def [known\_devices\_file](/scripts/slave/recipe_modules/chromium_android/api.py#48)(self):**

&mdash; **def [logcat\_dump](/scripts/slave/recipe_modules/chromium_android/api.py#748)(self):**
...
&mdash; **def [monkey\_test](/scripts/slave/recipe_modules/chromium_android/api.py#690)(self, \*\*kwargs):**

&mdash; **def [non\_blacklisted\_devices](/scripts/slave/recipe_modules/chromium_android/api.py#411)(self):**

&mdash; **def [non\_denylisted\_devices](/scripts/slave/recipe_modules/chromium_android/api.py#398)(self):**

&emsp; **@property**<br>&mdash; **def [out\_path](/scripts/slave/recipe_modules/chromium_android/api.py#40)(self):**

&mdash; **def [provision\_devices](/scripts/slave/recipe_modules/chromium_android/api.py#610)(self, skip_wipe=False, disable_location=False, reboot_timeout=None, emulators=False, \*\*kwargs):**
...
&mdash; **def [run\_bisect\_script](/scripts/slave/recipe_modules/chromium_android/api.py#935)(self, extra_src='', path_to_config='', \*\*kwargs):**

&mdash; **def [run\_java\_unit\_test\_suite](/scripts/slave/recipe_modules/chromium_android/api.py#992)(self, suite, target_name=None, verbose=True, json_results_file=None, suffix=None, additional_args=None, \*\*kwargs):**

&mdash; **def [run\_telemetry\_browser\_test](/scripts/slave/recipe_modules/chromium_android/api.py#702)(self, test_name, browser='android-chromium'):**

Run a telemetry browser test.

&mdash; **def [run\_test\_suite](/scripts/slave/recipe_modules/chromium_android/api.py#952)(self, suite, verbose=True, result_details=False, store_tombstones=False, name=None, json_results_file=None, shard_timeout=None, args=None, \*\*kwargs):**

&mdash; **def [run\_tree\_truth](/scripts/slave/recipe_modules/chromium_android/api.py#182)(self, additional_repos=None):**

&mdash; **def [shutdown\_device\_monitor](/scripts/slave/recipe_modules/chromium_android/api.py#375)(self):**

&mdash; **def [spawn\_device\_monitor](/scripts/slave/recipe_modules/chromium_android/api.py#364)(self):**

&mdash; **def [spawn\_logcat\_monitor](/scripts/slave/recipe_modules/chromium_android/api.py#352)(self):**

&mdash; **def [stack\_tool\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#856)(self, force_latest_version=False):**

&mdash; **def [stackwalker](/scripts/slave/recipe_modules/chromium_android/api.py#809)(self, root_chromium_dir, binary_paths):**
...
&mdash; **def [staged\_files\_matching\_filter](/scripts/slave/recipe_modules/chromium_android/api.py#1178)(self, diff_filter):**
...
&mdash; **def [test\_report](/scripts/slave/recipe_modules/chromium_android/api.py#891)(self):**

&mdash; **def [test\_runner](/scripts/slave/recipe_modules/chromium_android/api.py#1223)(self, step_name, args=None, wrapper_script_suite_name=None, pass_adb_path=True, \*\*kwargs):**
...
&mdash; **def [ensure\_checkout](/scripts/slave/recipe_modules/chromium_checkout/api.py#76)(self, bot_config=None, \*\*kwargs):**
...
&mdash; **def [download\_latest\_file](/scripts/slave/recipe_modules/chromium_gsutil/api.py#10)(self, base_url, partial_name, destination, name='Download latest file from GS'):**
...
&mdash; **def [add\_default\_tag](/scripts/slave/recipe_modules/chromium_swarming/api.py#390)(self, tag):**
...
&mdash; **def [check\_client\_version](/scripts/slave/recipe_modules/chromium_swarming/api.py#700)(self, step_test_data=None):**

Yields steps to verify compatibility with swarming_client version.

&mdash; **def [collect\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#1012)(self, task, \*\*kwargs):**
...
&mdash; **def [configure\_swarming](/scripts/slave/recipe_modules/chromium_swarming/api.py#1691)(self, project_name, precommit, builder_group=None, mastername=None, default_priority=None, path_to_testing_dir=None):**
...
&emsp; **@property**<br>&mdash; **def [default\_dimensions](/scripts/slave/recipe_modules/chromium_swarming/api.py#325)(self):**
...
&emsp; **@property**<br>&mdash; **def [default\_env](/scripts/slave/recipe_modules/chromium_swarming/api.py#348)(self):**
...
&emsp; **@default_expiration.setter**<br>&mdash; **def [default\_expiration](/scripts/slave/recipe_modules/chromium_swarming/api.py#248)(self, value):**

&emsp; **@default_hard_timeout.setter**<br>&mdash; **def [default\_hard\_timeout](/scripts/slave/recipe_modules/chromium_swarming/api.py#265)(self, value):**

&emsp; **@default_idempotent.setter**<br>&mdash; **def [default\_idempotent](/scripts/slave/recipe_modules/chromium_swarming/api.py#304)(self, value):**

&emsp; **@default_io_timeout.setter**<br>&mdash; **def [default\_io\_timeout](/scripts/slave/recipe_modules/chromium_swarming/api.py#284)(self, value):**

&emsp; **@default_priority.setter**<br>&mdash; **def [default\_priority](/scripts/slave/recipe_modules/chromium_swarming/api.py#375)(self, value):**

&emsp; **@default_user.setter**<br>&mdash; **def [default\_user](/scripts/slave/recipe_modules/chromium_swarming/api.py#320)(self, value):**

&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/chromium_swarming/api.py#1642)(self, requests_json):**

SwarmingTask -> argument list for go swarming command.

&mdash; **def [get\_collect\_task\_args](/scripts/slave/recipe_modules/chromium_swarming/api.py#1126)(self, merge_script, merge_arguments, build_properties, requests_json, output_json=None, task_output_dir=None, allow_missing_json=False):**
...
&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/chromium_swarming/api.py#1450)(self, prefix, task):**
...
&mdash; **def [gtest\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#621)(self, name=None, isolated=None, extra_args=None, cipd_packages=None, merge=None, raw_cmd=None, relative_cwd=None, \*\*kwargs):**
...
&mdash; **def [initialize](/scripts/slave/recipe_modules/chromium_swarming/api.py#195)(self):**

&mdash; **def [isolated\_script\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#666)(self, raw_cmd=None, relative_cwd=None):**
...
&mdash; **def [merge\_script\_path](/scripts/slave/recipe_modules/chromium_swarming/api.py#428)(self, name):**
...
&emsp; **@staticmethod**<br>&mdash; **def [prefered\_os\_dimension](/scripts/slave/recipe_modules/chromium_swarming/api.py#410)(platform):**
...
&mdash; **def [run\_collect\_task\_script](/scripts/slave/recipe_modules/chromium_swarming/api.py#1299)(self, name, task_args, gen_step_test_data, \*\*kwargs):**
...
&mdash; **def [set\_default\_dimension](/scripts/slave/recipe_modules/chromium_swarming/api.py#340)(self, key, value):**

&mdash; **def [set\_default\_env](/scripts/slave/recipe_modules/chromium_swarming/api.py#359)(self, key, value):**

&emsp; **@show_outputs_ref_in_collect_step.setter**<br>&mdash; **def [show\_outputs\_ref\_in\_collect\_step](/scripts/slave/recipe_modules/chromium_swarming/api.py#406)(self, value):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [summary](/scripts/slave/recipe_modules/chromium_swarming/api.py#201)(self):**

&emsp; **@swarming_server.setter**<br>&mdash; **def [swarming\_server](/scripts/slave/recipe_modules/chromium_swarming/api.py#220)(self, value):**

Changes URL of Swarming server to use.

&mdash; **def [task](/scripts/slave/recipe_modules/chromium_swarming/api.py#436)(self, name=None, build_properties=None, cipd_packages=None, collect_step=None, env=None, env_prefixes=None, extra_args=None, failure_as_exception=True, idempotent=None, ignore_task_failure=False, isolated=None, merge=None, named_caches=None, optional_dimensions=None, raw_cmd=None, service_account=None, shards=1, shard_indices=None, task_output_dir=None, task_to_retry=None, trigger_script=None, relative_cwd=None):**
...
&emsp; **@task_output_stdout.setter**<br>&mdash; **def [task\_output\_stdout](/scripts/slave/recipe_modules/chromium_swarming/api.py#385)(self, value):**

&mdash; **def [trigger\_task](/scripts/slave/recipe_modules/chromium_swarming/api.py#705)(self, task, \*\*kwargs):**
...
&emsp; **@verbose.setter**<br>&mdash; **def [verbose](/scripts/slave/recipe_modules/chromium_swarming/api.py#230)(self, value):**

Enables or disables verbose output in swarming scripts.

&mdash; **def [wait\_for\_finished\_task\_set](/scripts/slave/recipe_modules/chromium_swarming/api.py#1369)(self, task_sets, suffix=None, attempts=0):**
...
&emsp; **@property**<br>&mdash; **def [builders](/scripts/slave/recipe_modules/chromium_tests/api.py#115)(self):**

&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#353)(self, bot_config, update_step, build_config, compile_targets, tests_including_triggered, builder_id=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=True, override_execution_mode=None):**
...
&mdash; **def [configure\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#151)(self, bot_config):**

&mdash; **def [create\_bot\_config\_object](/scripts/slave/recipe_modules/chromium_tests/api.py#127)(self, builder_ids_or_bot_mirrors, builders=None):**
...
&mdash; **def [deapply\_deps](/scripts/slave/recipe_modules/chromium_tests/api.py#1295)(self, bot_update_step):**

&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#803)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#690)(self, builder_id, update_step, bot_config, build_archive_url=None, build_revision=None, override_execution_mode=None, read_gn_args=True):**

&mdash; **def [generate\_tests\_from\_source\_side\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#232)(self, source_side_spec, bot_spec, buildername, builder_group, swarming_dimensions, scripts_compile_targets_fn, bot_update_step):**

&mdash; **def [get\_android\_version\_details](/scripts/slave/recipe_modules/chromium_tests/api.py#324)(self, bot_config, log_details=False):**

&mdash; **def [get\_common\_args\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#986)(self, bot_config=None):**

&mdash; **def [get\_compile\_targets\_for\_scripts](/scripts/slave/recipe_modules/chromium_tests/api.py#1020)(self, bot_config=None):**
...
&mdash; **def [get\_config\_defaults](/scripts/slave/recipe_modules/chromium_tests/api.py#139)(self):**

&mdash; **def [inbound\_transfer](/scripts/slave/recipe_modules/chromium_tests/api.py#1176)(self, bot, bot_update_step, build_config, mb_config_path, mb_phase):**
...
&mdash; **def [integration\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1318)(self, builders=None, bots=None):**

&mdash; **def [log](/scripts/slave/recipe_modules/chromium_tests/api.py#123)(self, message):**

&mdash; **def [lookup\_bot\_metadata](/scripts/slave/recipe_modules/chromium_tests/api.py#1482)(self, builders=None, mirrored_bots=None):**

&mdash; **def [lookup\_builder\_gn\_args](/scripts/slave/recipe_modules/chromium_tests/api.py#1772)(self, bot_meta_data, mb_config_path=None, mb_phase=None, builders=None):**

&mdash; **def [main\_waterfall\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1053)(self, mb_config_path=None, mb_phase=None, builders=None, root_solution_revision=None):**
...
&mdash; **def [outbound\_transfer](/scripts/slave/recipe_modules/chromium_tests/api.py#1122)(self, bot, bot_update_step, build_config):**
...
&mdash; **def [package\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#488)(self, builder_id, update_step, bot_config, reasons=None):**
...
&mdash; **def [prepare\_checkout](/scripts/slave/recipe_modules/chromium_tests/api.py#214)(self, bot_config, \*\*kwargs):**

&mdash; **def [read\_source\_side\_spec](/scripts/slave/recipe_modules/chromium_tests/api.py#252)(self, source_side_spec_file):**

&mdash; **def [run\_mb\_and\_compile](/scripts/slave/recipe_modules/chromium_tests/api.py#657)(self, compile_targets, isolated_targets, name_suffix, builder_id=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=False, android_version_code=None, android_version_name=None):**

&mdash; **def [run\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#1797)(self, bot_meta_data, tests):**

&mdash; **def [run\_tests\_with\_and\_without\_changes](/scripts/slave/recipe_modules/chromium_tests/api.py#1359)(self, builders, mirrored_bots, deapply_changes, tests=None, root_solution_revision=None):**
...
&mdash; **def [runhooks](/scripts/slave/recipe_modules/chromium_tests/api.py#203)(self, update_step):**

&mdash; **def [set\_swarming\_command\_lines](/scripts/slave/recipe_modules/chromium_tests/api.py#470)(self, tests, suffix):**

&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/chromium_tests/api.py#191)(self, bot_config):**

&mdash; **def [trigger\_child\_builds](/scripts/slave/recipe_modules/chromium_tests/api.py#624)(self, builder_id, update_step, bot_config, additional_properties=None):**

&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1324)(self, builders=None, trybots=None, root_solution_revision=None):**
...
&mdash; **def [trybot\_steps\_for\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#1348)(self, builders=None, trybots=None, tests=None):**
...
&emsp; **@property**<br>&mdash; **def [trybots](/scripts/slave/recipe_modules/chromium_tests/api.py#119)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [wrap\_chromium\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#753)(self, bot_config, tests=None):**
...
[DEPS](/scripts/slave/recipe_modules/codesearch/__init__.py#1): [build](#recipe_modules-build), [chromium](#recipe_modules-chromium), [goma](#recipe_modules-goma), [depot\_tools/depot\_tools][depot_tools/recipe_modules/depot_tools], [depot\_tools/git][depot_tools/recipe_modules/git], [depot\_tools/gsutil][depot_tools/recipe_modules/gsutil], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
#### **class [CronetApi](/scripts/slave/recipe_modules/cronet/api.py#14)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [build](/scripts/slave/recipe_modules/cronet/api.py#38)(self, builder_id=None, targets=None, use_goma=True):**

&mdash; **def [get\_bucket](/scripts/slave/recipe_modules/cronet/api.py#59)(self, platform):**

&mdash; **def [get\_version](/scripts/slave/recipe_modules/cronet/api.py#54)(self):**
...
&mdash; **def [run\_perf\_tests](/scripts/slave/recipe_modules/cronet/api.py#99)(self, perf_id):**

&mdash; **def [sizes](/scripts/slave/recipe_modules/cronet/api.py#83)(self, perf_id):**

&mdash; **def [upload\_package](/scripts/slave/recipe_modules/cronet/api.py#64)(self, build_config, cronetdir=None, platform='android'):**
...
&mdash; **def [analyze](/scripts/slave/recipe_modules/filter/api.py#303)(self, affected_files, test_targets, additional_compile_targets, config_file_name, builder_id=None, mb_config_path=None, build_output_dir=None, additional_names=None):**
...
&mdash; **def [does\_patch\_require\_compile](/scripts/slave/recipe_modules/filter/api.py#117)(self, affected_files, test_targets=None, additional_compile_targets=None, additional_names=None, config_file_name='trybot_analyze_config.json', use_mb=False, builder_id=None, mb_config_path=None, build_output_dir=None, \*\*kwargs):**
...
&mdash; **def [record\_previous\_revision](/scripts/slave/recipe_modules/findit/api.py#379)(self, bot_config):**
...
#### **class [GomaApi](/scripts/slave/recipe_modules/goma/api.py#13)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [additional\_goma\_dir](/scripts/slave/recipe_modules/goma/api.py#245)(self, platform):**
...
&emsp; **@property**<br>&mdash; **def [bigquery\_service\_account\_json\_path](/scripts/slave/recipe_modules/goma/api.py#85)(self):**

&mdash; **def [build\_with\_goma](/scripts/slave/recipe_modules/goma/api.py#623)(self, ninja_command, name=None, ninja_log_outdir=None, ninja_log_compiler=None, goma_env=None, ninja_env=None, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [cloudtail\_exe](/scripts/slave/recipe_modules/goma/api.py#89)(self):**

&emsp; **@property**<br>&mdash; **def [cloudtail\_pid\_file](/scripts/slave/recipe_modules/goma/api.py#96)(self):**

&emsp; **@property**<br>&mdash; **def [cloudtail\_service\_account\_json\_path](/scripts/slave/recipe_modules/goma/api.py#76)(self):**

&mdash; **def [configure\_enable\_ats](/scripts/slave/recipe_modules/goma/api.py#177)(self):**
...
&emsp; **@property**<br>&mdash; **def [counterz\_path](/scripts/slave/recipe_modules/goma/api.py#80)(self):**

&emsp; **@property**<br>&mdash; **def [debug](/scripts/slave/recipe_modules/goma/api.py#148)(self):**
...
&emsp; **@property**<br>&mdash; **def [default\_cache\_path](/scripts/slave/recipe_modules/goma/api.py#116)(self):**

&emsp; **@property**<br>&mdash; **def [default\_cache\_path\_per\_slave](/scripts/slave/recipe_modules/goma/api.py#110)(self):**

&emsp; **@property**<br>&mdash; **def [default\_client\_path](/scripts/slave/recipe_modules/goma/api.py#123)(self):**

&mdash; **def [ensure\_goma](/scripts/slave/recipe_modules/goma/api.py#190)(self, client_type=None, additional_platforms=None, ephemeral=False):**
...
&emsp; **@property**<br>&mdash; **def [goma\_ctl](/scripts/slave/recipe_modules/goma/api.py#257)(self):**

&emsp; **@property**<br>&mdash; **def [goma\_dir](/scripts/slave/recipe_modules/goma/api.py#261)(self):**

&mdash; **def [initialize](/scripts/slave/recipe_modules/goma/api.py#68)(self):**

&emsp; **@property**<br>&mdash; **def [jobs](/scripts/slave/recipe_modules/goma/api.py#139)(self):**
...
&emsp; **@property**<br>&mdash; **def [json\_path](/scripts/slave/recipe_modules/goma/api.py#100)(self):**

&emsp; **@property**<br>&mdash; **def [jsonstatus](/scripts/slave/recipe_modules/goma/api.py#105)(self):**

&emsp; **@property**<br>&mdash; **def [recommended\_goma\_jobs](/scripts/slave/recipe_modules/goma/api.py#157)(self):**
...
&emsp; **@property**<br>&mdash; **def [service\_account\_json\_path](/scripts/slave/recipe_modules/goma/api.py#72)(self):**
...
&mdash; **def [stop](/scripts/slave/recipe_modules/goma/api.py#436)(self, build_exit_status, ninja_log_outdir=None, ninja_log_compiler=None, ninja_log_command=None, build_step_name='', \*\*kwargs):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#1012)(self, triggered_tests):**

&emsp; **@property**<br>&mdash; **def [configuration](/scripts/slave/recipe_modules/ios/api.py#61)(self):**

&mdash; **def [ensure\_xcode](/scripts/slave/recipe_modules/ios/api.py#322)(self, xcode_build_version):**

&mdash; **def [generate\_test\_from\_task](/scripts/slave/recipe_modules/ios/api.py#977)(self, task, upload_test_results=True, result_callback=None):**
...
&mdash; **def [get\_mac\_toolchain\_cmd](/scripts/slave/recipe_modules/ios/api.py#315)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [get\_step\_name](/scripts/slave/recipe_modules/ios/api.py#590)(test):**

&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#893)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_earlgrey\_test](/scripts/slave/recipe_modules/ios/api.py#847)(self, test, swarming_tasks, tmp_dir, isolate_template, bot=None):**

Isolate earlgrey test into small shards

&mdash; **def [isolate\_test](/scripts/slave/recipe_modules/ios/api.py#611)(self, test, tmp_dir, isolate_template, test_cases=None, shard_num=None):**

Isolates a single test.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_dir](/scripts/slave/recipe_modules/ios/api.py#1087)(self):**

Returns the path (relative to checkout working dir) of the most recently
compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_app\_path](/scripts/slave/recipe_modules/ios/api.py#1074)(self):**

Returns the Path to the directory of the most recently compiled apps.

&emsp; **@property**<br>&mdash; **def [most\_recent\_iossim](/scripts/slave/recipe_modules/ios/api.py#1102)(self):**
...
&mdash; **def [read\_build\_config](/scripts/slave/recipe_modules/ios/api.py#205)(self, builder_group=None, master_name=None, build_config_base_dir=None, buildername=None):**
...
&mdash; **def [symupload](/scripts/slave/recipe_modules/ios/api.py#489)(self, artifact, url):**
...
&mdash; **def [test\_swarming](/scripts/slave/recipe_modules/ios/api.py#1037)(self, scripts_dir='src/ios/build/bots/scripts', upload_test_results=True, retry_failed_shards=False):**

Runs tests on Swarming as instructed by this bot's build config.

&mdash; **def [upload](/scripts/slave/recipe_modules/ios/api.py#535)(self, base_path=None, revision=None):**

Uploads built artifacts as instructed by this bot's build config.

&mdash; **def [upload\_tgz](/scripts/slave/recipe_modules/ios/api.py#504)(self, artifact, bucket, path):**
...
[DEPS](/scripts/slave/recipe_modules/libyuv/__init__.py#1): [archive](#recipe_modules-archive), [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [chromium\_android](#recipe_modules-chromium_android), [chromium\_checkout](#recipe_modules-chromium_checkout), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/osx\_sdk][depot_tools/recipe_modules/osx_sdk], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/scheduler][recipe_engine/recipe_modules/scheduler], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [ensure\_profdata\_files](/scripts/slave/recipe_modules/pgo/api.py#71)(self, tests):**
...
&mdash; **def [process\_pgo\_data](/scripts/slave/recipe_modules/pgo/api.py#121)(self, tests):**
...
&mdash; **def [profile\_dir](/scripts/slave/recipe_modules/profiles/api.py#73)(self, identifier=None):**
...
#### **class [TestUtilsApi](/scripts/slave/recipe_modules/test_utils/api.py#36)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&emsp; **@property**<br>&mdash; **def [canonical](/scripts/slave/recipe_modules/test_utils/api.py#93)(self):**

&mdash; **def [create\_results\_from\_json](/scripts/slave/recipe_modules/test_utils/api.py#984)(self, data):**

&emsp; **@staticmethod**<br>&mdash; **def [format\_step\_text](/scripts/slave/recipe_modules/test_utils/api.py#124)(data):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [gtest\_results](/scripts/slave/recipe_modules/test_utils/api.py#997)(self, add_json_log=True):**
...
&mdash; **def [limit\_failures](/scripts/slave/recipe_modules/test_utils/api.py#97)(self, failures, limit=None):**
...
&mdash; **def [present\_gtest\_failures](/scripts/slave/recipe_modules/test_utils/api.py#154)(self, step_result, presentation=None):**
...
&mdash; **def [run\_tests](/scripts/slave/recipe_modules/test_utils/api.py#555)(self, caller_api, test_suites, suffix, sort_by_shard=False, retry_failed_shards=False, retry_invalid_shards=False):**
...
&mdash; **def [run\_tests\_with\_patch](/scripts/slave/recipe_modules/test_utils/api.py#675)(self, caller_api, test_suites, retry_failed_shards=False):**
...
&mdash; **def [summarize\_failing\_test\_with\_no\_retries](/scripts/slave/recipe_modules/test_utils/api.py#827)(self, caller_api, test_suite):**

Summarizes a failing test suite that is not going to be retried.

&mdash; **def [summarize\_findit\_flakiness](/scripts/slave/recipe_modules/test_utils/api.py#884)(self, caller_api, test_suites):**
...
&mdash; **def [summarize\_test\_with\_patch\_deapplied](/scripts/slave/recipe_modules/test_utils/api.py#789)(self, caller_api, test_suite):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_results](/scripts/slave/recipe_modules/test_utils/api.py#987)(self, add_json_log=True):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#483)(self):**

&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#886)(self):**

Absolute path to the build product based on the 'checkout' path.

&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1492)(self, requests, project=None, bucket=None, step_name='trigger'):**
...
&emsp; **@property**<br>&mdash; **def [builderset](/scripts/slave/recipe_modules/v8/api.py#491)(self):**

Returns a list of names of this builder and all its triggered testers.

&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1602)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#423)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#378)(self, revision=None, \*\*kwargs):**

&mdash; **def [collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#798)(self):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#716)(self, test_spec=v8_builders.EmptyTestSpec, mb_config_path=None, out_dir=None, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#980)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#986)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#993)(self):**

&mdash; **def [dedupe\_tests](/scripts/slave/recipe_modules/v8/api.py#529)(self, high_prec_tests, low_prec_tests):**

Dedupe tests with lower precedence.

&emsp; **@property**<br>&mdash; **def [depot\_tools\_path](/scripts/slave/recipe_modules/v8/api.py#829)(self):**

Returns path to depot_tools pinned in the V8 checkout.

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#874)(self, revision):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [ensure\_osx\_sdk\_if\_needed](/scripts/slave/recipe_modules/v8/api.py#655)(self):**
...
&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1256)(self):**

&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#511)(self):**

Returns runnable testing.BaseTest objects for each extra test specified
by parent_test_spec property.

&mdash; **def [extra\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#520)(self, test_spec):**

Returns runnable testing.BaseTest objects for each extra test specified
in the test spec of the current builder.

&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1165)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#891)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#976)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1578)(self, bisect_range):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1527)(self):**

&mdash; **def [get\_test\_roots](/scripts/slave/recipe_modules/v8/api.py#191)(self):**
...
&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#895)(self):**

Delete all gcov counter files.

&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#996)(self):**

&mdash; **def [isolate\_targets\_from\_tests](/scripts/slave/recipe_modules/v8/api.py#569)(self, tests):**
...
&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#589)(self, isolate_targets, out_dir=None):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#842)(self):**

&mdash; **def [load\_dynamic\_test\_configs](/scripts/slave/recipe_modules/v8/api.py#225)(self, root):**
...
&mdash; **def [load\_static\_test\_configs](/scripts/slave/recipe_modules/v8/api.py#221)(self):**

Set predifined test configs from build repository.

&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1624)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#1065)(self, test_results, test_spec):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#857)(self, update_step):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [maybe\_nest](/scripts/slave/recipe_modules/v8/api.py#1001)(self, condition, parent_step_name):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1365)(self, test_spec=v8_builders.EmptyTestSpec, \*\*additional_properties):**

&mdash; **def [parse\_revision\_props](/scripts/slave/recipe_modules/v8/api.py#400)(self, got_revision, got_revision_cp=None):**
...
&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#535)(self, root):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1640)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1649)(self, ref, step_name_desc):**

Read and return the version at a paricular ref.

&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#507)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1629)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#475)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#1009)(self, tests):**

&mdash; **def [set\_chromium\_configs](/scripts/slave/recipe_modules/v8/api.py#352)(self, clobber, default_targets):**

&mdash; **def [set\_gclient\_custom\_deps](/scripts/slave/recipe_modules/v8/api.py#347)(self, custom_deps):**

Configures additional gclient custom_deps to be synced.

&mdash; **def [set\_gclient\_custom\_var](/scripts/slave/recipe_modules/v8/api.py#338)(self, var_name):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#439)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#499)(self):**

&emsp; **@property**<br>&mdash; **def [should\_collect\_post\_compile\_metrics](/scripts/slave/recipe_modules/v8/api.py#791)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#503)(self):**

&emsp; **@property**<br>&mdash; **def [target\_bits](/scripts/slave/recipe_modules/v8/api.py#646)(self):**

Returns target bits (as int) inferred from gn arguments from MB.

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1282)(self):**

&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#358)(self):**
...
&mdash; **def [ui\_test\_label](/scripts/slave/recipe_modules/v8/api.py#1196)(self, full_test_name):**

&mdash; **def [update\_bot\_config](/scripts/slave/recipe_modules/v8/api.py#135)(self, bot_config, binary_size_tracking, build_config, clusterfuzz_archive, coverage, enable_swarming, target_arch, target_platform, track_build_dependencies, triggers, triggers_proxy):**
...
&mdash; **def [update\_test\_configs](/scripts/slave/recipe_modules/v8/api.py#216)(self, test_configs):**

Update test configs without mutating previous copy.

&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#905)(self):**

Capture coverage data and upload a report.

&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#849)(self):**
...
### *recipes* / [angle\_chromium](/scripts/slave/recipes/angle_chromium.py)

[DEPS](/scripts/slave/recipes/angle_chromium.py#5): [adb](#recipe_modules-adb), [build](#recipe_modules-build), [chromium](#recipe_modules-chromium), [chromium\_android](#recipe_modules-chromium_android), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [isolate](#recipe_modules-isolate), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/gitiles][depot_tools/recipe_modules/gitiles], [depot\_tools/gsutil][depot_tools/recipe_modules/gsutil], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/legacy\_annotation][recipe_engine/recipe_modules/legacy_annotation], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipes/angle_chromium.py#53)(api):**

&mdash; **def [get\_component\_revision\_from\_deps](/scripts/slave/recipes/angle_chromium.py#34)(api, component, project, repository_url, branch):**
### *recipes* / [angle\_chromium\_trybot](/scripts/slave/recipes/angle_chromium_trybot.py)

[DEPS](/scripts/slave/recipes/angle_chromium_trybot.py#5): [build](#recipe_modules-build), [chromium](#recipe_modules-chromium), [chromium\_android](#recipe_modules-chromium_android), [chromium\_checkout](#recipe_modules-chromium_checkout), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [filter](#recipe_modules-filter), [isolate](#recipe_modules-isolate), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/gerrit][depot_tools/recipe_modules/gerrit], [depot\_tools/git][depot_tools/recipe_modules/git], [depot\_tools/gitiles][depot_tools/recipe_modules/gitiles], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/legacy\_annotation][recipe_engine/recipe_modules/legacy_annotation], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipes/angle_chromium_trybot.py#81)(api):**

&mdash; **def [get\_chromium\_revision\_from\_angle\_cl](/scripts/slave/recipes/angle_chromium_trybot.py#57)(api):**

&mdash; **def [get\_component\_revision\_from\_deps](/scripts/slave/recipes/angle_chromium_trybot.py#38)(api, component, project, repository_url, branch):**
### *recipes* / [archive:examples/full](/scripts/slave/recipe_modules/archive/examples/full.py)

[DEPS](/scripts/slave/recipe_modules/archive/examples/full.py#11): [archive](#recipe_modules-archive), [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/archive/examples/full.py#27)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/chromium.py#33)(api):**
...
### *recipes* / [chromium:tests/bad\_config](/scripts/slave/recipe_modules/chromium/tests/bad_config.py)

[DEPS](/scripts/slave/recipe_modules/chromium/tests/bad_config.py#10): [chromium](#recipe_modules-chromium), [recipe\_engine/assertions][recipe_engine/recipe_modules/assertions]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium/tests/bad_config.py#21)(api):**

&emsp; **@config_ctx()**<br>&mdash; **def [bad\_generator](/scripts/slave/recipe_modules/chromium/tests/bad_config.py#16)(c):**
...
[DEPS](/scripts/slave/recipe_modules/chromium/tests/test_api_ci_build.py#7): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [recipe\_engine/assertions][recipe_engine/recipe_modules/assertions], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/properties][recipe_engine/recipe_modules/properties]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium/tests/test_api_ci_build.py#16)(api):**
### *recipes* / [chromium:tests/test\_api\_generic\_build](/scripts/slave/recipe_modules/chromium/tests/test_api_generic_build.py)

[DEPS](/scripts/slave/recipe_modules/chromium/tests/test_api_generic_build.py#7): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [recipe\_engine/assertions][recipe_engine/recipe_modules/assertions], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/properties][recipe_engine/recipe_modules/properties]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium/tests/test_api_generic_build.py#16)(api):**
### *recipes* / [chromium:tests/test\_api\_try\_build](/scripts/slave/recipe_modules/chromium/tests/test_api_try_build.py)

[DEPS](/scripts/slave/recipe_modules/chromium/tests/test_api_try_build.py#7): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [recipe\_engine/assertions][recipe_engine/recipe_modules/assertions], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/properties][recipe_engine/recipe_modules/properties]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium/tests/test_api_try_build.py#16)(api):**
...
### *recipes* / [chromium\_android:tests/read\_denylist](/scripts/slave/recipe_modules/chromium_android/tests/read_denylist.py)

[DEPS](/scripts/slave/recipe_modules/chromium_android/tests/read_denylist.py#5): [chromium\_android](#recipe_modules-chromium_android), [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_android/tests/read_denylist.py#14)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_codesearch.py#196)(api, root_solution_revision, root_solution_revision_timestamp, codesearch_mirror_revision, codesearch_mirror_revision_timestamp):**
...
[DEPS](/scripts/slave/recipes/chromium_speed_processor.py#5): [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_speed_processor.py#23)(api, properties):**
### *recipes* / [chromium\_speed\_tester](/scripts/slave/recipes/chromium_speed_tester.py)

[DEPS](/scripts/slave/recipes/chromium_speed_tester.py#5): [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/python][recipe_engine/recipe_modules/python]

&mdash; **def [RunSteps](/scripts/slave/recipes/chromium_speed_tester.py#21)(api, properties):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/api/compile_specific_targets.py#33)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/api/configure_build.py#36)(api):**
...
[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/api/create_test_runner.py#7): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [chromium\_tests](#recipe_modules-chromium_tests), [test\_results](#recipe_modules-test_results), [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/legacy\_annotation][recipe_engine/recipe_modules/legacy_annotation], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/api/create_test_runner.py#19)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/api/prepare_checkout.py#37)(api):**
...
### *recipes* / [chromium\_tests:tests/api/set\_swarming\_command\_lines](/scripts/slave/recipe_modules/chromium_tests/tests/api/set_swarming_command_lines.py)

[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/api/set_swarming_command_lines.py#9): [build](#recipe_modules-build), [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/api/set_swarming_command_lines.py#31)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/api/trybot_steps.py#88)(api):**
### *recipes* / [chromium\_tests:tests/api/trybot\_steps\_analyze\_autoroll](/scripts/slave/recipe_modules/chromium_tests/tests/api/trybot_steps_analyze_autoroll.py)

[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/api/trybot_steps_analyze_autoroll.py#7): [chromium](#recipe_modules-chromium), [chromium\_tests](#recipe_modules-chromium_tests), [test\_utils](#recipe_modules-test_utils), [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/api/trybot_steps_analyze_autoroll.py#45)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/api/trybot_steps_with_specific_tests.py#37)(api, fail_calculate_tests, fail_mb_and_compile, expected_jsonish_result):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/builders.py#73)(api):**

&mdash; **def [validate\_tester\_config](/scripts/slave/recipe_modules/chromium_tests/tests/builders.py#42)(api, builder_group, buildername, bot_config):**
...
[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/steps/artifact_links.py#5): [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [isolate](#recipe_modules-isolate), [profiles](#recipe_modules-profiles), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/steps/artifact_links.py#28)(api):**
...
[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/steps/generate_fuchsia_test.py#7): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [chromium\_tests](#recipe_modules-chromium_tests), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/steps/generate_fuchsia_test.py#25)(api):**
...
[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/steps/generate_gtest.py#5): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [isolate](#recipe_modules-isolate), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/steps/generate_gtest.py#31)(api):**
...
[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/steps/generate_isolated_script.py#5): [build](#recipe_modules-build), [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [isolate](#recipe_modules-isolate), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/steps/generate_isolated_script.py#32)(api):**
...
[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/steps/get_args_for_test.py#5): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [chromium\_tests](#recipe_modules-chromium_tests), [test\_results](#recipe_modules-test_results), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/assertions][recipe_engine/recipe_modules/assertions], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/properties][recipe_engine/recipe_modules/properties]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/steps/get_args_for_test.py#24)(api):**
...
### *recipes* / [chromium\_tests:tests/steps/layout\_tests\_handler](/scripts/slave/recipe_modules/chromium_tests/tests/steps/layout_tests_handler.py)

[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/steps/layout_tests_handler.py#5): [build](#recipe_modules-build), [chromium](#recipe_modules-chromium), [chromium\_tests](#recipe_modules-chromium_tests), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/steps/layout_tests_handler.py#30)(api):**
...
[DEPS](/scripts/slave/recipe_modules/chromium_tests/tests/steps/swarming_ios_test.py#5): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [ios](#recipe_modules-ios), [perf\_dashboard](#recipe_modules-perf_dashboard), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step], [recipe\_engine/time][recipe_engine/recipe_modules/time]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/steps/swarming_ios_test.py#30)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/chromium_tests/tests/steps/webrtc_perf_test.py#23)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/code_coverage/tests/full.py#27)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/dawn.py#133)(api, target_cpu, debug, clang):**
### *recipes* / [devtools/devtools-backend](/scripts/slave/recipes/devtools/devtools-backend.py)

[DEPS](/scripts/slave/recipes/devtools/devtools-backend.py#11): [chromium](#recipe_modules-chromium), [goma](#recipe_modules-goma), [perf\_dashboard](#recipe_modules-perf_dashboard), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/depot\_tools][depot_tools/recipe_modules/depot_tools], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/git][depot_tools/recipe_modules/git], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/cipd][recipe_engine/recipe_modules/cipd], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipes/devtools/devtools-backend.py#34)(api):**

&mdash; **def [cmake](/scripts/slave/recipes/devtools/devtools-backend.py#53)(api):**

&mdash; **def [compile\_n\_check](/scripts/slave/recipes/devtools/devtools-backend.py#65)(api, sever_build_path):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/findit/chromium/flake.py#57)(api, target_mastername, target_testername, test_revision, tests, test_repeat_count, skip_tests):**
...
[DEPS](/scripts/slave/recipe_modules/goma/tests/start.py#7): [goma](#recipe_modules-goma), [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/goma/tests/start.py#15)(api):**
### *recipes* / [goma\_client](/scripts/slave/recipes/goma_client.py)

[DEPS](/scripts/slave/recipes/goma_client.py#5): [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/depot\_tools][depot_tools/recipe_modules/depot_tools], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/osx\_sdk][depot_tools/recipe_modules/osx_sdk], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/cipd][recipe_engine/recipe_modules/cipd], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipes/goma_client.py#20)(api):**
...
[DEPS](/scripts/slave/recipes/ios/unified_builder_tester.py#7): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [ios](#recipe_modules-ios), [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipes/ios/unified_builder_tester.py#19)(api):**
...
[DEPS](/scripts/slave/recipes/led_recipes_tester.py#16): [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/cipd][recipe_engine/recipe_modules/cipd], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/futures][recipe_engine/recipe_modules/futures], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/led][recipe_engine/recipe_modules/led], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step], [recipe\_engine/swarming][recipe_engine/recipe_modules/swarming]

Tests a recipe CL by running a chromium builder.

&mdash; **def [RunSteps](/scripts/slave/recipes/led_recipes_tester.py#422)(api, repo_name):**
### *recipes* / [libyuv/libyuv](/scripts/slave/recipes/libyuv/libyuv.py)

[DEPS](/scripts/slave/recipes/libyuv/libyuv.py#13): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [chromium\_android](#recipe_modules-chromium_android), [libyuv](#recipe_modules-libyuv), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]

Recipe for building and running tests for Libyuv stand-alone.

&mdash; **def [RunSteps](/scripts/slave/recipes/libyuv/libyuv.py#29)(api):**
...
[DEPS](/scripts/slave/recipes/openscreen.py#7): [code\_coverage](#recipe_modules-code_coverage), [goma](#recipe_modules-goma), [profiles](#recipe_modules-profiles), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/depot\_tools][depot_tools/recipe_modules/depot_tools], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/git][depot_tools/recipe_modules/git], [depot\_tools/gsutil][depot_tools/recipe_modules/gsutil], [depot\_tools/osx\_sdk][depot_tools/recipe_modules/osx_sdk], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/isolated][recipe_engine/recipe_modules/isolated], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step], [recipe\_engine/swarming][recipe_engine/recipe_modules/swarming]

Recipe for building and running tests for Open Screen stand-alone.

&mdash; **def [CalculateCodeCoverage](/scripts/slave/recipes/openscreen.py#245)(api, output_path, unit_test_binary, e2e_test_binary):**

Calculates code coverage from raw coverage data generated by prior test
runs.

&mdash; **def [CheckSwarmingResults](/scripts/slave/recipes/openscreen.py#152)(api, name, results):**

Called after swarming.collect() to produce a proper step result.

&mdash; **def [FormatGnArg](/scripts/slave/recipes/openscreen.py#117)(properties, key):**

Takes a specific keg, e.g. is_debug, and format the key and value pair as
a valid gn argument.

&mdash; **def [FormatGnArgs](/scripts/slave/recipes/openscreen.py#127)(properties):**

Takes a list of properties and maps them to string gn arguments.

&mdash; **def [GenerateCoverageTestConstants](/scripts/slave/recipes/openscreen.py#81)(api, checkout_dir, output_dir):**

Generates fake file paths used for validation in code coverage tests.

&mdash; **def [GetChangedFiles](/scripts/slave/recipes/openscreen.py#102)(api, checkout_path):**

Returns list of POSIX paths of files affected by patch.

&mdash; **def [GetHostToolLabel](/scripts/slave/recipes/openscreen.py#72)(platform):**

Determines what the platform label is, e.g. 'mac' or 'linux64'.

&mdash; **def [GetSwarmingDimensions](/scripts/slave/recipes/openscreen.py#55)(is_ci):**

&mdash; **def [RunSteps](/scripts/slave/recipes/openscreen.py#342)(api):**

Main function body for execution on the current bot.

&mdash; **def [RunTestsAndCoverageLocally](/scripts/slave/recipes/openscreen.py#297)(api, output_path, unit_test_binary, e2e_test_binary):**

Runs unit tests and e2e tests locally and calculates code coverage

&mdash; **def [RunTestsLocally](/scripts/slave/recipes/openscreen.py#291)(api, unit_test_binary, e2e_test_binary):**

Runs unit tests and e2e tests locally

&mdash; **def [SetCodeCoverageConstants](/scripts/slave/recipes/openscreen.py#217)(api, checkout_dir, host_tool_label):**
...
&mdash; **def [SwarmTests](/scripts/slave/recipes/openscreen.py#167)(api, output_path, checkout_path, dimensions):**

Runs specific types of tests on a separate swarming bot.

&mdash; **def [UploadFilesToIsolateStorage](/scripts/slave/recipes/openscreen.py#133)(api, files):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/pdfium.py#600)(api, memory_tool, skia, skia_paths, xfa, v8, target_cpu, clang, msvc, rel, component, skip_test, target_os):**
...
&mdash; **def [RunSteps](/scripts/slave/recipe_modules/pgo/tests/full.py#28)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/swarming/staging.py#45)(api, mastername):**
...
[DEPS](/scripts/slave/recipe_modules/test_utils/tests/run_tests.py#5): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [test\_results](#recipe_modules-test_results), [test\_utils](#recipe_modules-test_utils), [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/test_utils/tests/run_tests.py#30)(api, test_swarming, test_name, abort_on_failure, retry_invalid_shards):**
...
[DEPS](/scripts/slave/recipe_modules/test_utils/tests/upload_results_to_resultdb.py#5): [builder\_group](#recipe_modules-builder_group), [chromium](#recipe_modules-chromium), [chromium\_swarming](#recipe_modules-chromium_swarming), [chromium\_tests](#recipe_modules-chromium_tests), [test\_utils](#recipe_modules-test_utils), [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/resultdb][recipe_engine/recipe_modules/resultdb]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/test_utils/tests/upload_results_to_resultdb.py#37)(api, is_swarming_test=True):**
### *recipes* / [tint](/scripts/slave/recipes/tint.py)

[DEPS](/scripts/slave/recipes/tint.py#5): [goma](#recipe_modules-goma), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/depot\_tools][depot_tools/recipe_modules/depot_tools], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/osx\_sdk][depot_tools/recipe_modules/osx_sdk], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [RunSteps](/scripts/slave/recipes/tint.py#125)(api, target_cpu, debug, clang):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/auto_roll_deps.py#78)(api):**

&mdash; **def [get\_v8\_revision](/scripts/slave/recipes/v8/auto_roll_deps.py#43)(api, name, deps):**

&mdash; **def [is\_gitiles\_inconsistent](/scripts/slave/recipes/v8/auto_roll_deps.py#53)(api):**
...
[DEPS](/scripts/slave/recipes/v8/auto_roll_release_process.py#5): [builder\_group](#recipe_modules-builder_group), [v8](#recipe_modules-v8), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]

&mdash; **def [ClusterfuzzHasIssues](/scripts/slave/recipes/v8/auto_roll_release_process.py#24)(api):**

&mdash; **def [RunSteps](/scripts/slave/recipes/v8/auto_roll_release_process.py#47)(api):**
...
[DEPS](/scripts/slave/recipes/v8/auto_tag.py#23): [builder\_group](#recipe_modules-builder_group), [v8](#recipe_modules-v8), [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/git][depot_tools/recipe_modules/git], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/service\_account][recipe_engine/recipe_modules/service_account], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [GetCommitForRef](/scripts/slave/recipes/v8/auto_tag.py#69)(api, repo, ref):**

&mdash; **def [Git](/scripts/slave/recipes/v8/auto_tag.py#59)(api, \*args, \*\*kwargs):**

Convenience wrapper.

&mdash; **def [IncrementVersion](/scripts/slave/recipes/v8/auto_tag.py#91)(api, ref, latest_version, latest_version_file):**
...
&mdash; **def [InitClean](/scripts/slave/recipes/v8/auto_tag.py#50)(api):**

Ensures a clean state of the git checkout.

&mdash; **def [LogStep](/scripts/slave/recipes/v8/auto_tag.py#87)(api, text):**

&mdash; **def [PushRef](/scripts/slave/recipes/v8/auto_tag.py#82)(api, repo, ref, hsh):**

&mdash; **def [RunSteps](/scripts/slave/recipes/v8/auto_tag.py#167)(api):**

&mdash; **def [UpdateRef](/scripts/slave/recipes/v8/auto_tag.py#225)(api, repo, head, lkgr_ref):**
### *recipes* / [v8/flako](/scripts/slave/recipes/v8/flako.py)

[DEPS](/scripts/slave/recipes/v8/flako.py#31): [builder\_group](#recipe_modules-builder_group), [chromium\_swarming](#recipe_modules-chromium_swarming), [swarming\_client](#recipe_modules-swarming_client), [depot\_tools/gitiles][depot_tools/recipe_modules/gitiles], [depot\_tools/gsutil][depot_tools/recipe_modules/gsutil], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/flako.py#546)(api, bisect_builder_group, bisect_buildername, build_config, extra_args, initial_commit_offset, max_calibration_attempts, isolated_name, num_shards, repetitions, repro_only, swarming_dimensions, swarming_priority, swarming_expiration, test_name, timeout_sec, total_timeout_sec, to_revision, variant):**
...
[DEPS](/scripts/slave/recipes/v8/node_integration_ng.py#17): [chromium](#recipe_modules-chromium), [goma](#recipe_modules-goma), [v8](#recipe_modules-v8), [zip](#recipe_modules-zip), [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/gsutil][depot_tools/recipe_modules/gsutil], [depot\_tools/tryserver][depot_tools/recipe_modules/tryserver], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/commit\_position][recipe_engine/recipe_modules/commit_position], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

Recipe to test v8/node.js integration.

&mdash; **def [RunSteps](/scripts/slave/recipes/v8/node_integration_ng.py#71)(api, triggers, v8_tot):**

&mdash; **def [run\_with\_retry](/scripts/slave/recipes/v8/node_integration_ng.py#49)(api, step_name, step_fun):**
...
[DEPS](/scripts/slave/recipes/v8/verify_flakes.py#24): [v8](#recipe_modules-v8), [depot\_tools/gitiles][depot_tools/recipe_modules/gitiles], [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
[DEPS](/scripts/slave/recipe_modules/v8/tests/example.py#7): [v8](#recipe_modules-v8), [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/runtime][recipe_engine/recipe_modules/runtime]

&mdash; **def [RunSteps](/scripts/slave/recipe_modules/v8/tests/example.py#15)(api):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/wasm_llvm.py#20)(api):**
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5d50d5f744305222468fed128a8b369ce873ce19/README.recipes.md#recipe_modules-generator_script
[recipe_engine/recipe_modules/isolated]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5d50d5f744305222468fed128a8b369ce873ce19/README.recipes.md#recipe_modules-isolated
...
[recipe_engine/recipe_modules/led]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5d50d5f744305222468fed128a8b369ce873ce19/README.recipes.md#recipe_modules-led
[recipe_engine/recipe_modules/legacy_annotation]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5d50d5f744305222468fed128a8b369ce873ce19/README.recipes.md#recipe_modules-legacy_annotation
...
[recipe_engine/recipe_modules/swarming]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5d50d5f744305222468fed128a8b369ce873ce19/README.recipes.md#recipe_modules-swarming
...
[recipe_engine/recipe_modules/tricium]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5d50d5f744305222468fed128a8b369ce873ce19/README.recipes.md#recipe_modules-tricium
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/5d50d5f744305222468fed128a8b369ce873ce19/recipe_engine/util.py#151
