...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#932)(self, tasks, upload_test_results=True):**
...
&mdash; **def [isolate](/scripts/slave/recipe_modules/ios/api.py#723)(self, scripts_dir='src/ios/build/bots/scripts'):**

Isolates the tests specified in this bot's build config.

&mdash; **def [isolate\_earlgrey\_test](/scripts/slave/recipe_modules/ios/api.py#668)(self, test, shard_size, tmp_dir, isolate_template):**
...
&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#823)(self, tasks):**
...
&mdash; **def [apply\_bot\_config](/scripts/slave/recipe_modules/v8/api.py#117)(self, builders=None, flattened_builders=None):**
...
&emsp; **@property**<br>&mdash; **def [bot\_type](/scripts/slave/recipe_modules/v8/api.py#342)(self):**

&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#711)(self):**

Absolute path to the build product based on the 'checkout' path.

&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1350)(self, bucket, changes, requests, step_name='trigger', service_account='v8-bot', no_buildset=False):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1478)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#273)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#227)(self, revision=None, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#554)(self, test_spec=EmptyTestSpec, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#806)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#812)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#819)(self):**

&mdash; **def [dedupe\_tests](/scripts/slave/recipe_modules/v8/api.py#389)(self, high_prec_tests, low_prec_tests):**

Dedupe tests with lower precedence.

&mdash; **def [download\_build](/scripts/slave/recipe_modules/v8/api.py#691)(self, name_suffix='', archive=None):**

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#699)(self, revision):**

&emsp; **@property**<br>&mdash; **def [extra\_flags](/scripts/slave/recipe_modules/v8/api.py#1115)(self):**

&mdash; **def [extra\_tests\_from\_properties](/scripts/slave/recipe_modules/v8/api.py#371)(self):**

Returns runnable testing.BaseTest objects for each extra test specified
by parent_test_spec property.

&mdash; **def [extra\_tests\_from\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#380)(self, test_spec):**

Returns runnable testing.BaseTest objects for each extra test specified
in the test spec of the current builder.

&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#979)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#716)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#802)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1454)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1404)(self):**

&mdash; **def [get\_changes](/scripts/slave/recipe_modules/v8/api.py#1344)(self):**

&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#720)(self):**

Delete all gcov counter files.

&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#822)(self):**

&emsp; **@property**<br>&mdash; **def [isolate\_targets](/scripts/slave/recipe_modules/v8/api.py#432)(self):**

&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#457)(self, isolate_targets):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#657)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/v8/api.py#197)(self):**

&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1500)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#882)(self, test_results):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#675)(self, update_step):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1215)(self, test_spec=EmptyTestSpec, \*\*additional_properties):**

&mdash; **def [read\_test\_spec](/scripts/slave/recipe_modules/v8/api.py#395)(self):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1516)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1525)(self, ref, step_name_desc):**

Read and return the version at a paricular ref.

&emsp; **@property**<br>&mdash; **def [relative\_path\_to\_d8](/scripts/slave/recipe_modules/v8/api.py#367)(self):**

&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1505)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#333)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#827)(self, tests):**

&mdash; **def [set\_gclient\_custom\_var](/scripts/slave/recipe_modules/v8/api.py#188)(self, var_name):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#289)(self):**

&emsp; **@property**<br>&mdash; **def [should\_build](/scripts/slave/recipe_modules/v8/api.py#350)(self):**

&emsp; **@property**<br>&mdash; **def [should\_download\_build](/scripts/slave/recipe_modules/v8/api.py#363)(self):**

&emsp; **@property**<br>&mdash; **def [should\_test](/scripts/slave/recipe_modules/v8/api.py#354)(self):**

&emsp; **@property**<br>&mdash; **def [should\_upload\_build](/scripts/slave/recipe_modules/v8/api.py#358)(self):**

&emsp; **@property**<br>&mdash; **def [test\_filter](/scripts/slave/recipe_modules/v8/api.py#1141)(self):**

&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#207)(self):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#650)(self, name_suffix='', archive=None):**

&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#730)(self):**

Capture coverage data and upload a report.

&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#667)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1529)(blob):**
...
&mdash; **def [build\_android\_archive](/scripts/slave/recipe_modules/webrtc/api.py#288)(self):**
...
&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/webrtc/api.py#265)(self):**

&mdash; **def [package\_apprtcmobile](/scripts/slave/recipe_modules/webrtc/api.py#329)(self):**

&mdash; **def [package\_build](/scripts/slave/recipe_modules/webrtc/api.py#278)(self):**

&mdash; **def [run\_baremetal\_test](/scripts/slave/recipe_modules/webrtc/api.py#260)(self, test, name=None, gtest_args=None, args=None, parallel=True):**

&mdash; **def [run\_mb](/scripts/slave/recipe_modules/webrtc/api.py#192)(self):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/webrtc/api.py#223)(self):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/angle.py#100)(api, target_cpu, debug, clang, msvc):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/pdfium.py#253)(api, memory_tool, skia, xfa, v8, target_cpu, clang, msvc, rel, jumbo, skip_test, target_os):**

&mdash; **def [dict\_to\_str](/scripts/slave/recipes/pdfium.py#317)(props):**

Returns the given dictionary as a string of space
separated key/value pairs sorted by keys.

&mdash; **def [get\_buildbucket\_build\_id](/scripts/slave/recipes/pdfium.py#304)(api):**

Returns the build bucket id or '0' if is not availabe in api

&mdash; **def [get\_gold\_ignore\_hashes](/scripts/slave/recipes/pdfium.py#352)(api, out_dir):**
...
&mdash; **def [get\_gold\_params](/scripts/slave/recipes/pdfium.py#269)(api, build_config, revision):**
...
&mdash; **def [gold\_build\_config](/scripts/slave/recipes/pdfium.py#326)(args):**
...
&mdash; **def [gs\_cp](/scripts/slave/recipes/pdfium.py#455)(api, name, src, dst, multithreaded=False, extra_args=None):**

Copy the src to dst in Google storage.

&mdash; **def [upload\_dm\_results](/scripts/slave/recipes/pdfium.py#407)(api, results_dir, revision):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/v8/node_integration.py#236)(api):**

&emsp; **@contextmanager**<br>&mdash; **def [goma\_wrapper](/scripts/slave/recipes/v8/node_integration.py#98)(api):**
...
[depot_tools/recipe_modules/bot_update]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-bot_update
[depot_tools/recipe_modules/cipd]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-cipd
[depot_tools/recipe_modules/depot_tools]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-depot_tools
[depot_tools/recipe_modules/gclient]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-gclient
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-gerrit
[depot_tools/recipe_modules/git]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-git
[depot_tools/recipe_modules/gitiles]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-gitiles
[depot_tools/recipe_modules/gsutil]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-gsutil
[depot_tools/recipe_modules/infra_paths]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-infra_paths
[depot_tools/recipe_modules/presubmit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-presubmit
[depot_tools/recipe_modules/tryserver]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/142a92ce8b834a412c16c0451ed8d434ea323e58/recipes/README.recipes.md#recipe_modules-tryserver
