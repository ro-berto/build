...
&mdash; **def [get\_collect\_cmd\_args](/scripts/slave/recipe_modules/swarming/api.py#1295)(self, task):**
...
&mdash; **def [RunSteps](/scripts/slave/recipes/art.py#597)(api):**
...
&mdash; **def [setup\_aosp\_builder](/scripts/slave/recipes/art.py#421)(api, read_barrier):**
...
&mdash; **def [setup\_target](/scripts/slave/recipes/art.py#219)(api, serial, device, debug, concurrent_collector=True, generational_cc=True, heap_poisoning=False, gcstress=False):**
