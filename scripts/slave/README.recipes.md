...
&mdash; **def [android\_build\_wrapper](/scripts/slave/recipe_modules/chromium_android/api.py#1279)(self, logcat_gs_bucket='chromium-android'):**

&mdash; **def [android\_test\_wrapper](/scripts/slave/recipe_modules/chromium_android/api.py#1296)(self, _logcat_gs_bucket='chromium-android'):**
...
&mdash; **def [common\_tests\_final\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#1258)(self, logcat_gs_bucket='chromium-android', force_latest_version=False, checkout_dir=None):**

&mdash; **def [common\_tests\_setup\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#1234)(self, perf_setup=False, \*\*provision_kwargs):**
...
&mdash; **def [coverage\_report](/scripts/slave/recipe_modules/chromium_android/api.py#1439)(self, upload=True, \*\*kwargs):**
...
&mdash; **def [generate\_breakpad\_symbols](/scripts/slave/recipe_modules/chromium_android/api.py#1103)(self, symbols_dir, binary_path, root_chromium_dir):**
...
&mdash; **def [get\_changed\_lines\_for\_revision](/scripts/slave/recipe_modules/chromium_android/api.py#1551)(self):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [handle\_exit\_codes](/scripts/slave/recipe_modules/chromium_android/api.py#1612)(self):**
...
&mdash; **def [incremental\_coverage\_report](/scripts/slave/recipe_modules/chromium_android/api.py#1480)(self):**
...
&mdash; **def [logcat\_dump](/scripts/slave/recipe_modules/chromium_android/api.py#1068)(self, gs_bucket=None):**
...
&mdash; **def [run\_bisect\_script](/scripts/slave/recipe_modules/chromium_android/api.py#1303)(self, extra_src='', path_to_config='', \*\*kwargs):**
...
&mdash; **def [run\_java\_unit\_test\_suite](/scripts/slave/recipe_modules/chromium_android/api.py#1361)(self, suite, verbose=True, json_results_file=None, suffix=None, \*\*kwargs):**
...
&mdash; **def [run\_test\_suite](/scripts/slave/recipe_modules/chromium_android/api.py#1319)(self, suite, verbose=True, tool=None, result_details=False, store_tombstones=False, name=None, json_results_file=None, shard_timeout=None, args=None, \*\*kwargs):**

&mdash; **def [run\_tree\_truth](/scripts/slave/recipe_modules/chromium_android/api.py#189)(self, additional_repos=None):**

&mdash; **def [run\_webview\_cts](/scripts/slave/recipe_modules/chromium_android/api.py#1396)(self, android_platform, arch, command_line_args=None, suffix=None, json_results_file=None, result_details=False):**
...
&mdash; **def [stack\_tool\_steps](/scripts/slave/recipe_modules/chromium_android/api.py#1174)(self, force_latest_version=False):**

&mdash; **def [stackwalker](/scripts/slave/recipe_modules/chromium_android/api.py#1127)(self, root_chromium_dir, binary_paths):**
...
&mdash; **def [staged\_files\_matching\_filter](/scripts/slave/recipe_modules/chromium_android/api.py#1592)(self, diff_filter):**
...
&mdash; **def [test\_report](/scripts/slave/recipe_modules/chromium_android/api.py#1217)(self):**

&mdash; **def [test\_runner](/scripts/slave/recipe_modules/chromium_android/api.py#1635)(self, step_name, args=None, wrapper_script_suite_name=None, pass_adb_path=True, \*\*kwargs):**
...
&mdash; **def [collect](/scripts/slave/recipe_modules/ios/api.py#925)(self, tasks, upload_test_results=True):**
...
&mdash; **def [trigger](/scripts/slave/recipe_modules/ios/api.py#816)(self, tasks):**
...
&mdash; **def [create\_results\_from\_json](/scripts/slave/recipe_modules/test_utils/api.py#282)(self, data):**

&mdash; **def [create\_results\_from\_json\_if\_needed](/scripts/slave/recipe_modules/test_utils/api.py#285)(self, data):**

&mdash; **def [determine\_new\_failures](/scripts/slave/recipe_modules/test_utils/api.py#182)(self, caller_api, tests, deapply_patch_fn):**
...
&emsp; **@staticmethod**<br>&mdash; **def [format\_step\_text](/scripts/slave/recipe_modules/test_utils/api.py#66)(data):**
...
&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [gtest\_results](/scripts/slave/recipe_modules/test_utils/api.py#302)(self, add_json_log=True):**
...
&mdash; **def [present\_gtest\_failures](/scripts/slave/recipe_modules/test_utils/api.py#96)(self, step_result, presentation=None):**
...
&mdash; **def [run\_tests](/scripts/slave/recipe_modules/test_utils/api.py#130)(self, caller_api, tests, suffix):**
...
&mdash; **def [run\_tests\_with\_patch](/scripts/slave/recipe_modules/test_utils/api.py#168)(self, caller_api, tests):**

&emsp; **@[returns\_placeholder][recipe_engine/wkt/returns_placeholder]**<br>&mdash; **def [test\_results](/scripts/slave/recipe_modules/test_utils/api.py#292)(self, add_json_log=True):**
...
&emsp; **@property**<br>&mdash; **def [build\_output\_dir](/scripts/slave/recipe_modules/v8/api.py#827)(self):**

Absolute path to the build product based on the 'checkout' path.

&mdash; **def [buildbucket\_trigger](/scripts/slave/recipe_modules/v8/api.py#1472)(self, bucket, changes, requests, step_name='trigger', service_account='v8-bot', no_buildset=False):**
...
&mdash; **def [calc\_missing\_values\_in\_sequence](/scripts/slave/recipe_modules/v8/api.py#1605)(self, sequence, subsequence, value):**
...
&mdash; **def [calculate\_patch\_base\_gerrit](/scripts/slave/recipe_modules/v8/api.py#363)(self):**

Calculates the commit hash a gerrit patch was branched off.

&mdash; **def [checkout](/scripts/slave/recipe_modules/v8/api.py#319)(self, revision=None, \*\*kwargs):**

&mdash; **def [compile](/scripts/slave/recipe_modules/v8/api.py#667)(self, test_spec=EmptyTestSpec, \*\*kwargs):**
...
&mdash; **def [create\_coverage\_context](/scripts/slave/recipe_modules/v8/api.py#922)(self):**

&mdash; **def [create\_test](/scripts/slave/recipe_modules/v8/api.py#928)(self, test):**

Wrapper that allows to shortcut common tests with their names.

Returns: A runnable test instance.

&mdash; **def [create\_tests](/scripts/slave/recipe_modules/v8/api.py#935)(self):**
...
&mdash; **def [download\_build](/scripts/slave/recipe_modules/v8/api.py#807)(self, name_suffix='', archive=None):**

&mdash; **def [download\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#815)(self, revision):**
...
&emsp; **@staticmethod**<br>&mdash; **def [format\_duration](/scripts/slave/recipe_modules/v8/api.py#1095)(duration_in_seconds):**

&emsp; **@property**<br>&mdash; **def [generate\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#832)(self):**

&emsp; **@property**<br>&mdash; **def [generate\_sanitizer\_coverage](/scripts/slave/recipe_modules/v8/api.py#918)(self):**

&mdash; **def [get\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1581)(self, bisect_range, use_swarming=False):**

&mdash; **def [get\_change\_range](/scripts/slave/recipe_modules/v8/api.py#1531)(self):**

&mdash; **def [get\_changes](/scripts/slave/recipe_modules/v8/api.py#1466)(self):**
...
&mdash; **def [init\_gcov\_coverage](/scripts/slave/recipe_modules/v8/api.py#836)(self):**

Delete all gcov counter files.

&emsp; **@property**<br>&mdash; **def [is\_pure\_swarming\_tester](/scripts/slave/recipe_modules/v8/api.py#938)(self):**
...
&mdash; **def [isolate\_tests](/scripts/slave/recipe_modules/v8/api.py#570)(self, isolate_targets):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_archive\_path](/scripts/slave/recipe_modules/v8/api.py#773)(self):**

&emsp; **@property**<br>&mdash; **def [isolated\_tests](/scripts/slave/recipe_modules/v8/api.py#289)(self):**
...
&mdash; **def [log\_available\_range](/scripts/slave/recipe_modules/v8/api.py#1627)(self, available_bisect_range):**

&mdash; **def [maybe\_bisect](/scripts/slave/recipe_modules/v8/api.py#998)(self, test_results):**

Build-local bisection for one failure.

&mdash; **def [maybe\_create\_clusterfuzz\_archive](/scripts/slave/recipe_modules/v8/api.py#791)(self, update_step):**

&mdash; **def [maybe\_trigger](/scripts/slave/recipe_modules/v8/api.py#1336)(self, test_spec=EmptyTestSpec, \*\*additional_properties):**
...
&mdash; **def [read\_version\_file](/scripts/slave/recipe_modules/v8/api.py#1643)(self, ref, step_name_desc):**

Read and return the version-file content at a paricular ref.

&mdash; **def [read\_version\_from\_ref](/scripts/slave/recipe_modules/v8/api.py#1652)(self, ref, step_name_desc):**
...
&mdash; **def [report\_culprits](/scripts/slave/recipe_modules/v8/api.py#1632)(self, culprit_range):**

&mdash; **def [runhooks](/scripts/slave/recipe_modules/v8/api.py#423)(self, \*\*kwargs):**

&mdash; **def [runtests](/scripts/slave/recipe_modules/v8/api.py#943)(self, tests):**

&mdash; **def [set\_gclient\_custom\_deps](/scripts/slave/recipe_modules/v8/api.py#284)(self, custom_deps):**
...
&mdash; **def [set\_up\_swarming](/scripts/slave/recipe_modules/v8/api.py#379)(self):**
...
&mdash; **def [testing\_random\_seed](/scripts/slave/recipe_modules/v8/api.py#299)(self):**
...
&mdash; **def [upload\_build](/scripts/slave/recipe_modules/v8/api.py#766)(self, name_suffix='', archive=None):**

&mdash; **def [upload\_gcov\_coverage\_report](/scripts/slave/recipe_modules/v8/api.py#846)(self):**

Capture coverage data and upload a report.

&mdash; **def [upload\_isolated\_json](/scripts/slave/recipe_modules/v8/api.py#783)(self):**

&emsp; **@staticmethod**<br>&mdash; **def [version\_from\_file](/scripts/slave/recipe_modules/v8/api.py#1656)(blob):**
...
[depot_tools/recipe_modules/gerrit]: https://chromium.googlesource.com/chromium/tools/depot_tools.git/+/2c984a03caff0f1c0f92d6b5ddbc3226393db5eb/recipes/README.recipes.md#recipe_modules-gerrit
...
[recipe_engine/recipe_modules/generator_script]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/e396449f8434e3faf4151c36b5ad3f2377b80608/README.recipes.md#recipe_modules-generator_script
...
[recipe_engine/recipe_modules/scheduler]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/e396449f8434e3faf4151c36b5ad3f2377b80608/README.recipes.md#recipe_modules-scheduler
...
[recipe_engine/wkt/returns_placeholder]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/e396449f8434e3faf4151c36b5ad3f2377b80608/recipe_engine/util.py#120
