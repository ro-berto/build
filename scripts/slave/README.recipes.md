...
&mdash; **def [compile\_specific\_targets](/scripts/slave/recipe_modules/chromium_tests/api.py#339)(self, bot_config, update_step, build_config, compile_targets, tests_including_triggered, builder_id=None, mb_phase=None, mb_config_path=None, mb_recursive_lookup=True, override_bot_type=None):**
...
&mdash; **def [create\_test\_runner](/scripts/slave/recipe_modules/chromium_tests/api.py#256)(self, tests, suffix='', serialize_tests=False, retry_failed_shards=False, retry_invalid_shards=False):**
...
&mdash; **def [deapply\_deps](/scripts/slave/recipe_modules/chromium_tests/api.py#1195)(self, bot_update_step):**

&mdash; **def [deapply\_patch](/scripts/slave/recipe_modules/chromium_tests/api.py#766)(self, bot_update_step):**

&mdash; **def [download\_and\_unzip\_build](/scripts/slave/recipe_modules/chromium_tests/api.py#648)(self, builder_id, update_step, bot_config, build_archive_url=None, build_revision=None, override_bot_type=None, read_gn_args=True):**
...
&mdash; **def [get\_android\_version\_details](/scripts/slave/recipe_modules/chromium_tests/api.py#309)(self, bot_config, log_details=False):**
...
&mdash; **def [integration\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1218)(self, builders=None, bots=None):**

&mdash; **def [log](/scripts/slave/recipe_modules/chromium_tests/api.py#114)(self, message):**

&mdash; **def [lookup\_bot\_metadata](/scripts/slave/recipe_modules/chromium_tests/api.py#1352)(self, builders=None, mirrored_bots=None):**

&mdash; **def [lookup\_builder\_gn\_args](/scripts/slave/recipe_modules/chromium_tests/api.py#1615)(self, bot_meta_data, mb_config_path=None, mb_phase=None, builders=None):**
...
&mdash; **def [outbound\_transfer](/scripts/slave/recipe_modules/chromium_tests/api.py#1067)(self, bot, bot_update_step, build_config):**
...
&mdash; **def [run\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#1640)(self, bot_meta_data, tests):**

&mdash; **def [run\_tests\_with\_and\_without\_changes](/scripts/slave/recipe_modules/chromium_tests/api.py#1240)(self, builders, mirrored_bots, deapply_changes, tests=None):**
...
&mdash; **def [trybot\_steps](/scripts/slave/recipe_modules/chromium_tests/api.py#1223)(self, builders=None, trybots=None):**

&mdash; **def [trybot\_steps\_for\_tests](/scripts/slave/recipe_modules/chromium_tests/api.py#1229)(self, builders=None, trybots=None, tests=None):**
