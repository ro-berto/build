...
AUX_BINARY_PACKAGES = {
    ...
    None: (
      cipd.CipdPackage(
          ...
          version='git_revision:8f11082f6d4f92ed2cf4c2c189884c4bbfee83db'),
    ...
    STAGING: (
      cipd.CipdPackage(
          name='infra/tools/luci/vpython/${platform}',
          version='git_revision:0577e51184b2da24260cbb01763eba51915b9755'),
      ...
      cipd.CipdPackage(
          ...
          version='version:2.7.14.chromium13'),
