...
DEFAULT_CIPD_VERSION = 'git_revision:2288f0cb47eea8b5430882867099586afcee2368'
STAGING_CIPD_VERSION = 'git_revision:a1f61935faa60feb73e37556fdf791262c2dedce'
...
AUX_BINARY_PACKAGES = {
    ...
    None: (
      cipd.CipdPackage(
          ...
          version='git_revision:08e35087eaf8ee95207450d2a2e33152a2f245be'),
    ...
    STAGING: (
      cipd.CipdPackage(
          name='infra/tools/luci/vpython/${platform}',
          version='git_revision:9d158814f77dc305eeb5d440df88c80e26e2b13b'),
