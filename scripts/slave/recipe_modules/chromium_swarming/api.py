  ...
  def task(self, name=None, build_properties=None, cipd_packages=None,
    ...
    if buildername:
      task_name_suffix += '/%s/%s' % (
        buildername, self.m.buildbucket.build.number or -1)
...
class SwarmingTask(object):
  ...
  def __init__(self, request, collect_step, extra_args, ignore_task_failure,
               shards, shard_indices, spec_name, task_name_suffix,
               task_output_dir, build_properties=None, containment_type=None,
    ...
    Args:
      ...
      * task_name_suffix: Suffix to append to the task name. Usually composed
        of buildername and buildnumber.
