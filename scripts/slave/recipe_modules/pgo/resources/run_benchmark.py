...
def main():
  ...
  env['PATH'] = str(os.pathsep.join([pgo_sweep_dir, options.build_dir,
                                     os.environ['PATH']]))
  env['PogoSafeMode'] = '1'
  # Apply a scaling factor of 0.25 to the PGO profiling buffers for the 32-bit
  # builds, without this the buffers will be too large and the process will
  # fail to start, see crbug.com/632864#c22.
  #
  # This value was initially set to 0.5 and had to be lowered to 0.25, see
  # crbug.com/661902#c8.
  if options.target_bits == 32:
    env['VCPROFILE_ALLOC_SCALE'] = '0.25'
