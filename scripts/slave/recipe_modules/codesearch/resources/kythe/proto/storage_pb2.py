...
_VNAMEREWRITERULE = _descriptor.Descriptor(
  name='VNameRewriteRule',
  full_name='kythe.proto.VNameRewriteRule',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pattern', full_name='kythe.proto.VNameRewriteRule.pattern', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='v_name', full_name='kythe.proto.VNameRewriteRule.v_name', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='vname', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
VNameRewriteRule = _reflection.GeneratedProtocolMessageType('VNameRewriteRule', (_message.Message,), dict(
  DESCRIPTOR = _VNAMEREWRITERULE,
  __module__ = 'kythe.proto.storage_pb2'
