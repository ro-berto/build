...
####### Category: Linux
      'V8 Linux - builder': {
        'chromium_apply_config': [
          'default_compiler', 'v8_ninja', 'goma', 'gcmole'],
        'v8_config_kwargs': {
      ...
      'V8 Linux - nosnap builder': {
        'chromium_apply_config': [
          'default_compiler', 'v8_ninja', 'goma', 'no_snapshot'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Release',
          'TARGET_BITS': 32,
        },
      ...
      'V8 Linux - interpreted regexp': {
        'chromium_apply_config': [
          'default_compiler', 'v8_ninja', 'goma', 'interpreted_regexp'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Release',
          'TARGET_BITS': 32,
        },
      ...
      'V8 Linux - noi18n - debug': {
        ...
        'chromium_apply_config': [
          'default_compiler', 'v8_ninja', 'goma', 'no_i18n'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Debug',
          'TARGET_BITS': 32,
        },
...
####### Category: Windows
      ...
      'V8 Win32': {
        ...
        'enable_swarming': True,
        'tests': [V8Testing, Test262, Mozilla, IgnitionTurbofan],
        'testing': {'platform': 'linux'},
        'swarming_dimensions': {
          'os': 'Windows-7-SP1',
          'cpu': 'x86-64',
      ...
      'V8 Win32 - nosnap - shared': {
        ...
        'bot_type': 'builder_tester',
        'enable_swarming': True,
        'tests': [V8Testing_2, IgnitionTurbofan],
        'swarming_dimensions': {
          'os': 'Windows-7-SP1',
          'cpu': 'x86-64',
        },
      ...
      'V8 Win32 - debug': {
        ...
        'enable_swarming': True,
        'tests': [V8Testing_2, Test262, Mozilla, IgnitionTurbofan],
        'testing': {'platform': 'linux'},
        'swarming_dimensions': {
          'os': 'Windows-7-SP1',
          'cpu': 'x86-64',
      ...
      'V8 Win64': {
        ...
        'tests': [V8Testing, SimdJs, Test262, Mozilla, IgnitionTurbofan],
        'testing': {'platform': 'win'},
      },
      'V8 Win64 - debug': {
        'chromium_apply_config': [
        ...
        'tests': [V8Testing_2, SimdJs, Test262, Mozilla, IgnitionTurbofan],
        'testing': {'platform': 'win'},
      },
      'V8 Win64 - clang': {
        'chromium_apply_config': [
...
####### Category: Mac
      'V8 Mac': {
        ...
        'bot_type': 'builder_tester',
        'enable_swarming': True,
        'tests': [V8Testing, Test262, Mozilla, SimdJs, IgnitionTurbofan],
        'swarming_dimensions': {
          'os': 'Mac-10.9',
          'cpu': 'x86-64',
        },
...
####### Category: Misc
      ...
      'V8 Linux - gc stress': {
        ...
        'build_gs_archive': 'linux_dbg_archive',
        'enable_swarming': True,
        'tests': [Mjsunit_3, Webkit, MjsunitIgnitionTurbofan_2],
        'testing': {'platform': 'linux'},
      },
      'V8 Mac GC Stress': {
        'chromium_apply_config': ['v8_ninja', 'default_compiler', 'goma'],
      ...
      'V8 Linux gcc 4.8': {
        'chromium_apply_config': ['v8_ninja', 'gcc', 'goma'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Release',
          'TARGET_BITS': 32,
        },
      ...
      'V8 Linux64 ASAN': {
        ...
        'tests': [V8Testing_2, Test262, IgnitionTurbofan],
        'testing': {'platform': 'linux'},
        'triggers': [
      ...
      'V8 Linux64 TSAN': {
        ...
        'tests': [V8Testing, Test262_2, IgnitionTurbofan],
        'testing': {'platform': 'linux'},
      },
      ...
      'V8 Mac64 ASAN': {
        ...
        'bot_type': 'builder_tester',
        'enable_swarming': True,
        'tests': [V8Testing_4, IgnitionTurbofan],
        'swarming_dimensions': {
          'os': 'Mac-10.9',
          'cpu': 'x86-64',
        },
...
####### Category: FYI
      ...
      'V8 Linux - vtunejit': {
        'chromium_apply_config': [
          'default_compiler', 'v8_ninja', 'goma', 'vtunejit'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Debug',
          'TARGET_BITS': 32,
        },
      ...
      'V8 Linux - predictable': {
        ...
        'chromium_apply_config': [
          'v8_ninja', 'default_compiler', 'goma', 'predictable'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Release',
          'TARGET_BITS': 32,
        },
      ...
      'V8 Linux - full debug': {
        'chromium_apply_config': [
          'default_compiler', 'v8_ninja', 'goma', 'no_optimized_debug'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Debug',
          'TARGET_BITS': 32,
        },
...
####### Category: Arm
      ...
      'V8 Linux - arm - sim - debug': {
        'chromium_apply_config': ['default_compiler', 'v8_ninja', 'goma', 'simulate_arm'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Debug',
          'TARGET_BITS': 32,
        },
...
####### Category: PPC
      'V8 Linux - ppc - sim': {
        'chromium_apply_config': [
          'default_compiler', 'v8_ninja', 'goma', 'simulate_ppc'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Release',
          'TARGET_BITS': 32,
        },
...
####### Category: S390
      'V8 Linux - s390 - sim': {
        'chromium_apply_config': [
          'default_compiler', 'v8_ninja', 'goma', 'simulate_s390'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Release',
          'TARGET_BITS': 32,
        },
  ...
  'tryserver.v8': {
    'builders': {
      ...
      'v8_linux_nodcheck_rel_ng': {
        'chromium_apply_config': [
          'default_compiler', 'v8_ninja', 'goma', 'no_dcheck'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Release',
          'TARGET_BITS': 32,
        },
      ...
      'v8_linux_gcc_compile_rel': {
        'chromium_apply_config': ['v8_ninja', 'no_dcheck', 'gcc', 'goma'],
        'v8_config_kwargs': {
          'BUILD_CONFIG': 'Release',
          'TARGET_BITS': 32,
        },
      ...
      'v8_linux64_asan_rel_ng_triggered': {
        ...
        'enable_swarming': True,
        'tests': [V8Testing_2, Test262_2, IgnitionTurbofan],
      ...
      'v8_win_dbg': {
        ...
        'tests': [V8Testing_2, IgnitionTurbofan, Mozilla],
        'testing': {'platform': 'win'},
      },
      'v8_win_compile_dbg': {
        'chromium_apply_config': [
      ...
      'v8_win_rel_ng_triggered': {
        ...
        'tests': [V8Testing, IgnitionTurbofan],
        'testing': {'platform': 'linux'},
      },
      ...
      'v8_win64_rel_ng_triggered': {
        ...
        'tests': [V8Testing, SimdJs, IgnitionTurbofan],
        'testing': {'platform': 'linux'},
      },
      'v8_win64_dbg': {
        'chromium_apply_config': [
        ...
        'tests': [V8Testing_2, SimdJs, IgnitionTurbofan, Mozilla],
        'testing': {'platform': 'win'},
      },
      'v8_mac_rel_ng': {
        'chromium_apply_config': ['v8_ninja', 'default_compiler', 'goma'],
      ...
      'v8_mac_dbg': {
        ...
        'bot_type': 'builder_tester',
        'enable_swarming': True,
        'tests': [V8Testing_2, Test262, Mozilla, SimdJs, IgnitionTurbofan],
        'swarming_dimensions': {
          'os': 'Mac-10.9',
          'cpu': 'x86-64',
        },
