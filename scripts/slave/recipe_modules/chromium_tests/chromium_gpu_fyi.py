...
SPEC = {
    ...
    'builders': {
        ...
        'GPU FYI XR Win x64 Builder': {
            ...
            # (NVIDIA)", which is a child of this builder, uploads perf results,
            # and Pinpoint may trigger additional builds on this builder during
            # a bisect.
        ...
        'GPU FYI Perf Android 64 Builder': {
            ...
            # is a child of this builder, uploads perf results, and Pinpoint may
            # trigger additional builds on this builder during a bisect.
            'perf_isolate_lookup': True,
        },
