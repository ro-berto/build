...
_AddBotSpec(
    ...
    num_shards=5,
    chromium_apply_config=[])
# TODO(erikchen): Remove chromium_apply_config once the 10.8 bots have become
# 10.10 bots, and have the 10.10 SDK.
_AddBotSpec(
    name='Mac 10.8 Perf',
    platform='mac',
    parent_builder='Mac Builder',
