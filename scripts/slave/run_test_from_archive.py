...
# This is just a copy of the file found in the chromium depot (tools/isolate),
# it is needed here so that the swarm trigger builder can access it.
# This should be removed from this repo once the test bootstraping is updated.
